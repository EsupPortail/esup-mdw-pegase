...
VALUES ('PEGASE_API_IDT_URL', 'Base Url de l''API du module IDT de Pégase (attention à conserver la structure de l''url d''exemple)', NULL, 'https://ins-pegase.fr/api/idt/v1', '3', 'STRING', 1);
