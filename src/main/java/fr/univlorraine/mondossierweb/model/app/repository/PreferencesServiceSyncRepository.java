...
public interface PreferencesServiceSyncRepository extends JpaRepository<PreferencesServiceSync, PreferencesServiceSyncPK> {

	public List<PreferencesServiceSync> findByLastUpdateAfter(LocalDateTime lastSyncUpdate);
