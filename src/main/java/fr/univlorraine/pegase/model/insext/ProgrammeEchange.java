...
public class ProgrammeEchange {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProgrammeEchange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProgrammeEchange is not found in the empty JSON string", ProgrammeEchange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProgrammeEchange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProgrammeEchange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("codePays") != null && !jsonObj.get("codePays").isJsonNull()) && !jsonObj.get("codePays").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `codePays` to be a primitive type in the JSON string but got `%s`", jsonObj.get("codePays").toString()));
      }
  }
  ...
  public ProgrammeEchange code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ProgrammeEchange codePays(@javax.annotation.Nullable String codePays) {
  ...
  public ProgrammeEchange contexteConsommation(@javax.annotation.Nullable Date contexteConsommation) {
