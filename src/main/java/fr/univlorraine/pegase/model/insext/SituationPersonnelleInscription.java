...
public class SituationPersonnelleInscription {
  ...
  static {
    ...
    openapiFields.add("amenagementsSpecifiques");
    openapiFields.add("souhaitAmenagement");
    openapiFields.add("profilsSpecifiques");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SituationPersonnelleInscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SituationPersonnelleInscription is not found in the empty JSON string", SituationPersonnelleInscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SituationPersonnelleInscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SituationPersonnelleInscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("amenagementsSpecifiques") != null && !jsonObj.get("amenagementsSpecifiques").isJsonNull() && !jsonObj.get("amenagementsSpecifiques").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `amenagementsSpecifiques` to be an array in the JSON string but got `%s`", jsonObj.get("amenagementsSpecifiques").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("profilsSpecifiques") != null && !jsonObj.get("profilsSpecifiques").isJsonNull() && !jsonObj.get("profilsSpecifiques").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `profilsSpecifiques` to be an array in the JSON string but got `%s`", jsonObj.get("profilsSpecifiques").toString()));
      }
  }
  ...
  public SituationPersonnelleInscription amenagementsSpecifiques(@javax.annotation.Nullable List<String> amenagementsSpecifiques) {
  ...
  public void setAmenagementsSpecifiques(@javax.annotation.Nullable List<String> amenagementsSpecifiques) {
    this.amenagementsSpecifiques = amenagementsSpecifiques;
  }

  public SituationPersonnelleInscription souhaitAmenagement(@javax.annotation.Nullable Boolean souhaitAmenagement) {
  ...
  public void setSouhaitAmenagement(@javax.annotation.Nullable Boolean souhaitAmenagement) {
    this.souhaitAmenagement = souhaitAmenagement;
  }

  public SituationPersonnelleInscription profilsSpecifiques(@javax.annotation.Nullable List<String> profilsSpecifiques) {
  ...
  public void setProfilsSpecifiques(@javax.annotation.Nullable List<String> profilsSpecifiques) {
    this.profilsSpecifiques = profilsSpecifiques;
  }
