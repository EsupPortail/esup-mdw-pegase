...
public class Filiere {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Filiere.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Filiere is not found in the empty JSON string", Filiere.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Filiere.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Filiere` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public Filiere code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public Filiere contexteConsommation(@javax.annotation.Nullable Date contexteConsommation) {
