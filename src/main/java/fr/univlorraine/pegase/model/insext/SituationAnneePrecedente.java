...
import fr.univlorraine.pegase.model.insext.Nomenclature;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SituationAnneePrecedente.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SituationAnneePrecedente is not found in the empty JSON string", SituationAnneePrecedente.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SituationAnneePrecedente.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SituationAnneePrecedente` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
