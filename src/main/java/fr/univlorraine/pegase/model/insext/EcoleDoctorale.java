...
public class EcoleDoctorale {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EcoleDoctorale.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcoleDoctorale is not found in the empty JSON string", EcoleDoctorale.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EcoleDoctorale.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EcoleDoctorale` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public EcoleDoctorale code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public EcoleDoctorale contexteConsommation(@javax.annotation.Nullable Date contexteConsommation) {
  ...
  public void setContexteConsommation(@javax.annotation.Nullable Date contexteConsommation) {
    this.contexteConsommation = contexteConsommation;
  }
