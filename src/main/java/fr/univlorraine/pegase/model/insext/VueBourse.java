...
public class VueBourse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VueBourse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VueBourse is not found in the empty JSON string", VueBourse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VueBourse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VueBourse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public VueBourse code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public VueBourse libelleLong(@javax.annotation.Nonnull String libelleLong) {
