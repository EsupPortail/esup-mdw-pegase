...
public class PremieresInscriptions {
  ...
  static {
    ...
    openapiFields.add("anneeEnseignementSuperieur");
    openapiFields.add("anneeUniversite");
    openapiFields.add("anneeEtablissement");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PremieresInscriptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PremieresInscriptions is not found in the empty JSON string", PremieresInscriptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PremieresInscriptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PremieresInscriptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("anneeEnseignementSuperieur") != null && !jsonObj.get("anneeEnseignementSuperieur").isJsonNull()) && !jsonObj.get("anneeEnseignementSuperieur").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `anneeEnseignementSuperieur` to be a primitive type in the JSON string but got `%s`", jsonObj.get("anneeEnseignementSuperieur").toString()));
      }
      if ((jsonObj.get("anneeUniversite") != null && !jsonObj.get("anneeUniversite").isJsonNull()) && !jsonObj.get("anneeUniversite").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `anneeUniversite` to be a primitive type in the JSON string but got `%s`", jsonObj.get("anneeUniversite").toString()));
      }
      if ((jsonObj.get("anneeEtablissement") != null && !jsonObj.get("anneeEtablissement").isJsonNull()) && !jsonObj.get("anneeEtablissement").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `anneeEtablissement` to be a primitive type in the JSON string but got `%s`", jsonObj.get("anneeEtablissement").toString()));
      }
  }
  ...
  public PremieresInscriptions anneeEnseignementSuperieur(@javax.annotation.Nullable String anneeEnseignementSuperieur) {
  ...
  public void setAnneeEnseignementSuperieur(@javax.annotation.Nullable String anneeEnseignementSuperieur) {
    this.anneeEnseignementSuperieur = anneeEnseignementSuperieur;
  }

  public PremieresInscriptions anneeUniversite(@javax.annotation.Nullable String anneeUniversite) {
  ...
  public void setAnneeUniversite(@javax.annotation.Nullable String anneeUniversite) {
    this.anneeUniversite = anneeUniversite;
  }

  public PremieresInscriptions anneeEtablissement(@javax.annotation.Nullable String anneeEtablissement) {
  ...
  public void setAnneeEtablissement(@javax.annotation.Nullable String anneeEtablissement) {
    this.anneeEtablissement = anneeEtablissement;
  }
