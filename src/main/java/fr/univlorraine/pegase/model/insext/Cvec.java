...
public class Cvec {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cvec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cvec is not found in the empty JSON string", Cvec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cvec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cvec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public Cvec numero(@javax.annotation.Nullable String numero) {
    this.numero = numero;
    return this;
  }
