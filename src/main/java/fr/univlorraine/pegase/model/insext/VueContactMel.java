...
public class VueContactMel extends VueContact {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VueContactMel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VueContactMel is not found in the empty JSON string", VueContactMel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VueContactMel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VueContactMel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public VueContactMel mail(@javax.annotation.Nonnull String mail) {
    this.mail = mail;
    return this;
  }
  ...
  public void setMail(@javax.annotation.Nonnull String mail) {
    this.mail = mail;
  }
