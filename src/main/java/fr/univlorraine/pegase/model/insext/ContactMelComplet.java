...
public class ContactMelComplet extends ContactComplet {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactMelComplet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactMelComplet is not found in the empty JSON string", ContactMelComplet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactMelComplet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactMelComplet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public ContactMelComplet mail(@javax.annotation.Nonnull String mail) {
    this.mail = mail;
    return this;
  }
