...
public class ObjetAvecLibelle {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjetAvecLibelle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjetAvecLibelle is not found in the empty JSON string", ObjetAvecLibelle.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        ...
        case "Periode":
          ...
          break;
        default:
          throw new IllegalArgumentException(String.format("The value of the `est1` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }
  ...
  public ObjetAvecLibelle est1(@javax.annotation.Nonnull String est1) {
    this.est1 = est1;
    return this;
  }
  ...
  public ObjetAvecLibelle code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ObjetAvecLibelle libelleCourt(@javax.annotation.Nullable String libelleCourt) {
  ...
  public void setLibelleCourt(@javax.annotation.Nullable String libelleCourt) {
    this.libelleCourt = libelleCourt;
  }

  public ObjetAvecLibelle libelleLong(@javax.annotation.Nullable String libelleLong) {
  ...
  public void setLibelleLong(@javax.annotation.Nullable String libelleLong) {
    this.libelleLong = libelleLong;
  }
