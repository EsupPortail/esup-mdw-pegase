...
public class ContactTelephoneComplet extends ContactComplet {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactTelephoneComplet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactTelephoneComplet is not found in the empty JSON string", ContactTelephoneComplet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactTelephoneComplet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactTelephoneComplet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public ContactTelephoneComplet telephone(@javax.annotation.Nonnull String telephone) {
