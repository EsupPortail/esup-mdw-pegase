...
import fr.univlorraine.pegase.model.chc.InfosObjetMaquette;
import fr.univlorraine.pegase.model.chc.InfosPedagogique;
import fr.univlorraine.pegase.model.chc.PossibilitesPedagogiques;
...
/**
 * les infos d&#39;un apprenant pour un chemin objet maquette donné
 */
@ApiModel(description = "les infos d'un apprenant pour un chemin objet maquette donné")
...
public class LigneAffectationMasse {
  public static final String SERIALIZED_NAME_ID_CURSUS = "idCursus";
  @SerializedName(SERIALIZED_NAME_ID_CURSUS)
  ...
  public static final String SERIALIZED_NAME_INFOS_OBJET_MAQUETTE = "infosObjetMaquette";
  @SerializedName(SERIALIZED_NAME_INFOS_OBJET_MAQUETTE)
  private InfosObjetMaquette infosObjetMaquette;

  public static final String SERIALIZED_NAME_INFOS_PEDAGOGIQUE = "infosPedagogique";
  @SerializedName(SERIALIZED_NAME_INFOS_PEDAGOGIQUE)
  private InfosPedagogique infosPedagogique;

  public static final String SERIALIZED_NAME_POSSIBILITES_PEDAGOGIQUES = "possibilitesPedagogiques";
  @SerializedName(SERIALIZED_NAME_POSSIBILITES_PEDAGOGIQUES)
  private PossibilitesPedagogiques possibilitesPedagogiques;

  public static final String SERIALIZED_NAME_BROUILLON_EN_COURS = "brouillonEnCours";
  @SerializedName(SERIALIZED_NAME_BROUILLON_EN_COURS)
  private Boolean brouillonEnCours;
  ...
  public static final String SERIALIZED_NAME_PROPRIETAIRE_BROUILLON = "proprietaireBrouillon";
  @SerializedName(SERIALIZED_NAME_PROPRIETAIRE_BROUILLON)
  private String proprietaireBrouillon;

  public LigneAffectationMasse() { 
  }

  public LigneAffectationMasse idCursus(UUID idCursus) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "L'id technique du cursus")
  ...
  public void setIdCursus(UUID idCursus) {
    this.idCursus = idCursus;
  }


  public LigneAffectationMasse apprenant(Apprenant apprenant) {
  ...
  **/
  ...
  public LigneAffectationMasse infosObjetMaquette(InfosObjetMaquette infosObjetMaquette) {
    
    this.infosObjetMaquette = infosObjetMaquette;
    return this;
  }
  ...
  **/
  ...
  public void setInfosObjetMaquette(InfosObjetMaquette infosObjetMaquette) {
    this.infosObjetMaquette = infosObjetMaquette;
  }


  public LigneAffectationMasse infosPedagogique(InfosPedagogique infosPedagogique) {
    
    this.infosPedagogique = infosPedagogique;
    return this;
  }
  ...
  **/
  ...
  public void setInfosPedagogique(InfosPedagogique infosPedagogique) {
    this.infosPedagogique = infosPedagogique;
  }


  public LigneAffectationMasse possibilitesPedagogiques(PossibilitesPedagogiques possibilitesPedagogiques) {
    
    this.possibilitesPedagogiques = possibilitesPedagogiques;
    return this;
  }
  ...
  **/
  ...
  public void setPossibilitesPedagogiques(PossibilitesPedagogiques possibilitesPedagogiques) {
    this.possibilitesPedagogiques = possibilitesPedagogiques;
  }


  public LigneAffectationMasse brouillonEnCours(Boolean brouillonEnCours) {
    
    this.brouillonEnCours = brouillonEnCours;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Spécifie si un brouillon existe pour ce cursus")
  ...
  public void setBrouillonEnCours(Boolean brouillonEnCours) {
    this.brouillonEnCours = brouillonEnCours;
  }


  public LigneAffectationMasse codeCheminOmIa(String codeCheminOmIa) {
  ...
  **/
  ...
  public LigneAffectationMasse proprietaireBrouillon(String proprietaireBrouillon) {
    
    this.proprietaireBrouillon = proprietaireBrouillon;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "username CAS du proprietaire du brouillon")
  ...
  public void setProprietaireBrouillon(String proprietaireBrouillon) {
    this.proprietaireBrouillon = proprietaireBrouillon;
  }
  ...
  public boolean equals(Object o) {
    ...
    LigneAffectationMasse ligneAffectationMasse = (LigneAffectationMasse) o;
    return Objects.equals(this.idCursus, ligneAffectationMasse.idCursus) &&
        Objects.equals(this.apprenant, ligneAffectationMasse.apprenant) &&
        Objects.equals(this.infosObjetMaquette, ligneAffectationMasse.infosObjetMaquette) &&
        Objects.equals(this.infosPedagogique, ligneAffectationMasse.infosPedagogique) &&
        Objects.equals(this.possibilitesPedagogiques, ligneAffectationMasse.possibilitesPedagogiques) &&
        Objects.equals(this.brouillonEnCours, ligneAffectationMasse.brouillonEnCours) &&
        Objects.equals(this.codeCheminOmIa, ligneAffectationMasse.codeCheminOmIa) &&
        Objects.equals(this.proprietaireBrouillon, ligneAffectationMasse.proprietaireBrouillon);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idCursus, apprenant, infosObjetMaquette, infosPedagogique, possibilitesPedagogiques, brouillonEnCours, codeCheminOmIa, proprietaireBrouillon);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LigneAffectationMasse {\n");
    sb.append("    idCursus: ").append(toIndentedString(idCursus)).append("\n");
    sb.append("    apprenant: ").append(toIndentedString(apprenant)).append("\n");
    sb.append("    infosObjetMaquette: ").append(toIndentedString(infosObjetMaquette)).append("\n");
    sb.append("    infosPedagogique: ").append(toIndentedString(infosPedagogique)).append("\n");
    sb.append("    possibilitesPedagogiques: ").append(toIndentedString(possibilitesPedagogiques)).append("\n");
    sb.append("    brouillonEnCours: ").append(toIndentedString(brouillonEnCours)).append("\n");
    sb.append("    codeCheminOmIa: ").append(toIndentedString(codeCheminOmIa)).append("\n");
    sb.append("    proprietaireBrouillon: ").append(toIndentedString(proprietaireBrouillon)).append("\n");
    sb.append("}");
    return sb.toString();
  }
