...
/**
 * LienCorrespondanceCalculModification
 */
...
public class LienCorrespondanceCalculModification {
  public static final String SERIALIZED_NAME_ID_IMMUABLE_OBJET_FORMATION_CIBLE = "idImmuableObjetFormationCible";
  @SerializedName(SERIALIZED_NAME_ID_IMMUABLE_OBJET_FORMATION_CIBLE)
  private String idImmuableObjetFormationCible;

  public static final String SERIALIZED_NAME_CODE_OBJET_FORMATION_CIBLE = "codeObjetFormationCible";
  @SerializedName(SERIALIZED_NAME_CODE_OBJET_FORMATION_CIBLE)
  private String codeObjetFormationCible;

  public static final String SERIALIZED_NAME_CODE_TYPE_CIBLE = "codeTypeCible";
  @SerializedName(SERIALIZED_NAME_CODE_TYPE_CIBLE)
  private String codeTypeCible;

  public static final String SERIALIZED_NAME_ID_IMMUABLE_OBJET_FORMATION_SOURCE = "idImmuableObjetFormationSource";
  @SerializedName(SERIALIZED_NAME_ID_IMMUABLE_OBJET_FORMATION_SOURCE)
  private String idImmuableObjetFormationSource;

  public static final String SERIALIZED_NAME_CODE_OBJET_FORMATION_SOURCE = "codeObjetFormationSource";
  @SerializedName(SERIALIZED_NAME_CODE_OBJET_FORMATION_SOURCE)
  private String codeObjetFormationSource;

  public static final String SERIALIZED_NAME_CODE_TYPE_SOURCE = "codeTypeSource";
  @SerializedName(SERIALIZED_NAME_CODE_TYPE_SOURCE)
  private String codeTypeSource;
  ...
  public LienCorrespondanceCalculModification() { 
  }

  public LienCorrespondanceCalculModification idImmuableObjetFormationCible(String idImmuableObjetFormationCible) {
    
    this.idImmuableObjetFormationCible = idImmuableObjetFormationCible;
    return this;
  }

   /**
   * L&#39;id immmuable de l&#39;objet de formation cible
   * @return idImmuableObjetFormationCible
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "L'id immmuable de l'objet de formation cible")

  public String getIdImmuableObjetFormationCible() {
    return idImmuableObjetFormationCible;
  }


  public void setIdImmuableObjetFormationCible(String idImmuableObjetFormationCible) {
    this.idImmuableObjetFormationCible = idImmuableObjetFormationCible;
  }


  public LienCorrespondanceCalculModification codeObjetFormationCible(String codeObjetFormationCible) {
    
    this.codeObjetFormationCible = codeObjetFormationCible;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code de l'objet de formation cible")
  ...
  public void setCodeObjetFormationCible(String codeObjetFormationCible) {
    this.codeObjetFormationCible = codeObjetFormationCible;
  }


  public LienCorrespondanceCalculModification codeTypeCible(String codeTypeCible) {
    
    this.codeTypeCible = codeTypeCible;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code du type de l'objet de formation cible")
  ...
  public void setCodeTypeCible(String codeTypeCible) {
    this.codeTypeCible = codeTypeCible;
  }


  public LienCorrespondanceCalculModification idImmuableObjetFormationSource(String idImmuableObjetFormationSource) {
    
    this.idImmuableObjetFormationSource = idImmuableObjetFormationSource;
    return this;
  }

   /**
   * L&#39;id immmuable de l&#39;objet de formation source
   * @return idImmuableObjetFormationSource
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "L'id immmuable de l'objet de formation source")

  public String getIdImmuableObjetFormationSource() {
    return idImmuableObjetFormationSource;
  }


  public void setIdImmuableObjetFormationSource(String idImmuableObjetFormationSource) {
    this.idImmuableObjetFormationSource = idImmuableObjetFormationSource;
  }


  public LienCorrespondanceCalculModification codeObjetFormationSource(String codeObjetFormationSource) {
    
    this.codeObjetFormationSource = codeObjetFormationSource;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code de l'objet de formation source")
  ...
  public void setCodeObjetFormationSource(String codeObjetFormationSource) {
    this.codeObjetFormationSource = codeObjetFormationSource;
  }


  public LienCorrespondanceCalculModification codeTypeSource(String codeTypeSource) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code du type de l'objet de formation source")
  ...
  public void setCodeTypeSource(String codeTypeSource) {
    this.codeTypeSource = codeTypeSource;
  }


  public LienCorrespondanceCalculModification commentaire(String commentaire) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Le commentaire relatif au lien")
  ...
  public LienCorrespondanceCalculModification actif(Boolean actif) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Ce lien est-il actif?")
  ...
  public boolean equals(Object o) {
    ...
    LienCorrespondanceCalculModification lienCorrespondanceCalculModification = (LienCorrespondanceCalculModification) o;
    return Objects.equals(this.idImmuableObjetFormationCible, lienCorrespondanceCalculModification.idImmuableObjetFormationCible) &&
        Objects.equals(this.codeObjetFormationCible, lienCorrespondanceCalculModification.codeObjetFormationCible) &&
        Objects.equals(this.codeTypeCible, lienCorrespondanceCalculModification.codeTypeCible) &&
        Objects.equals(this.idImmuableObjetFormationSource, lienCorrespondanceCalculModification.idImmuableObjetFormationSource) &&
        Objects.equals(this.codeObjetFormationSource, lienCorrespondanceCalculModification.codeObjetFormationSource) &&
        Objects.equals(this.codeTypeSource, lienCorrespondanceCalculModification.codeTypeSource) &&
        Objects.equals(this.commentaire, lienCorrespondanceCalculModification.commentaire) &&
        Objects.equals(this.actif, lienCorrespondanceCalculModification.actif);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idImmuableObjetFormationCible, codeObjetFormationCible, codeTypeCible, idImmuableObjetFormationSource, codeObjetFormationSource, codeTypeSource, commentaire, actif);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LienCorrespondanceCalculModification {\n");
    sb.append("    idImmuableObjetFormationCible: ").append(toIndentedString(idImmuableObjetFormationCible)).append("\n");
    sb.append("    codeObjetFormationCible: ").append(toIndentedString(codeObjetFormationCible)).append("\n");
    sb.append("    codeTypeCible: ").append(toIndentedString(codeTypeCible)).append("\n");
    sb.append("    idImmuableObjetFormationSource: ").append(toIndentedString(idImmuableObjetFormationSource)).append("\n");
    sb.append("    codeObjetFormationSource: ").append(toIndentedString(codeObjetFormationSource)).append("\n");
    sb.append("    codeTypeSource: ").append(toIndentedString(codeTypeSource)).append("\n");
