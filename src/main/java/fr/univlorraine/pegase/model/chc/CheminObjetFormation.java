...
public class CheminObjetFormation {
  public static final String SERIALIZED_NAME_ID_CHEMIN_OBJET_FORMATION = "idCheminObjetFormation";
  @SerializedName(SERIALIZED_NAME_ID_CHEMIN_OBJET_FORMATION)
  ...
  private String ouverteChoixCursus;
  ...
  **/
  ...
  @ApiModelProperty(value = "L'id technique du chemin objet formation")
  ...
  **/
  ...
  public CheminObjetFormation codeCategorie(String codeCategorie) {
  ...
  **/
  ...
  public CheminObjetFormation ouverteChoixCursus(String ouverteChoixCursus) {
  ...
  **/
  ...
  public String getOuverteChoixCursus() {
    return ouverteChoixCursus;
  }


  public void setOuverteChoixCursus(String ouverteChoixCursus) {
    this.ouverteChoixCursus = ouverteChoixCursus;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.idCheminObjetFormation, cheminObjetFormation.idCheminObjetFormation) &&
        ...
        Objects.equals(this.codeCategorie, cheminObjetFormation.codeCategorie) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idCheminObjetFormation, codeChemin, codePeriode, codeStructure, codeType, codeCategorie, capaciteAccueil, obligatoire, ouverteChoixCursus, creditEcts, estPlageDeChoix, plageMin, plageMax, formation, objetFormation, groupement);
  }
