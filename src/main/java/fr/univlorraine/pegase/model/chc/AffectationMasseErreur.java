...
public class AffectationMasseErreur {
  ...
  public AffectationMasseErreur() { 
  }

  public AffectationMasseErreur cursusId(UUID cursusId) {
  ...
  **/
  ...
  public AffectationMasseErreur message(String message) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le message de l'erreur")
  ...
  public boolean equals(Object o) {
    ...
    AffectationMasseErreur affectationMasseErreur = (AffectationMasseErreur) o;
    return Objects.equals(this.cursusId, affectationMasseErreur.cursusId) &&
        Objects.equals(this.message, affectationMasseErreur.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusId, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationMasseErreur {\n");
