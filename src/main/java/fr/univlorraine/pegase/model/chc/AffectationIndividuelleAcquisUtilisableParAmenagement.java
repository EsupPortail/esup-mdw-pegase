...
import fr.univlorraine.pegase.model.chc.AffectationIndividuelleCheminDelibereAcquisition;
...
public class AffectationIndividuelleAcquisUtilisableParAmenagement {
  public static final String SERIALIZED_NAME_CHEMIN_DELIBERE_ACQUISITION_LIST = "cheminDelibereAcquisitionList";
  @SerializedName(SERIALIZED_NAME_CHEMIN_DELIBERE_ACQUISITION_LIST)
  private List<AffectationIndividuelleCheminDelibereAcquisition> cheminDelibereAcquisitionList = null;
  ...
  public AffectationIndividuelleAcquisUtilisableParAmenagement addCheminDelibereAcquisitionListItem(AffectationIndividuelleCheminDelibereAcquisition cheminDelibereAcquisitionListItem) {
    if (this.cheminDelibereAcquisitionList == null) {
      this.cheminDelibereAcquisitionList = new ArrayList<AffectationIndividuelleCheminDelibereAcquisition>();
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "le code de l'objet formation dans le contexte de cet arbre pour lequel l'acquis utilisable est utilisable")
