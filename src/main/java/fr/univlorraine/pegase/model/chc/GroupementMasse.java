...
public class GroupementMasse {
  ...
  public GroupementMasse() { 
  }

  public GroupementMasse id(UUID id) {
   ...
   /**
   * L&#39;id technique du groupement
   * @return id
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "L'id technique du groupement")
  ...
  public GroupementMasse code(String code) {
   ...
   /**
   * Le code du groupement
   * @return code
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code du groupement")
  ...
  public GroupementMasse libelleCourt(String libelleCourt) {
   ...
   /**
   * Le libelle du groupement
   * @return libelleCourt
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libelle du groupement")
  ...
  public GroupementMasse codeNature(String codeNature) {
   ...
   /**
   * le type du groupement
   * @return codeNature
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "le type du groupement")
  ...
  public GroupementMasse mutualise(Boolean mutualise) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GroupementMasse groupementMasse = (GroupementMasse) o;
    return Objects.equals(this.id, groupementMasse.id) &&
        Objects.equals(this.code, groupementMasse.code) &&
        Objects.equals(this.libelleCourt, groupementMasse.libelleCourt) &&
        Objects.equals(this.codeNature, groupementMasse.codeNature) &&
        Objects.equals(this.mutualise, groupementMasse.mutualise);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, libelleCourt, codeNature, mutualise);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupementMasse {\n");
