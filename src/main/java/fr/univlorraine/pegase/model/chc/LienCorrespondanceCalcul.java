...
public class LienCorrespondanceCalcul {
  ...
  public static final String SERIALIZED_NAME_DATE_DE_CREATION = "dateDeCreation";
  @SerializedName(SERIALIZED_NAME_DATE_DE_CREATION)
  ...
  public LienCorrespondanceCalcul() { 
  }

  public LienCorrespondanceCalcul codeObjetFormationCible(String codeObjetFormationCible) {
  ...
  **/
  ...
  public LienCorrespondanceCalcul codeTypeCible(String codeTypeCible) {
  ...
  **/
  ...
  public LienCorrespondanceCalcul codeObjetFormationSource(String codeObjetFormationSource) {
  ...
  **/
  ...
  public LienCorrespondanceCalcul codeTypeSource(String codeTypeSource) {
  ...
  **/
  ...
  public LienCorrespondanceCalcul commentaire(String commentaire) {
  ...
  **/
  ...
  public LienCorrespondanceCalcul dateDeCreation(Date dateDeCreation) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "La date de création du lien de correspondance pour calcul")
  ...
  public LienCorrespondanceCalcul actif(Boolean actif) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LienCorrespondanceCalcul lienCorrespondanceCalcul = (LienCorrespondanceCalcul) o;
    return Objects.equals(this.codeObjetFormationCible, lienCorrespondanceCalcul.codeObjetFormationCible) &&
        Objects.equals(this.codeTypeCible, lienCorrespondanceCalcul.codeTypeCible) &&
        Objects.equals(this.codeObjetFormationSource, lienCorrespondanceCalcul.codeObjetFormationSource) &&
        Objects.equals(this.codeTypeSource, lienCorrespondanceCalcul.codeTypeSource) &&
        Objects.equals(this.commentaire, lienCorrespondanceCalcul.commentaire) &&
        Objects.equals(this.dateDeCreation, lienCorrespondanceCalcul.dateDeCreation) &&
        Objects.equals(this.actif, lienCorrespondanceCalcul.actif);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeObjetFormationCible, codeTypeCible, codeObjetFormationSource, codeTypeSource, commentaire, dateDeCreation, actif);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LienCorrespondanceCalcul {\n");
    ...
    sb.append("    dateDeCreation: ").append(toIndentedString(dateDeCreation)).append("\n");
