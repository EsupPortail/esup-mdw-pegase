...
import fr.univlorraine.pegase.model.chc.AffectationIndividuelleAmenagementAcquisUtilisable;
...
/**
 * AffectationIndividuelleCheminDelibereAcquisition
 */
...
public class AffectationIndividuelleCheminDelibereAcquisition {
  public static final String SERIALIZED_NAME_AMENAGEMENTS_ACQUISITION_LIST = "amenagementsAcquisitionList";
  @SerializedName(SERIALIZED_NAME_AMENAGEMENTS_ACQUISITION_LIST)
  private List<AffectationIndividuelleAmenagementAcquisUtilisable> amenagementsAcquisitionList = null;
  ...
  public AffectationIndividuelleCheminDelibereAcquisition() { 
  }

  public AffectationIndividuelleCheminDelibereAcquisition amenagementsAcquisitionList(List<AffectationIndividuelleAmenagementAcquisUtilisable> amenagementsAcquisitionList) {
    
    this.amenagementsAcquisitionList = amenagementsAcquisitionList;
    return this;
  }

  public AffectationIndividuelleCheminDelibereAcquisition addAmenagementsAcquisitionListItem(AffectationIndividuelleAmenagementAcquisUtilisable amenagementsAcquisitionListItem) {
    if (this.amenagementsAcquisitionList == null) {
      this.amenagementsAcquisitionList = new ArrayList<AffectationIndividuelleAmenagementAcquisUtilisable>();
    }
    this.amenagementsAcquisitionList.add(amenagementsAcquisitionListItem);
    return this;
  }
  ...
  **/
  ...
  public void setAmenagementsAcquisitionList(List<AffectationIndividuelleAmenagementAcquisUtilisable> amenagementsAcquisitionList) {
    this.amenagementsAcquisitionList = amenagementsAcquisitionList;
  }


  public AffectationIndividuelleCheminDelibereAcquisition codeChemin(String codeChemin) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "LIC-CHIMIE>LIC-CHIMIE-A1>LIC-CHIMIE-S1>UE-CHIMIE", value = "le code chemin vers l'objet formation dans le contexte de cet arbre pour lequel l'acquis utilisable est utilisable")
  ...
  public boolean equals(Object o) {
    ...
    AffectationIndividuelleCheminDelibereAcquisition affectationIndividuelleCheminDelibereAcquisition = (AffectationIndividuelleCheminDelibereAcquisition) o;
    return Objects.equals(this.amenagementsAcquisitionList, affectationIndividuelleCheminDelibereAcquisition.amenagementsAcquisitionList) &&
        Objects.equals(this.codeChemin, affectationIndividuelleCheminDelibereAcquisition.codeChemin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amenagementsAcquisitionList, codeChemin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationIndividuelleCheminDelibereAcquisition {\n");
    sb.append("    amenagementsAcquisitionList: ").append(toIndentedString(amenagementsAcquisitionList)).append("\n");
