...
public class Nomenclature {
  ...
  **/
  ...
  public Nomenclature libelleCourt(String libelleCourt) {
   ...
   /**
   * Libelle court du paramétrage
   * @return libelleCourt
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Libelle court du paramétrage")
  ...
  public Nomenclature libelleLong(String libelleLong) {
   ...
   /**
   * Nom complet du paramétrage
   * @return libelleLong
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Nom complet du paramétrage")
  ...
  **/
  ...
  public Nomenclature dateDebutValidite(LocalDate dateDebutValidite) {
   ...
   /**
   * Date du début de la validité du paramétrage
   * @return dateDebutValidite
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date du début de la validité du paramétrage")
  ...
  public Nomenclature dateFinValidite(LocalDate dateFinValidite) {
   ...
   /**
   * Date de la fin de la validité du paramétrage
   * @return dateFinValidite
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date de la fin de la validité du paramétrage")
  ...
  public Nomenclature temoinVisible(Boolean temoinVisible) {
   ...
   /**
   * Témoin de la visibilité du paramétrage
   * @return temoinVisible
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Témoin de la visibilité du paramétrage")
  ...
  public Nomenclature temoinLivre(Boolean temoinLivre) {
   ...
   /**
   * Témoin indiquant si le paramétrage a été livré
   * @return temoinLivre
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Témoin indiquant si le paramétrage a été livré")
