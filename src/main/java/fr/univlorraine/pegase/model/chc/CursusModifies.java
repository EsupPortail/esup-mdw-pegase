...
public class CursusModifies {
  public static final String SERIALIZED_NAME_CURSUS_MODIFIES = "cursusModifies";
  @SerializedName(SERIALIZED_NAME_CURSUS_MODIFIES)
  private List<Cursus> cursusModifies = null;

  public static final String SERIALIZED_NAME_ERREURS = "erreurs";
  @SerializedName(SERIALIZED_NAME_ERREURS)
  private List<CursusErreurMessage> erreurs = null;

  public CursusModifies() { 
  }

  public CursusModifies cursusModifies(List<Cursus> cursusModifies) {
    
    this.cursusModifies = cursusModifies;
    return this;
  }

  public CursusModifies addCursusModifiesItem(Cursus cursusModifiesItem) {
    if (this.cursusModifies == null) {
      this.cursusModifies = new ArrayList<>();
    }
    this.cursusModifies.add(cursusModifiesItem);
    return this;
  }
  ...
  **/
  ...
  public List<Cursus> getCursusModifies() {
    return cursusModifies;
  }


  public void setCursusModifies(List<Cursus> cursusModifies) {
    this.cursusModifies = cursusModifies;
  }


  public CursusModifies erreurs(List<CursusErreurMessage> erreurs) {
    
    this.erreurs = erreurs;
    return this;
  }

  public CursusModifies addErreursItem(CursusErreurMessage erreursItem) {
  ...
  **/
  ...
  public List<CursusErreurMessage> getErreurs() {
    return erreurs;
  }


  public void setErreurs(List<CursusErreurMessage> erreurs) {
    this.erreurs = erreurs;
  }
  ...
  public boolean equals(Object o) {
    ...
    CursusModifies cursusModifies = (CursusModifies) o;
    return Objects.equals(this.cursusModifies, cursusModifies.cursusModifies) &&
        Objects.equals(this.erreurs, cursusModifies.erreurs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusModifies, erreurs);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CursusModifies {\n");
    sb.append("    cursusModifies: ").append(toIndentedString(cursusModifies)).append("\n");
