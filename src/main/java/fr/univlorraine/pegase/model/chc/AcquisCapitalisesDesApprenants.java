...
import fr.univlorraine.pegase.model.chc.AcquisCapitalise;
...
/**
 * AcquisCapitalisesDesApprenants
 */
...
public class AcquisCapitalisesDesApprenants {
  ...
  public static final String SERIALIZED_NAME_LISTE_ACQUIS_CAPITALISES = "listeAcquisCapitalises";
  @SerializedName(SERIALIZED_NAME_LISTE_ACQUIS_CAPITALISES)
  private List<AcquisCapitalise> listeAcquisCapitalises = null;

  public AcquisCapitalisesDesApprenants() { 
  }

  public AcquisCapitalisesDesApprenants codeApprenant(String codeApprenant) {
  ...
  **/
  ...
  @ApiModelProperty(example = "20210078", required = true, value = "le code de l'apprenant")
  ...
  public AcquisCapitalisesDesApprenants listeAcquisCapitalises(List<AcquisCapitalise> listeAcquisCapitalises) {
    
    this.listeAcquisCapitalises = listeAcquisCapitalises;
    return this;
  }

  public AcquisCapitalisesDesApprenants addListeAcquisCapitalisesItem(AcquisCapitalise listeAcquisCapitalisesItem) {
    if (this.listeAcquisCapitalises == null) {
      this.listeAcquisCapitalises = new ArrayList<>();
    }
    this.listeAcquisCapitalises.add(listeAcquisCapitalisesItem);
    return this;
  }

   /**
   * La liste des capitalisés de l&#39;apprenant dans le contexte de cet arbre
   * @return listeAcquisCapitalises
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "La liste des capitalisés de l'apprenant dans le contexte de cet arbre")

  public List<AcquisCapitalise> getListeAcquisCapitalises() {
    return listeAcquisCapitalises;
  }


  public void setListeAcquisCapitalises(List<AcquisCapitalise> listeAcquisCapitalises) {
    this.listeAcquisCapitalises = listeAcquisCapitalises;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcquisCapitalisesDesApprenants acquisCapitalisesDesApprenants = (AcquisCapitalisesDesApprenants) o;
    return Objects.equals(this.codeApprenant, acquisCapitalisesDesApprenants.codeApprenant) &&
        Objects.equals(this.listeAcquisCapitalises, acquisCapitalisesDesApprenants.listeAcquisCapitalises);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeApprenant, listeAcquisCapitalises);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AcquisCapitalisesDesApprenants {\n");
    sb.append("    codeApprenant: ").append(toIndentedString(codeApprenant)).append("\n");
    sb.append("    listeAcquisCapitalises: ").append(toIndentedString(listeAcquisCapitalises)).append("\n");
    sb.append("}");
    return sb.toString();
  }
