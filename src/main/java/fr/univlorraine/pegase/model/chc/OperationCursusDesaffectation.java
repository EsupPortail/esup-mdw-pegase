...
public class OperationCursusDesaffectation extends OperationCursus {
  public OperationCursusDesaffectation() { 
  ...
  public String toString() {
    ...
    sb.append("class OperationCursusDesaffectation {\n");
