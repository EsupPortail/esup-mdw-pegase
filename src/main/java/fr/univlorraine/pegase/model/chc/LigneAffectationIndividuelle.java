...
/**
 * Une ligne de l&#39;arbre de la lecture pédagogique
 */
@ApiModel(description = "Une ligne de l'arbre de la lecture pédagogique")
...
public class LigneAffectationIndividuelle {
  ...
  private List<LigneAffectationIndividuelle> enfants = null;

  public LigneAffectationIndividuelle() { 
  }

  public LigneAffectationIndividuelle infosObjetMaquette(InfosObjetMaquette infosObjetMaquette) {
  ...
  **/
  ...
  public LigneAffectationIndividuelle infosPedagogique(InfosPedagogique infosPedagogique) {
  ...
  **/
  ...
  public LigneAffectationIndividuelle possibilitesPedagogiques(PossibilitesPedagogiques possibilitesPedagogiques) {
  ...
  **/
  ...
  public LigneAffectationIndividuelle enfants(List<LigneAffectationIndividuelle> enfants) {
    
    this.enfants = enfants;
    return this;
  }

  public LigneAffectationIndividuelle addEnfantsItem(LigneAffectationIndividuelle enfantsItem) {
    if (this.enfants == null) {
      this.enfants = new ArrayList<LigneAffectationIndividuelle>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les lignes filles dans l'arbre de la lecture pédagogique")
  ...
  public void setEnfants(List<LigneAffectationIndividuelle> enfants) {
    this.enfants = enfants;
  }
  ...
  public boolean equals(Object o) {
    ...
    LigneAffectationIndividuelle ligneAffectationIndividuelle = (LigneAffectationIndividuelle) o;
    return Objects.equals(this.infosObjetMaquette, ligneAffectationIndividuelle.infosObjetMaquette) &&
        Objects.equals(this.infosPedagogique, ligneAffectationIndividuelle.infosPedagogique) &&
        Objects.equals(this.possibilitesPedagogiques, ligneAffectationIndividuelle.possibilitesPedagogiques) &&
        Objects.equals(this.enfants, ligneAffectationIndividuelle.enfants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(infosObjetMaquette, infosPedagogique, possibilitesPedagogiques, enfants);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LigneAffectationIndividuelle {\n");
