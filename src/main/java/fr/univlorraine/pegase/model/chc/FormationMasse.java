...
public class FormationMasse {
  ...
  private BigDecimal versionMaquette;

  public FormationMasse() { 
  }

  public FormationMasse id(UUID id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "L'id technique de la formation")
  ...
  public FormationMasse code(String code) {
  ...
  **/
  ...
  public FormationMasse libelle(String libelle) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libelle de la formation")
  ...
  public FormationMasse type(String type) {
  ...
  **/
  ...
  public FormationMasse versionMaquette(BigDecimal versionMaquette) {
  ...
  **/
  ...
  public BigDecimal getVersionMaquette() {
    return versionMaquette;
  }


  public void setVersionMaquette(BigDecimal versionMaquette) {
    this.versionMaquette = versionMaquette;
  }
  ...
  public boolean equals(Object o) {
    ...
    FormationMasse formationMasse = (FormationMasse) o;
    return Objects.equals(this.id, formationMasse.id) &&
        Objects.equals(this.code, formationMasse.code) &&
        Objects.equals(this.libelle, formationMasse.libelle) &&
        Objects.equals(this.type, formationMasse.type) &&
        Objects.equals(this.versionMaquette, formationMasse.versionMaquette);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, libelle, type, versionMaquette);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormationMasse {\n");
