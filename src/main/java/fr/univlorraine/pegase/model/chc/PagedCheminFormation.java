...
import fr.univlorraine.pegase.model.chc.CheminFormation;
import fr.univlorraine.pegase.model.chc.CheminFormations;
...
public class PagedCheminFormation {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CheminFormation> items = null;
  ...
  public PagedCheminFormation() { 
  }

  public PagedCheminFormation items(List<CheminFormation> items) {
    
    this.items = items;
    return this;
  }

  public PagedCheminFormation addItemsItem(CheminFormation itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CheminFormation>();
    }
  ...
  **/
  ...
  public List<CheminFormation> getItems() {
    return items;
  }


  public void setItems(List<CheminFormation> items) {
    this.items = items;
  }


  public PagedCheminFormation totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedCheminFormation totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedCheminFormation taille(Integer taille) {
  ...
  **/
  ...
  public PagedCheminFormation page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedCheminFormation pagedCheminFormation = (PagedCheminFormation) o;
    return Objects.equals(this.items, pagedCheminFormation.items) &&
        Objects.equals(this.totalElements, pagedCheminFormation.totalElements) &&
        Objects.equals(this.totalPages, pagedCheminFormation.totalPages) &&
        Objects.equals(this.taille, pagedCheminFormation.taille) &&
        Objects.equals(this.page, pagedCheminFormation.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedCheminFormation {\n");
