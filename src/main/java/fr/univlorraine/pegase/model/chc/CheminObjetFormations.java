...
public class CheminObjetFormations {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CheminObjetFormation> items = null;

  public CheminObjetFormations() { 
  }

  public CheminObjetFormations items(List<CheminObjetFormation> items) {
    
    this.items = items;
    return this;
  }

  public CheminObjetFormations addItemsItem(CheminObjetFormation itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CheminObjetFormations cheminObjetFormations = (CheminObjetFormations) o;
    return Objects.equals(this.items, cheminObjetFormations.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheminObjetFormations {\n");
