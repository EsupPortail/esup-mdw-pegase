...
public class CustomPageable {
  ...
  public CustomPageable page(Integer page) {
  ...
  **/
  ...
  public CustomPageable taille(Integer taille) {
  ...
  **/
  ...
  public CustomPageable tri(List<String> tri) {
    
    this.tri = tri;
    return this;
  }

  public CustomPageable addTriItem(String triItem) {
    if (this.tri == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomPageable customPageable = (CustomPageable) o;
    return Objects.equals(this.page, customPageable.page) &&
        Objects.equals(this.taille, customPageable.taille) &&
        Objects.equals(this.tri, customPageable.tri);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomPageable {\n");
