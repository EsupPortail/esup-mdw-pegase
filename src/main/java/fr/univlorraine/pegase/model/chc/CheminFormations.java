...
public class CheminFormations {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CheminFormation> items = null;

  public CheminFormations() { 
  }

  public CheminFormations items(List<CheminFormation> items) {
    
    this.items = items;
    return this;
  }

  public CheminFormations addItemsItem(CheminFormation itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CheminFormations cheminFormations = (CheminFormations) o;
    return Objects.equals(this.items, cheminFormations.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheminFormations {\n");
