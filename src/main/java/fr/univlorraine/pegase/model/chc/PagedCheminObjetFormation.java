...
import fr.univlorraine.pegase.model.chc.CheminObjetFormation;
import fr.univlorraine.pegase.model.chc.CheminObjetFormations;
...
public class PagedCheminObjetFormation {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CheminObjetFormation> items = null;
  ...
  public PagedCheminObjetFormation items(List<CheminObjetFormation> items) {
    
    this.items = items;
    return this;
  }

  public PagedCheminObjetFormation addItemsItem(CheminObjetFormation itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CheminObjetFormation>();
    }
  ...
  **/
  ...
  public List<CheminObjetFormation> getItems() {
    return items;
  }


  public void setItems(List<CheminObjetFormation> items) {
    this.items = items;
  }


  public PagedCheminObjetFormation totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedCheminObjetFormation totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedCheminObjetFormation taille(Integer taille) {
  ...
  **/
  ...
  public PagedCheminObjetFormation page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedCheminObjetFormation pagedCheminObjetFormation = (PagedCheminObjetFormation) o;
    return Objects.equals(this.items, pagedCheminObjetFormation.items) &&
        Objects.equals(this.totalElements, pagedCheminObjetFormation.totalElements) &&
        Objects.equals(this.totalPages, pagedCheminObjetFormation.totalPages) &&
        Objects.equals(this.taille, pagedCheminObjetFormation.taille) &&
        Objects.equals(this.page, pagedCheminObjetFormation.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedCheminObjetFormation {\n");
