...
import fr.univlorraine.pegase.model.chc.AffectationIndividuelleAcquisUtilisableParAmenagement;
import fr.univlorraine.pegase.model.chc.AffectationIndividuelleAcquisUtilisableParEvaluation;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import java.io.IOException;

/**
 * AffectationIndividuelleAcquisUtilisable
 */
...
public class AffectationIndividuelleAcquisUtilisable {
  public static final String SERIALIZED_NAME_ACQUIS_UTILISABLE_PAR_EVALUATION = "acquisUtilisableParEvaluation";
  @SerializedName(SERIALIZED_NAME_ACQUIS_UTILISABLE_PAR_EVALUATION)
  private AffectationIndividuelleAcquisUtilisableParEvaluation acquisUtilisableParEvaluation;

  public static final String SERIALIZED_NAME_ACQUIS_UTILISABLE_PAR_AMENAGEMENT = "acquisUtilisableParAmenagement";
  @SerializedName(SERIALIZED_NAME_ACQUIS_UTILISABLE_PAR_AMENAGEMENT)
  private AffectationIndividuelleAcquisUtilisableParAmenagement acquisUtilisableParAmenagement;

  public AffectationIndividuelleAcquisUtilisable() { 
  }

  public AffectationIndividuelleAcquisUtilisable acquisUtilisableParEvaluation(AffectationIndividuelleAcquisUtilisableParEvaluation acquisUtilisableParEvaluation) {
    
    this.acquisUtilisableParEvaluation = acquisUtilisableParEvaluation;
    return this;
  }
  ...
  **/
  ...
  public void setAcquisUtilisableParEvaluation(AffectationIndividuelleAcquisUtilisableParEvaluation acquisUtilisableParEvaluation) {
    this.acquisUtilisableParEvaluation = acquisUtilisableParEvaluation;
  }


  public AffectationIndividuelleAcquisUtilisable acquisUtilisableParAmenagement(AffectationIndividuelleAcquisUtilisableParAmenagement acquisUtilisableParAmenagement) {
    
    this.acquisUtilisableParAmenagement = acquisUtilisableParAmenagement;
    return this;
  }
  ...
  **/
  ...
  public void setAcquisUtilisableParAmenagement(AffectationIndividuelleAcquisUtilisableParAmenagement acquisUtilisableParAmenagement) {
    this.acquisUtilisableParAmenagement = acquisUtilisableParAmenagement;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationIndividuelleAcquisUtilisable affectationIndividuelleAcquisUtilisable = (AffectationIndividuelleAcquisUtilisable) o;
    return Objects.equals(this.acquisUtilisableParEvaluation, affectationIndividuelleAcquisUtilisable.acquisUtilisableParEvaluation) &&
        Objects.equals(this.acquisUtilisableParAmenagement, affectationIndividuelleAcquisUtilisable.acquisUtilisableParAmenagement);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acquisUtilisableParEvaluation, acquisUtilisableParAmenagement);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationIndividuelleAcquisUtilisable {\n");
    sb.append("    acquisUtilisableParEvaluation: ").append(toIndentedString(acquisUtilisableParEvaluation)).append("\n");
    sb.append("    acquisUtilisableParAmenagement: ").append(toIndentedString(acquisUtilisableParAmenagement)).append("\n");
    sb.append("}");
    return sb.toString();
  }
