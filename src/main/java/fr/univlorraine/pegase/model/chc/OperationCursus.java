...
import fr.univlorraine.pegase.model.chc.OperationCursusAffectation;
import fr.univlorraine.pegase.model.chc.OperationCursusAjoutAmenagement;
import fr.univlorraine.pegase.model.chc.OperationCursusDesaffectation;
import fr.univlorraine.pegase.model.chc.OperationCursusEnleverAmenagement;
...
public class OperationCursus {
  /**
   * Gets or Sets op
   */
  @JsonAdapter(OpEnum.Adapter.class)
  public enum OpEnum {
    OPERATIONCURSUSAFFECTATION("OperationCursusAffectation"),
    
    OPERATIONCURSUSDESAFFECTATION("OperationCursusDesaffectation"),
    
    OPERATIONCURSUSAJOUTAMENAGEMENT("OperationCursusAjoutAmenagement"),
    
    OPERATIONCURSUSENLEVERAMENAGEMENT("OperationCursusEnleverAmenagement");
  ...
  public OperationCursus() { 
    this.op =  OperationCursus.OpEnum.fromValue(this.getClass().getSimpleName());
  }

  public OperationCursus op(OpEnum op) {
  ...
  **/
  ...
  public OperationCursus codeChemin(String codeChemin) {
  ...
  **/
  ...
  public OperationCursus apprenant(String apprenant) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OperationCursus operationCursus = (OperationCursus) o;
    return Objects.equals(this.op, operationCursus.op) &&
        Objects.equals(this.codeChemin, operationCursus.codeChemin) &&
        Objects.equals(this.apprenant, operationCursus.apprenant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(op, codeChemin, apprenant);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OperationCursus {\n");
