...
import fr.univlorraine.pegase.model.chc.ApprenantCompositionCursus;
...
/**
 * apprenant lié à une composition, via son affectation à un ou des ObjetFormation(s) (ou Formation(s)) associé à cette composition, à un ou des chemins par ObjetFormation (ou Formation), de son cursus 
 */
@ApiModel(description = "apprenant lié à une composition, via son affectation à un ou des ObjetFormation(s) (ou Formation(s)) associé à cette composition, à un ou des chemins par ObjetFormation (ou Formation), de son cursus ")
...
public class ApprenantComposition {
  ...
  private List<ApprenantCompositionCursus> cursus = null;

  public ApprenantComposition() { 
  }

  public ApprenantComposition apprenant(Apprenant apprenant) {
  ...
  **/
  ...
  public ApprenantComposition cursus(List<ApprenantCompositionCursus> cursus) {
    
    this.cursus = cursus;
    return this;
  }

  public ApprenantComposition addCursusItem(ApprenantCompositionCursus cursusItem) {
    if (this.cursus == null) {
   ...
   /**
   * liste des code chemins des objet de formation (ou formation) de son cursus associés à la composition
   * @return cursus
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "liste des code chemins des objet de formation (ou formation) de son cursus associés à la composition")
  ...
  public void setCursus(List<ApprenantCompositionCursus> cursus) {
    this.cursus = cursus;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApprenantComposition apprenantComposition = (ApprenantComposition) o;
    return Objects.equals(this.apprenant, apprenantComposition.apprenant) &&
        Objects.equals(this.cursus, apprenantComposition.cursus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apprenant, cursus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApprenantComposition {\n");
