...
import fr.univlorraine.pegase.model.chc.OperationCursusAffectationAllOf;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import java.io.IOException;

/**
 * OperationCursusAffectation
 */
...
public class OperationCursusAffectation extends OperationCursus {
  public static final String SERIALIZED_NAME_DESCENDANCE = "descendance";
  @SerializedName(SERIALIZED_NAME_DESCENDANCE)
  private Boolean descendance = true;

  public OperationCursusAffectation() { 
    this.op = OperationCursus.OpEnum.fromValue(this.getClass().getSimpleName());
  }

  public OperationCursusAffectation descendance(Boolean descendance) {
  ...
  **/
  ...
  public Boolean getDescendance() {
    return descendance;
  }


  public void setDescendance(Boolean descendance) {
    this.descendance = descendance;
  }
  ...
  public boolean equals(Object o) {
    ...
    OperationCursusAffectation operationCursusAffectation = (OperationCursusAffectation) o;
    return Objects.equals(this.descendance, operationCursusAffectation.descendance) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(descendance, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OperationCursusAffectation {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    descendance: ").append(toIndentedString(descendance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
