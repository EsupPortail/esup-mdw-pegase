...
import fr.univlorraine.pegase.model.chc.Colonnes;
import fr.univlorraine.pegase.model.chc.ElementSelectionne;
...
/**
 * ParametresEditionListeAppelEmargement
 */
...
public class ParametresEditionListeAppelEmargement {
  ...
  private LocalDate dateDuCours;

  public static final String SERIALIZED_NAME_ELEMENTS_SELECTIONNES = "elementsSelectionnes";
  @SerializedName(SERIALIZED_NAME_ELEMENTS_SELECTIONNES)
  private List<ElementSelectionne> elementsSelectionnes = new ArrayList<>();
  ...
  public ParametresEditionListeAppelEmargement() { 
  }

  public ParametresEditionListeAppelEmargement dateDuCours(LocalDate dateDuCours) {
  ...
  **/
  ...
  public LocalDate getDateDuCours() {
    return dateDuCours;
  }


  public void setDateDuCours(LocalDate dateDuCours) {
    this.dateDuCours = dateDuCours;
  }


  public ParametresEditionListeAppelEmargement elementsSelectionnes(List<ElementSelectionne> elementsSelectionnes) {
    
    this.elementsSelectionnes = elementsSelectionnes;
    return this;
  }

  public ParametresEditionListeAppelEmargement addElementsSelectionnesItem(ElementSelectionne elementsSelectionnesItem) {
    this.elementsSelectionnes.add(elementsSelectionnesItem);
    return this;
  }
  ...
  **/
  ...
  public void setElementsSelectionnes(List<ElementSelectionne> elementsSelectionnes) {
    this.elementsSelectionnes = elementsSelectionnes;
  }


  public ParametresEditionListeAppelEmargement colonnes(Colonnes colonnes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement = (ParametresEditionListeAppelEmargement) o;
    return Objects.equals(this.dateDuCours, parametresEditionListeAppelEmargement.dateDuCours) &&
        Objects.equals(this.elementsSelectionnes, parametresEditionListeAppelEmargement.elementsSelectionnes) &&
        Objects.equals(this.colonnes, parametresEditionListeAppelEmargement.colonnes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateDuCours, elementsSelectionnes, colonnes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ParametresEditionListeAppelEmargement {\n");
    sb.append("    dateDuCours: ").append(toIndentedString(dateDuCours)).append("\n");
    sb.append("    elementsSelectionnes: ").append(toIndentedString(elementsSelectionnes)).append("\n");
