...
public class ParametresEditionListeAppelEmargement {
  ...
  private List<ElementSelectionne> elementsSelectionnes = new ArrayList<ElementSelectionne>();
  ...
  public ParametresEditionListeAppelEmargement dateDuCours(Date dateDuCours) {
