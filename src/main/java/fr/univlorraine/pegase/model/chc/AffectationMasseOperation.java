...
public class AffectationMasseOperation {
  public static final String SERIALIZED_NAME_COMMANDE = "commande";
  @SerializedName(SERIALIZED_NAME_COMMANDE)
  private String commande;

  public static final String SERIALIZED_NAME_CURSUS_ID = "cursusId";
  @SerializedName(SERIALIZED_NAME_CURSUS_ID)
  private UUID cursusId;

  public static final String SERIALIZED_NAME_AVEC_CREATION_BROUILLON = "avecCreationBrouillon";
  @SerializedName(SERIALIZED_NAME_AVEC_CREATION_BROUILLON)
  private Boolean avecCreationBrouillon;

  public AffectationMasseOperation() { 
  }

  public AffectationMasseOperation commande(String commande) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "La commande à effectuer")
  ...
  public AffectationMasseOperation cursusId(UUID cursusId) {
  ...
  **/
  ...
  public void setCursusId(UUID cursusId) {
    this.cursusId = cursusId;
  }


  public AffectationMasseOperation avecCreationBrouillon(Boolean avecCreationBrouillon) {
    
    this.avecCreationBrouillon = avecCreationBrouillon;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "spécifie si le brouillon doit etre créé")
  ...
  public void setAvecCreationBrouillon(Boolean avecCreationBrouillon) {
    this.avecCreationBrouillon = avecCreationBrouillon;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationMasseOperation affectationMasseOperation = (AffectationMasseOperation) o;
    return Objects.equals(this.commande, affectationMasseOperation.commande) &&
        Objects.equals(this.cursusId, affectationMasseOperation.cursusId) &&
        Objects.equals(this.avecCreationBrouillon, affectationMasseOperation.avecCreationBrouillon);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commande, cursusId, avecCreationBrouillon);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationMasseOperation {\n");
    sb.append("    commande: ").append(toIndentedString(commande)).append("\n");
    sb.append("    cursusId: ").append(toIndentedString(cursusId)).append("\n");
    sb.append("    avecCreationBrouillon: ").append(toIndentedString(avecCreationBrouillon)).append("\n");
    sb.append("}");
    return sb.toString();
  }
