...
import fr.univlorraine.pegase.model.chc.AffectationMasseErreur;
import fr.univlorraine.pegase.model.chc.LigneAffectationMasse;
...
public class AffectationMasseResponse {
  public static final String SERIALIZED_NAME_CURSUS_EN_ERREUR = "cursusEnErreur";
  @SerializedName(SERIALIZED_NAME_CURSUS_EN_ERREUR)
  private List<AffectationMasseErreur> cursusEnErreur = null;

  public static final String SERIALIZED_NAME_LIGNES_AFFECTATION_MASSE = "lignesAffectationMasse";
  @SerializedName(SERIALIZED_NAME_LIGNES_AFFECTATION_MASSE)
  private List<LigneAffectationMasse> lignesAffectationMasse = null;

  public AffectationMasseResponse() { 
  }

  public AffectationMasseResponse cursusEnErreur(List<AffectationMasseErreur> cursusEnErreur) {
    
    this.cursusEnErreur = cursusEnErreur;
    return this;
  }

  public AffectationMasseResponse addCursusEnErreurItem(AffectationMasseErreur cursusEnErreurItem) {
    if (this.cursusEnErreur == null) {
      this.cursusEnErreur = new ArrayList<AffectationMasseErreur>();
    }
    this.cursusEnErreur.add(cursusEnErreurItem);
    return this;
  }
  ...
  **/
  ...
  public void setCursusEnErreur(List<AffectationMasseErreur> cursusEnErreur) {
    this.cursusEnErreur = cursusEnErreur;
  }


  public AffectationMasseResponse lignesAffectationMasse(List<LigneAffectationMasse> lignesAffectationMasse) {
    
    this.lignesAffectationMasse = lignesAffectationMasse;
    return this;
  }

  public AffectationMasseResponse addLignesAffectationMasseItem(LigneAffectationMasse lignesAffectationMasseItem) {
    if (this.lignesAffectationMasse == null) {
      this.lignesAffectationMasse = new ArrayList<LigneAffectationMasse>();
    }
    this.lignesAffectationMasse.add(lignesAffectationMasseItem);
    return this;
  }
  ...
  **/
  ...
  public void setLignesAffectationMasse(List<LigneAffectationMasse> lignesAffectationMasse) {
    this.lignesAffectationMasse = lignesAffectationMasse;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationMasseResponse affectationMasseResponse = (AffectationMasseResponse) o;
    return Objects.equals(this.cursusEnErreur, affectationMasseResponse.cursusEnErreur) &&
        Objects.equals(this.lignesAffectationMasse, affectationMasseResponse.lignesAffectationMasse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusEnErreur, lignesAffectationMasse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationMasseResponse {\n");
    sb.append("    cursusEnErreur: ").append(toIndentedString(cursusEnErreur)).append("\n");
    sb.append("    lignesAffectationMasse: ").append(toIndentedString(lignesAffectationMasse)).append("\n");
    sb.append("}");
    return sb.toString();
  }
