...
public class Erreurs {
  ...
  **/
  ...
  public Erreurs timestamp(LocalDateTime timestamp) {
   ...
   /**
   * Timestamp auquel à lieu l&#39;erreur.  A titre de debugging. 
   * @return timestamp
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Timestamp auquel à lieu l'erreur.  A titre de debugging. ")
  ...
  **/
  ...
  public Erreurs path(String path) {
   ...
   /**
   * URI sur lequel le service a été appelé (i.e /api/monservice).  A titre de debugging. 
   * @return path
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "URI sur lequel le service a été appelé (i.e /api/monservice).  A titre de debugging. ")
