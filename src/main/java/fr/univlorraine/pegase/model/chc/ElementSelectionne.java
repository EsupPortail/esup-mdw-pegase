...
public class ElementSelectionne {
  public static final String SERIALIZED_NAME_CODE_CHEMINS = "codeChemins";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMINS)
  private List<String> codeChemins = new ArrayList<String>();

  public static final String SERIALIZED_NAME_CODE_COMPOSITION = "codeComposition";
  @SerializedName(SERIALIZED_NAME_CODE_COMPOSITION)
  private String codeComposition;

  public static final String SERIALIZED_NAME_CODE_GROUPE = "codeGroupe";
  @SerializedName(SERIALIZED_NAME_CODE_GROUPE)
  private String codeGroupe;

  public ElementSelectionne() { 
  }

  public ElementSelectionne codeChemins(List<String> codeChemins) {
    
    this.codeChemins = codeChemins;
    return this;
  }

  public ElementSelectionne addCodeCheminsItem(String codeCheminsItem) {
    this.codeChemins.add(codeCheminsItem);
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "liste qui contient soit le code chemin de la formation sélectionnée, soit le code chemin de l'objet maquette sélectionné, soit le code chemin de l'objet maquette pour le groupe sélectionné, soit les code chemins qui mène à l'objet maquette (mutualisé) pour le groupe sélectionné")
  ...
  public void setCodeChemins(List<String> codeChemins) {
    this.codeChemins = codeChemins;
  }


  public ElementSelectionne codeComposition(String codeComposition) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Le code de la composition")
  ...
  public ElementSelectionne codeGroupe(String codeGroupe) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le code du groupe de la composition spécifié")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeChemins, elementSelectionne.codeChemins) &&
        Objects.equals(this.codeComposition, elementSelectionne.codeComposition) &&
        Objects.equals(this.codeGroupe, elementSelectionne.codeGroupe);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeChemins, codeComposition, codeGroupe);
  }
  ...
  public String toString() {
    ...
    sb.append("    codeChemins: ").append(toIndentedString(codeChemins)).append("\n");
    sb.append("    codeComposition: ").append(toIndentedString(codeComposition)).append("\n");
    sb.append("    codeGroupe: ").append(toIndentedString(codeGroupe)).append("\n");
    sb.append("}");
    return sb.toString();
  }
