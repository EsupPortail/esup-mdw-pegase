...
public class AcquisCapitalise {
  public static final String SERIALIZED_NAME_CODE_CHEMIN_OBJET_FOMATION = "codeCheminObjetFomation";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_OBJET_FOMATION)
  private String codeCheminObjetFomation;
  ...
  public static final String SERIALIZED_NAME_CODE_TYPE_RESULTAT = "codeTypeResultat";
  @SerializedName(SERIALIZED_NAME_CODE_TYPE_RESULTAT)
  private String codeTypeResultat;
  ...
  public AcquisCapitalise codeCheminObjetFomation(String codeCheminObjetFomation) {
    
    this.codeCheminObjetFomation = codeCheminObjetFomation;
    return this;
  }

   /**
   * le code chemin vers l&#39;objet formation dans le contexte de cet arbre
   * @return codeCheminObjetFomation
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "LIC-CHIMIE>LIC-CHIMIE-A1>LIC-CHIMIE-S1>UE-CHIMIE", required = true, value = "le code chemin vers l'objet formation dans le contexte de cet arbre")

  public String getCodeCheminObjetFomation() {
    return codeCheminObjetFomation;
  }


  public void setCodeCheminObjetFomation(String codeCheminObjetFomation) {
    this.codeCheminObjetFomation = codeCheminObjetFomation;
  }


  public AcquisCapitalise codePeriodeAcquisition(String codePeriodeAcquisition) {
   ...
   /**
   * La période à laquelle il y a eu l&#39;acquisition
   * @return codePeriodeAcquisition
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "La période à laquelle il y a eu l'acquisition")
  ...
  public AcquisCapitalise codeObjetFormationAcquisition(String codeObjetFormationAcquisition) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "L'objet sur lequel il y a eu l'acquisition (différent de l'objet du chemin dans le cas des LCC par exemple)")
  ...
  public AcquisCapitalise noteFinale(String noteFinale) {
  ...
  **/
  ...
  public AcquisCapitalise bareme(Integer bareme) {
  ...
  **/
  ...
  public AcquisCapitalise codeTypeResultat(String codeTypeResultat) {
    
    this.codeTypeResultat = codeTypeResultat;
    return this;
  }

   /**
   * code du type de résultat final
   * @return codeTypeResultat
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "code du type de résultat final")

  public String getCodeTypeResultat() {
    return codeTypeResultat;
  }


  public void setCodeTypeResultat(String codeTypeResultat) {
    this.codeTypeResultat = codeTypeResultat;
  }


  public AcquisCapitalise numeroSessionRetenueNote(Integer numeroSessionRetenueNote) {
   ...
   /**
   * Le numéro de session de la note retenue
   * @return numeroSessionRetenueNote
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Le numéro de session de la note retenue")
  ...
  public AcquisCapitalise numeroSessionRetenueResultat(Integer numeroSessionRetenueResultat) {
   ...
   /**
   * Le numéro de session du résultat retenu
   * @return numeroSessionRetenueResultat
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "Le numéro de session du résultat retenu")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeCheminObjetFomation, acquisCapitalise.codeCheminObjetFomation) &&
        Objects.equals(this.codePeriodeAcquisition, acquisCapitalise.codePeriodeAcquisition) &&
        ...
        Objects.equals(this.codeTypeResultat, acquisCapitalise.codeTypeResultat) &&
        Objects.equals(this.numeroSessionRetenueNote, acquisCapitalise.numeroSessionRetenueNote) &&
        Objects.equals(this.numeroSessionRetenueResultat, acquisCapitalise.numeroSessionRetenueResultat);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeCheminObjetFomation, codePeriodeAcquisition, codeObjetFormationAcquisition, noteFinale, bareme, codeTypeResultat, numeroSessionRetenueNote, numeroSessionRetenueResultat);
  }
  ...
  public String toString() {
    ...
    sb.append("    codeCheminObjetFomation: ").append(toIndentedString(codeCheminObjetFomation)).append("\n");
    ...
    sb.append("    codeTypeResultat: ").append(toIndentedString(codeTypeResultat)).append("\n");
