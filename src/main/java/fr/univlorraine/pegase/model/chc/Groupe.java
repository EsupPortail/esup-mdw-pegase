...
import fr.univlorraine.pegase.model.chc.GroupeCapaciteAccueil;
...
public class Groupe {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, description, listeDiffusion, capaciteAccueil);
  }
