...
public class ApprenantExtention {
  ...
  public static final String SERIALIZED_NAME_CODE_CHEMIN_I_A = "codeCheminIA";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_I_A)
  private String codeCheminIA;
  ...
  **/
  ...
  public ApprenantExtention codeCheminIA(String codeCheminIA) {
    
    this.codeCheminIA = codeCheminIA;
    return this;
  }

   /**
   * Le code chemin de l&#39;inscription administative qui conduit l&#39;apprenant à avoir un cursus sur l&#39;objet maquette
   * @return codeCheminIA
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le code chemin de l'inscription administative qui conduit l'apprenant à avoir un cursus sur l'objet maquette")

  public String getCodeCheminIA() {
    return codeCheminIA;
  }


  public void setCodeCheminIA(String codeCheminIA) {
    this.codeCheminIA = codeCheminIA;
  }
  ...
  **/
  ...
  public ApprenantExtention temoinObligatoire(Boolean temoinObligatoire) {
   ...
   /**
   * Est ce que l&#39;objet maquette du cursus est obligatoire?
   * @return temoinObligatoire
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Est ce que l'objet maquette du cursus est obligatoire?")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeApprenant, apprenantExtention.codeApprenant) &&
        ...
        Objects.equals(this.codeCheminIA, apprenantExtention.codeCheminIA) &&
        Objects.equals(this.typeAmenagementLst, apprenantExtention.typeAmenagementLst) &&
        Objects.equals(this.temoinObligatoire, apprenantExtention.temoinObligatoire);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeApprenant, ine, nomFamille, prenom, dateNaissance, plageChoix, temoinAffecte, temoinAcquis, codeCheminIA, typeAmenagementLst, temoinObligatoire);
  }
  ...
  public String toString() {
    ...
    sb.append("    codeCheminIA: ").append(toIndentedString(codeCheminIA)).append("\n");
