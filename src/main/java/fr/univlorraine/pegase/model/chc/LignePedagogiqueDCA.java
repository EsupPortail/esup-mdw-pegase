...
public class LignePedagogiqueDCA {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codeObjetMaquette, libelleLongObjetMaquette, libelleAffichageTypeObjetFormation, estObligatoire, creditEcts, amenagements, acquisCapitalise, enfants);
  }
