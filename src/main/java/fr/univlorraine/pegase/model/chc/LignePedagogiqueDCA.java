...
import fr.univlorraine.pegase.model.chc.AcquisCapitaliseDCA;
...
public class LignePedagogiqueDCA {
  ...
  private List<AmenagementDCA> amenagements = null;
  ...
  private AcquisCapitaliseDCA acquisCapitalise;
  ...
  private List<LignePedagogiqueDCA> enfants = null;

  public LignePedagogiqueDCA() { 
  }

  public LignePedagogiqueDCA codeObjetMaquette(String codeObjetMaquette) {
  ...
  **/
  ...
  @ApiModelProperty(value = "code de l'objet maquette (formation, objet formation ou groupement)")
  ...
  public LignePedagogiqueDCA libelleLongObjetMaquette(String libelleLongObjetMaquette) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "libellé long de l'objet maquette (formation, objet formation ou groupement)")
  ...
  public void setLibelleLongObjetMaquette(String libelleLongObjetMaquette) {
    this.libelleLongObjetMaquette = libelleLongObjetMaquette;
  }


  public LignePedagogiqueDCA libelleAffichageTypeObjetFormation(String libelleAffichageTypeObjetFormation) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "libellé d'affichage du type objet formation")
  ...
  public void setLibelleAffichageTypeObjetFormation(String libelleAffichageTypeObjetFormation) {
    this.libelleAffichageTypeObjetFormation = libelleAffichageTypeObjetFormation;
  }


  public LignePedagogiqueDCA estObligatoire(Boolean estObligatoire) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "si l'objet maquette est obligatoire pour ce code chemin")
  ...
  public LignePedagogiqueDCA creditEcts(Double creditEcts) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "le nombre de crédit ECTS de l'objet maquette pour ce code chemin")
  ...
  public LignePedagogiqueDCA amenagements(List<AmenagementDCA> amenagements) {
    
    this.amenagements = amenagements;
    return this;
  }

  public LignePedagogiqueDCA addAmenagementsItem(AmenagementDCA amenagementsItem) {
    if (this.amenagements == null) {
      this.amenagements = new ArrayList<AmenagementDCA>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "liste des aménagements du choix pédagogique")
  ...
  public void setAmenagements(List<AmenagementDCA> amenagements) {
    this.amenagements = amenagements;
  }


  public LignePedagogiqueDCA acquisCapitalise(AcquisCapitaliseDCA acquisCapitalise) {
  ...
  **/
  ...
  public void setAcquisCapitalise(AcquisCapitaliseDCA acquisCapitalise) {
    this.acquisCapitalise = acquisCapitalise;
  }


  public LignePedagogiqueDCA typeChoixPedagogique(TypeChoixPedagogiqueEnum typeChoixPedagogique) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Enum des differents type de choix pedagogique")
  ...
  public void setTypeChoixPedagogique(TypeChoixPedagogiqueEnum typeChoixPedagogique) {
    this.typeChoixPedagogique = typeChoixPedagogique;
  }


  public LignePedagogiqueDCA enfants(List<LignePedagogiqueDCA> enfants) {
    
    this.enfants = enfants;
    return this;
  }

  public LignePedagogiqueDCA addEnfantsItem(LignePedagogiqueDCA enfantsItem) {
    if (this.enfants == null) {
      this.enfants = new ArrayList<LignePedagogiqueDCA>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les fils pédagogiques dans l'arbre")
  ...
  public void setEnfants(List<LignePedagogiqueDCA> enfants) {
    this.enfants = enfants;
  }
  ...
  public boolean equals(Object o) {
    ...
    LignePedagogiqueDCA lignePedagogiqueDCA = (LignePedagogiqueDCA) o;
    return Objects.equals(this.codeObjetMaquette, lignePedagogiqueDCA.codeObjetMaquette) &&
        Objects.equals(this.libelleLongObjetMaquette, lignePedagogiqueDCA.libelleLongObjetMaquette) &&
        Objects.equals(this.libelleAffichageTypeObjetFormation, lignePedagogiqueDCA.libelleAffichageTypeObjetFormation) &&
        Objects.equals(this.estObligatoire, lignePedagogiqueDCA.estObligatoire) &&
        Objects.equals(this.creditEcts, lignePedagogiqueDCA.creditEcts) &&
        Objects.equals(this.amenagements, lignePedagogiqueDCA.amenagements) &&
        Objects.equals(this.acquisCapitalise, lignePedagogiqueDCA.acquisCapitalise) &&
        Objects.equals(this.typeChoixPedagogique, lignePedagogiqueDCA.typeChoixPedagogique) &&
        Objects.equals(this.enfants, lignePedagogiqueDCA.enfants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeObjetMaquette, libelleLongObjetMaquette, libelleAffichageTypeObjetFormation, estObligatoire, creditEcts, amenagements, acquisCapitalise, typeChoixPedagogique, enfants);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LignePedagogiqueDCA {\n");
