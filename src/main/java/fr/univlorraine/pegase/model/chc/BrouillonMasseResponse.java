...
public class BrouillonMasseResponse {
  public static final String SERIALIZED_NAME_SUCCESS = "success";
  @SerializedName(SERIALIZED_NAME_SUCCESS)
  private List<UUID> success = null;

  public static final String SERIALIZED_NAME_ERREURS = "erreurs";
  @SerializedName(SERIALIZED_NAME_ERREURS)
  private List<UUID> erreurs = null;

  public BrouillonMasseResponse() { 
  }

  public BrouillonMasseResponse success(List<UUID> success) {
    
    this.success = success;
    return this;
  }

  public BrouillonMasseResponse addSuccessItem(UUID successItem) {
    if (this.success == null) {
      this.success = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public void setSuccess(List<UUID> success) {
    this.success = success;
  }


  public BrouillonMasseResponse erreurs(List<UUID> erreurs) {
    
    this.erreurs = erreurs;
    return this;
  }

  public BrouillonMasseResponse addErreursItem(UUID erreursItem) {
    if (this.erreurs == null) {
      this.erreurs = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public void setErreurs(List<UUID> erreurs) {
    this.erreurs = erreurs;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrouillonMasseResponse brouillonMasseResponse = (BrouillonMasseResponse) o;
    return Objects.equals(this.success, brouillonMasseResponse.success) &&
        Objects.equals(this.erreurs, brouillonMasseResponse.erreurs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, erreurs);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrouillonMasseResponse {\n");
