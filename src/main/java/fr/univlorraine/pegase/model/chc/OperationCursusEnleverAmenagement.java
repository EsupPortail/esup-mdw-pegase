...
import fr.univlorraine.pegase.model.chc.OperationCursusAjoutAmenagementAllOf;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import java.io.IOException;

/**
 * OperationCursusEnleverAmenagement
 */
...
public class OperationCursusEnleverAmenagement extends OperationCursus {
  ...
  public OperationCursusEnleverAmenagement() { 
    this.op = OperationCursus.OpEnum.fromValue(this.getClass().getSimpleName());
  }

  public OperationCursusEnleverAmenagement codeAmenagement(String codeAmenagement) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OperationCursusEnleverAmenagement operationCursusEnleverAmenagement = (OperationCursusEnleverAmenagement) o;
    return Objects.equals(this.codeAmenagement, operationCursusEnleverAmenagement.codeAmenagement) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeAmenagement, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OperationCursusEnleverAmenagement {\n");
