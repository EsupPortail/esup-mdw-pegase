...
public class CursusApprenantsMasse {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<LigneAffectationMasse> items = null;

  public CursusApprenantsMasse() { 
  }

  public CursusApprenantsMasse items(List<LigneAffectationMasse> items) {
    
    this.items = items;
    return this;
  }

  public CursusApprenantsMasse addItemsItem(LigneAffectationMasse itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<LigneAffectationMasse>();
    }
  ...
  **/
  ...
  public List<LigneAffectationMasse> getItems() {
    return items;
  }


  public void setItems(List<LigneAffectationMasse> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    CursusApprenantsMasse cursusApprenantsMasse = (CursusApprenantsMasse) o;
    return Objects.equals(this.items, cursusApprenantsMasse.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CursusApprenantsMasse {\n");
