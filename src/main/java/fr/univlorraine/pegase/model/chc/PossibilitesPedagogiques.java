...
public class PossibilitesPedagogiques {
  public static final String SERIALIZED_NAME_AMENAGEMENTS_AJOUTABLES_CODES = "amenagementsAjoutablesCodes";
  @SerializedName(SERIALIZED_NAME_AMENAGEMENTS_AJOUTABLES_CODES)
  private List<String> amenagementsAjoutablesCodes = null;

  public static final String SERIALIZED_NAME_AMENAGEMENTS_RETIRABLES_CODES = "amenagementsRetirablesCodes";
  @SerializedName(SERIALIZED_NAME_AMENAGEMENTS_RETIRABLES_CODES)
  private List<String> amenagementsRetirablesCodes = null;

  /**
   * Gets or Sets actionsPossibles
   */
  @JsonAdapter(ActionsPossiblesEnum.Adapter.class)
  public enum ActionsPossiblesEnum {
    CORRIGERANOMALIE("CorrigerAnomalie"),
    
    CHOISIRAFFECTATION("ChoisirAffectation"),
    
    ANNULERCHOIXAFFECTATION("AnnulerChoixAffectation"),
    
    CHOISIRCAPITALISATION("ChoisirCapitalisation"),
    
    ANNULERCHOIXCAPITALISATION("AnnulerChoixCapitalisation"),
    
    CHOISIRRENONCIATION("ChoisirRenonciation"),
    
    ANNULERCHOIXRENONCIATION("AnnulerChoixRenonciation"),
    
    AJOUTERAMENAGEMENT("AjouterAmenagement"),
    
    RETIRERAMENAGEMENT("RetirerAmenagement");

    private String value;

    ActionsPossiblesEnum(String value) {
      this.value = value;
    }
    ...
    public static ActionsPossiblesEnum fromValue(String value) {
      for (ActionsPossiblesEnum b : ActionsPossiblesEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ActionsPossiblesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ActionsPossiblesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ActionsPossiblesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ActionsPossiblesEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_ACTIONS_POSSIBLES = "actionsPossibles";
  @SerializedName(SERIALIZED_NAME_ACTIONS_POSSIBLES)
  private List<ActionsPossiblesEnum> actionsPossibles = null;

  public PossibilitesPedagogiques() { 
  }

  public PossibilitesPedagogiques amenagementsAjoutablesCodes(List<String> amenagementsAjoutablesCodes) {
    
    this.amenagementsAjoutablesCodes = amenagementsAjoutablesCodes;
    return this;
  }

  public PossibilitesPedagogiques addAmenagementsAjoutablesCodesItem(String amenagementsAjoutablesCodesItem) {
    if (this.amenagementsAjoutablesCodes == null) {
      this.amenagementsAjoutablesCodes = new ArrayList<String>();
    }
    this.amenagementsAjoutablesCodes.add(amenagementsAjoutablesCodesItem);
    return this;
  }

   /**
   * les aménagements qu&#39;il est possible d&#39;ajouter
   * @return amenagementsAjoutablesCodes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les aménagements qu'il est possible d'ajouter")

  public List<String> getAmenagementsAjoutablesCodes() {
    return amenagementsAjoutablesCodes;
  }


  public void setAmenagementsAjoutablesCodes(List<String> amenagementsAjoutablesCodes) {
    this.amenagementsAjoutablesCodes = amenagementsAjoutablesCodes;
  }


  public PossibilitesPedagogiques amenagementsRetirablesCodes(List<String> amenagementsRetirablesCodes) {
    
    this.amenagementsRetirablesCodes = amenagementsRetirablesCodes;
    return this;
  }

  public PossibilitesPedagogiques addAmenagementsRetirablesCodesItem(String amenagementsRetirablesCodesItem) {
    if (this.amenagementsRetirablesCodes == null) {
      this.amenagementsRetirablesCodes = new ArrayList<String>();
    }
    this.amenagementsRetirablesCodes.add(amenagementsRetirablesCodesItem);
    return this;
  }

   /**
   * les aménagements qu&#39;il est possible de retirer
   * @return amenagementsRetirablesCodes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les aménagements qu'il est possible de retirer")

  public List<String> getAmenagementsRetirablesCodes() {
    return amenagementsRetirablesCodes;
  }


  public void setAmenagementsRetirablesCodes(List<String> amenagementsRetirablesCodes) {
    this.amenagementsRetirablesCodes = amenagementsRetirablesCodes;
  }


  public PossibilitesPedagogiques actionsPossibles(List<ActionsPossiblesEnum> actionsPossibles) {
    
    this.actionsPossibles = actionsPossibles;
    return this;
  }

  public PossibilitesPedagogiques addActionsPossiblesItem(ActionsPossiblesEnum actionsPossiblesItem) {
    if (this.actionsPossibles == null) {
      this.actionsPossibles = new ArrayList<ActionsPossiblesEnum>();
    }
    this.actionsPossibles.add(actionsPossiblesItem);
    return this;
  }

   /**
   * les types d&#39;actions pédagogiques possibles
   * @return actionsPossibles
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les types d'actions pédagogiques possibles")

  public List<ActionsPossiblesEnum> getActionsPossibles() {
    return actionsPossibles;
  }


  public void setActionsPossibles(List<ActionsPossiblesEnum> actionsPossibles) {
    this.actionsPossibles = actionsPossibles;
  }
  ...
  public boolean equals(Object o) {
    ...
    PossibilitesPedagogiques possibilitesPedagogiques = (PossibilitesPedagogiques) o;
    return Objects.equals(this.amenagementsAjoutablesCodes, possibilitesPedagogiques.amenagementsAjoutablesCodes) &&
        Objects.equals(this.amenagementsRetirablesCodes, possibilitesPedagogiques.amenagementsRetirablesCodes) &&
        Objects.equals(this.actionsPossibles, possibilitesPedagogiques.actionsPossibles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amenagementsAjoutablesCodes, amenagementsRetirablesCodes, actionsPossibles);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PossibilitesPedagogiques {\n");
    sb.append("    amenagementsAjoutablesCodes: ").append(toIndentedString(amenagementsAjoutablesCodes)).append("\n");
    sb.append("    amenagementsRetirablesCodes: ").append(toIndentedString(amenagementsRetirablesCodes)).append("\n");
    sb.append("    actionsPossibles: ").append(toIndentedString(actionsPossibles)).append("\n");
    sb.append("}");
    return sb.toString();
  }
