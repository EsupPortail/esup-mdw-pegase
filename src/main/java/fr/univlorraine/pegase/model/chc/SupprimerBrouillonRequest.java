...
public class SupprimerBrouillonRequest {
  public static final String SERIALIZED_NAME_CURSUS_UUIDS = "cursusUuids";
  @SerializedName(SERIALIZED_NAME_CURSUS_UUIDS)
  private List<UUID> cursusUuids = null;

  public SupprimerBrouillonRequest() { 
  }

  public SupprimerBrouillonRequest cursusUuids(List<UUID> cursusUuids) {
    
    this.cursusUuids = cursusUuids;
    return this;
  }

  public SupprimerBrouillonRequest addCursusUuidsItem(UUID cursusUuidsItem) {
    if (this.cursusUuids == null) {
      this.cursusUuids = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SupprimerBrouillonRequest supprimerBrouillonRequest = (SupprimerBrouillonRequest) o;
    return Objects.equals(this.cursusUuids, supprimerBrouillonRequest.cursusUuids);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusUuids);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SupprimerBrouillonRequest {\n");
