...
public class ObjetFormationMasse {
  ...
  public ObjetFormationMasse() { 
  }

  public ObjetFormationMasse id(UUID id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "L'id technique de l'OF")
  ...
  public ObjetFormationMasse code(String code) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code de l'OF")
  ...
  public ObjetFormationMasse libelleCourt(String libelleCourt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libelle de l'OF")
  ...
  public ObjetFormationMasse mutualise(Boolean mutualise) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObjetFormationMasse objetFormationMasse = (ObjetFormationMasse) o;
    return Objects.equals(this.id, objetFormationMasse.id) &&
        Objects.equals(this.code, objetFormationMasse.code) &&
        Objects.equals(this.libelleCourt, objetFormationMasse.libelleCourt) &&
        Objects.equals(this.mutualise, objetFormationMasse.mutualise);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, libelleCourt, mutualise);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjetFormationMasse {\n");
