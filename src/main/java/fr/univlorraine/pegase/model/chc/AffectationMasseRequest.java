...
import fr.univlorraine.pegase.model.chc.AffectationMasseOperation;
...
public class AffectationMasseRequest {
  public static final String SERIALIZED_NAME_AFFECTATIONS_AVEC_PROPOSITIONS = "affectationsAvecPropositions";
  @SerializedName(SERIALIZED_NAME_AFFECTATIONS_AVEC_PROPOSITIONS)
  private Boolean affectationsAvecPropositions;

  public static final String SERIALIZED_NAME_CODE_CHEMIN_OBJET_MAQUETTE = "codeCheminObjetMaquette";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_OBJET_MAQUETTE)
  private String codeCheminObjetMaquette;

  public static final String SERIALIZED_NAME_AFFECTATION_MASSE_OPERATIONS = "affectationMasseOperations";
  @SerializedName(SERIALIZED_NAME_AFFECTATION_MASSE_OPERATIONS)
  private List<AffectationMasseOperation> affectationMasseOperations = null;

  public AffectationMasseRequest() { 
  }

  public AffectationMasseRequest affectationsAvecPropositions(Boolean affectationsAvecPropositions) {
    
    this.affectationsAvecPropositions = affectationsAvecPropositions;
    return this;
  }

   /**
   * Indique si l&#39;affectation doit être faite avec propositions
   * @return affectationsAvecPropositions
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indique si l'affectation doit être faite avec propositions")
  ...
  public void setAffectationsAvecPropositions(Boolean affectationsAvecPropositions) {
    this.affectationsAvecPropositions = affectationsAvecPropositions;
  }


  public AffectationMasseRequest codeCheminObjetMaquette(String codeCheminObjetMaquette) {
    
    this.codeCheminObjetMaquette = codeCheminObjetMaquette;
    return this;
  }

   /**
   * Le code chemin de l&#39;objet maquette
   * @return codeCheminObjetMaquette
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code chemin de l'objet maquette")

  public String getCodeCheminObjetMaquette() {
    return codeCheminObjetMaquette;
  }


  public void setCodeCheminObjetMaquette(String codeCheminObjetMaquette) {
    this.codeCheminObjetMaquette = codeCheminObjetMaquette;
  }


  public AffectationMasseRequest affectationMasseOperations(List<AffectationMasseOperation> affectationMasseOperations) {
    
    this.affectationMasseOperations = affectationMasseOperations;
    return this;
  }

  public AffectationMasseRequest addAffectationMasseOperationsItem(AffectationMasseOperation affectationMasseOperationsItem) {
    if (this.affectationMasseOperations == null) {
      this.affectationMasseOperations = new ArrayList<AffectationMasseOperation>();
    }
    this.affectationMasseOperations.add(affectationMasseOperationsItem);
    return this;
  }

   /**
   * Get affectationMasseOperations
   * @return affectationMasseOperations
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<AffectationMasseOperation> getAffectationMasseOperations() {
    return affectationMasseOperations;
  }


  public void setAffectationMasseOperations(List<AffectationMasseOperation> affectationMasseOperations) {
    this.affectationMasseOperations = affectationMasseOperations;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationMasseRequest affectationMasseRequest = (AffectationMasseRequest) o;
    return Objects.equals(this.affectationsAvecPropositions, affectationMasseRequest.affectationsAvecPropositions) &&
        Objects.equals(this.codeCheminObjetMaquette, affectationMasseRequest.codeCheminObjetMaquette) &&
        Objects.equals(this.affectationMasseOperations, affectationMasseRequest.affectationMasseOperations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(affectationsAvecPropositions, codeCheminObjetMaquette, affectationMasseOperations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationMasseRequest {\n");
    sb.append("    affectationsAvecPropositions: ").append(toIndentedString(affectationsAvecPropositions)).append("\n");
    sb.append("    codeCheminObjetMaquette: ").append(toIndentedString(codeCheminObjetMaquette)).append("\n");
    sb.append("    affectationMasseOperations: ").append(toIndentedString(affectationMasseOperations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
