...
import fr.univlorraine.pegase.model.chc.AcquisCapitalisesDesApprenants;
...
/**
 * AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine
 */
...
public class AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine {
  public static final String SERIALIZED_NAME_CODE_CHEMIN_RACINE = "codeCheminRacine";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_RACINE)
  private String codeCheminRacine;
  ...
  private List<AcquisCapitalisesDesApprenants> listeApprenants = null;

  public AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine() { 
  }

  public AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine codeCheminRacine(String codeCheminRacine) {
    
    this.codeCheminRacine = codeCheminRacine;
    return this;
  }

   /**
   * Le code racine de l&#39;arbre des OF pour lequels la liste des capitalisés par apprenants est fournie
   * @return codeCheminRacine
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "LIC-CHIMIE>LIC-CHIMIE-A1", required = true, value = "Le code racine de l'arbre des OF pour lequels la liste des capitalisés par apprenants est fournie")

  public String getCodeCheminRacine() {
    return codeCheminRacine;
  }


  public void setCodeCheminRacine(String codeCheminRacine) {
    this.codeCheminRacine = codeCheminRacine;
  }


  public AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine listeApprenants(List<AcquisCapitalisesDesApprenants> listeApprenants) {
    
    this.listeApprenants = listeApprenants;
    return this;
  }

  public AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine addListeApprenantsItem(AcquisCapitalisesDesApprenants listeApprenantsItem) {
   ...
   /**
   * La liste des apprenants pour lesquels la liste des capitalisés dans le contexte de cet arbre sont fournies
   * @return listeApprenants
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "La liste des apprenants pour lesquels la liste des capitalisés dans le contexte de cet arbre sont fournies")

  public List<AcquisCapitalisesDesApprenants> getListeApprenants() {
    return listeApprenants;
  }


  public void setListeApprenants(List<AcquisCapitalisesDesApprenants> listeApprenants) {
    this.listeApprenants = listeApprenants;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine acquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine = (AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine) o;
    return Objects.equals(this.codeCheminRacine, acquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine.codeCheminRacine) &&
        Objects.equals(this.listeApprenants, acquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine.listeApprenants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeCheminRacine, listeApprenants);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AcquisCapitalisesDesApprenantsPourChaqueOFDescendantDeCodeRacine {\n");
    sb.append("    codeCheminRacine: ").append(toIndentedString(codeCheminRacine)).append("\n");
