 ...
 */
@ApiModel(description = "Descripteurs de piece justificative")
...
public class DescripteursPieceJustificative {
  ...
  public DescripteursPieceJustificative id(UUID id) {
  ...
  **/
  ...
  public DescripteursPieceJustificative code(String code) {
  ...
  **/
  ...
  public DescripteursPieceJustificative libelle(String libelle) {
  ...
  **/
  ...
  public DescripteursPieceJustificative temoinPhoto(Boolean temoinPhoto) {
  ...
  **/
  ...
  public DescripteursPieceJustificative prioriteAffichage(Integer prioriteAffichage) {
