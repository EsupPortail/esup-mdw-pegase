...
import fr.univlorraine.pegase.model.ins.AvancementImport;
import fr.univlorraine.pegase.model.ins.AvancementImportList;
...
public class PagedAvancementImport {
  ...
  private List<AvancementImport> items = null;
  ...
  public PagedAvancementImport() { 
  }

  public PagedAvancementImport items(List<AvancementImport> items) {
    
    this.items = items;
    return this;
  }

  public PagedAvancementImport addItemsItem(AvancementImport itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<AvancementImport>();
    }
  ...
  **/
  ...
  public List<AvancementImport> getItems() {
    return items;
  }


  public void setItems(List<AvancementImport> items) {
    this.items = items;
  }


  public PagedAvancementImport totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedAvancementImport totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedAvancementImport taille(Integer taille) {
  ...
  **/
  ...
  public PagedAvancementImport page(Integer page) {
  ...
  **/
  ...
  public PagedAvancementImport tri(List<String> tri) {
    
    this.tri = tri;
    return this;
  }

  public PagedAvancementImport addTriItem(String triItem) {
    if (this.tri == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedAvancementImport pagedAvancementImport = (PagedAvancementImport) o;
    return Objects.equals(this.items, pagedAvancementImport.items) &&
        Objects.equals(this.totalElements, pagedAvancementImport.totalElements) &&
        Objects.equals(this.totalPages, pagedAvancementImport.totalPages) &&
        Objects.equals(this.taille, pagedAvancementImport.taille) &&
        Objects.equals(this.page, pagedAvancementImport.page) &&
        Objects.equals(this.tri, pagedAvancementImport.tri);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedAvancementImport {\n");
