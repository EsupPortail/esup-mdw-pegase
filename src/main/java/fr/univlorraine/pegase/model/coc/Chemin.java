...
public class Chemin {
  /**
   * Gets or Sets absenceFinale
   */
  @JsonAdapter(AbsenceFinaleEnum.Adapter.class)
  public enum AbsenceFinaleEnum {
    JUSTIFIEE("JUSTIFIEE"),
    ...
    AbsenceFinaleEnum(String value) {
      this.value = value;
    }
    ...
    public static AbsenceFinaleEnum fromValue(String value) {
      for (AbsenceFinaleEnum b : AbsenceFinaleEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AbsenceFinaleEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AbsenceFinaleEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AbsenceFinaleEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AbsenceFinaleEnum.fromValue(value);
      }
    }
  }
  ...
  private AbsenceFinaleEnum absenceFinale;

  /**
   * Gets or Sets absenceSession1
   */
  @JsonAdapter(AbsenceSession1Enum.Adapter.class)
  public enum AbsenceSession1Enum {
    JUSTIFIEE("JUSTIFIEE"),
    ...
    AbsenceSession1Enum(String value) {
      this.value = value;
    }
    ...
    public static AbsenceSession1Enum fromValue(String value) {
      for (AbsenceSession1Enum b : AbsenceSession1Enum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<AbsenceSession1Enum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AbsenceSession1Enum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AbsenceSession1Enum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AbsenceSession1Enum.fromValue(value);
      }
    }
  }
  ...
  private AbsenceSession1Enum absenceSession1;

  /**
   * Gets or Sets absenceSession2
   */
  @JsonAdapter(AbsenceSession2Enum.Adapter.class)
  public enum AbsenceSession2Enum {
    JUSTIFIEE("JUSTIFIEE"),
    ...
    AbsenceSession2Enum(String value) {
      this.value = value;
    }
    ...
    public static AbsenceSession2Enum fromValue(String value) {
      for (AbsenceSession2Enum b : AbsenceSession2Enum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<AbsenceSession2Enum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AbsenceSession2Enum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AbsenceSession2Enum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AbsenceSession2Enum.fromValue(value);
      }
    }
  }
  ...
  private AbsenceSession2Enum absenceSession2;
  ...
  public Chemin absenceFinale(AbsenceFinaleEnum absenceFinale) {
  ...
  **/
  ...
  public AbsenceFinaleEnum getAbsenceFinale() {
    return absenceFinale;
  }


  public void setAbsenceFinale(AbsenceFinaleEnum absenceFinale) {
    this.absenceFinale = absenceFinale;
  }


  public Chemin absenceSession1(AbsenceSession1Enum absenceSession1) {
  ...
  **/
  ...
  public AbsenceSession1Enum getAbsenceSession1() {
    return absenceSession1;
  }


  public void setAbsenceSession1(AbsenceSession1Enum absenceSession1) {
    this.absenceSession1 = absenceSession1;
  }


  public Chemin absenceSession2(AbsenceSession2Enum absenceSession2) {
  ...
  **/
  ...
  public AbsenceSession2Enum getAbsenceSession2() {
    return absenceSession2;
  }


  public void setAbsenceSession2(AbsenceSession2Enum absenceSession2) {
    this.absenceSession2 = absenceSession2;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.absenceFinale, chemin.absenceFinale) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(absenceFinale, absenceSession1, absenceSession2, bareme, codeChemin, coefficientFinal, coefficientSession1, coefficientSession2, concerneParSession2, creditEcts, delibereFinales, delibereSession1, listeControle, listeTypeAmenagement, mentionHonorifique, notationEcts, notationGpa, noteConsolidee, noteFinale, noteSession1, noteSession2, numeroSessionRetenueNote, numeroSessionRetenueResultat, objetFeuille, pointsJury, publieEvaluationsFinales, publieSession1, publieSession2, resultatFinal, resultatSession1, resultatSession2);
  }
