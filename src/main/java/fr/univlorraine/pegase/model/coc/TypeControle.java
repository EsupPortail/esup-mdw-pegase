...
public class TypeControle {
  ...
  public TypeControle code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(example = "TCO005", required = true, value = "Le code du type de contrôle")
  ...
  public TypeControle libelleCourt(String libelleCourt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CONTROLE ORAL", required = true, value = "Le libellé court du type de contrôle")
  ...
  public TypeControle libelleLong(String libelleLong) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CONTROLE ORAL", required = true, value = "Le libellé long du type de contrôle")
  ...
  public TypeControle libelleAffichage(String libelleAffichage) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Contrôle oral", required = true, value = "Le libellé d'affichage (celui présenté aux apprenants) du type de contrôle")
