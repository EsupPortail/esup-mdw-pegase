...
import fr.univlorraine.pegase.model.insgestion.CalendrierAllOf;
...
public class Calendrier extends ObjetAvecDates {
  ...
  **/
  ...
  public Calendrier contexte(ContexteInscription contexte) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, contexte, super.hashCode());
  }
