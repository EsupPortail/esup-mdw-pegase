...
public class PremieresInscriptions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Année de 1ère inscription dans l'enseignement supérieur français")
  ...
  public PremieresInscriptions anneeUniversite(String anneeUniversite) {
   ...
   /**
   * Année de 1ère inscription en université française
   * @return anneeUniversite
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Année de 1ère inscription en université française")
  ...
  public PremieresInscriptions anneeEtablissement(String anneeEtablissement) {
   ...
   /**
   * Année de 1ère inscription dans l&#39;établissement
   * @return anneeEtablissement
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Année de 1ère inscription dans l'établissement")
