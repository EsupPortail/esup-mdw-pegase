...
public class ModaliteDePaiement {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, codeStructure, libelleAffichage, codeModeDePaiement, temoinVisibleEtudiant, statutPaiement, temoinPrimo, temoinReins, nombreDePaiements, montantMinimum, montantMaximum, temoinSaisieReference, temoinPaiementEnLigne, dateDebutValidite, dateFinValidite, prioriteAffichage);
  }
