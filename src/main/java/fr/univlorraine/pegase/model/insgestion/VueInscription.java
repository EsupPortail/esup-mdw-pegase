...
public class VueInscription {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(UAI, codeApprenant, dateInscription, derniereModification, INE, civilite, nomUsage, nomFamille, prenom, dateDeNaissance, nationalite, droitPhoto, Arrays.hashCode(photo), regime, bourses, mobilite, statutPaiement, statutInscription, inscriptionPrincipale, formation, anneeUniversitaire, periode, chemin, adresses, mels, telephones);
  }
