...
public class IdentiteDetail {
  ...
  public IdentiteDetail id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public IdentiteDetail identifiantApprenantPegase(@javax.annotation.Nonnull String identifiantApprenantPegase) {
  ...
  public IdentiteDetail nomNaissance(@javax.annotation.Nonnull String nomNaissance) {
  ...
  public IdentiteDetail prenom(@javax.annotation.Nonnull String prenom) {
    this.prenom = prenom;
    return this;
  }
  ...
  public IdentiteDetail email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public IdentiteDetail telephonePortablePersonnel(@javax.annotation.Nullable String telephonePortablePersonnel) {
  ...
  public IdentiteDetail profilApprenant(@javax.annotation.Nullable ProfilApprenant profilApprenant) {
