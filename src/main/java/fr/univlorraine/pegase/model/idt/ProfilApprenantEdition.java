...
public class ProfilApprenantEdition {
  ...
  public ProfilApprenantEdition listeINEs(@javax.annotation.Nullable List<Ine> listeINEs) {
  ...
  public ProfilApprenantEdition etatCivil(@javax.annotation.Nullable EtatCivil etatCivil) {
  ...
  public ProfilApprenantEdition donneesContact(@javax.annotation.Nullable DonneesContact donneesContact) {
  ...
  public ProfilApprenantEdition donneesComplementaires(@javax.annotation.Nullable DonneesComplementaires donneesComplementaires) {
  ...
  public ProfilApprenantEdition parcoursScolaireEtUniversitaire(@javax.annotation.Nullable ParcoursScolaireEtUniversitaire parcoursScolaireEtUniversitaire) {
  ...
  public ProfilApprenantEdition temoinDoublonPotentiel(@javax.annotation.Nullable Boolean temoinDoublonPotentiel) {
  ...
  public ProfilApprenantEdition temoinDecede(@javax.annotation.Nullable Boolean temoinDecede) {
