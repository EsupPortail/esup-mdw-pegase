...
import fr.univlorraine.pegase.ins.invoker.auth.Authentication;
import fr.univlorraine.pegase.ins.invoker.auth.HttpBasicAuth;
import fr.univlorraine.pegase.ins.invoker.auth.HttpBearerAuth;
import fr.univlorraine.pegase.ins.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8103/api/ins/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0-rc.20250414083300/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8103/api/ins/v1
