...
public class ProfilApprenant {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("listeINEs", "ineMaitre", "listeINEsAlternatifs", "etatCivil", "donneesContact", "donneesComplementaires", "parcoursScolaireEtUniversitaire", "temoinDoublonPotentiel", "temoinDecede", "codeApprenant"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfilApprenant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProfilApprenant is not found in the empty JSON string", ProfilApprenant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfilApprenant.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProfilApprenant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
	    if (jsonElement == null || jsonElement.isJsonNull()) {
