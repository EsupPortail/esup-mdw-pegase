...
public class ProfilApprenant {
   ...
   * @return the ProfilApprenant instance itself
   */
  public ProfilApprenant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.listeINEs, profilApprenant.listeINEs) &&
        ...
        Objects.equals(this.additionalProperties, profilApprenant.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listeINEs, ineMaitre, listeINEsAlternatifs, etatCivil, donneesContact, donneesComplementaires, parcoursScolaireEtUniversitaire, temoinDoublonPotentiel, temoinDecede, codeApprenant, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProfilApprenant>() {
           ...
           public ProfilApprenant read(JsonReader in) throws IOException {
             ...
             ProfilApprenant instance = thisAdapter.fromJsonTree(jsonObj);
