...
public class IdentiteApprenantSimilaireSummary {
   ...
   * @return the IdentiteApprenantSimilaireSummary instance itself
   */
  public IdentiteApprenantSimilaireSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, identiteApprenantSimilaireSummary.id) &&
        ...
        Objects.equals(this.additionalProperties, identiteApprenantSimilaireSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, identifiantApprenantPegase, nomNaissance, nomUsage, prenom, prenom2, prenom3, email, sexe, codeApprenant, ineMaitre, inesSupplementaires, dateNaissance, communeNaissance, paysNaissance, nationalite, actif, temoinDoublonPotentiel, temoinDecede, scoreSimilarite, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "identifiantApprenantPegase", "nomNaissance", "nomUsage", "prenom", "prenom2", "prenom3", "email", "sexe", "codeApprenant", "ineMaitre", "inesSupplementaires", "dateNaissance", "communeNaissance", "paysNaissance", "nationalite", "actif", "temoinDoublonPotentiel", "temoinDecede", "scoreSimilarite"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentiteApprenantSimilaireSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in IdentiteApprenantSimilaireSummary is not found in the empty JSON string", IdentiteApprenantSimilaireSummary.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IdentiteApprenantSimilaireSummary>() {
           ...
           public IdentiteApprenantSimilaireSummary read(JsonReader in) throws IOException {
             ...
             IdentiteApprenantSimilaireSummary instance = thisAdapter.fromJsonTree(jsonObj);
