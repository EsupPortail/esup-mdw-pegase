...
/**
 * L&#39;état global des dépôts pour une inscription
 */
@JsonAdapter(StatutGlobalPiece.Adapter.class)
public enum StatutGlobalPiece {
  
  SANS_STATUT("SANS_STATUT"),
  
  VALIDEES("VALIDEES"),
  
  VALIDEES_ET_ATTENTE("VALIDEES_ET_ATTENTE"),
  
  NON_DEPOSEES("NON_DEPOSEES"),
  
  REJETEES_DEPOT_PARTIEL("REJETEES_DEPOT_PARTIEL"),
  
  A_VALIDER_DOSSIER_BLOQUE_COMPLET("A_VALIDER_DOSSIER_BLOQUE_COMPLET"),
  
  A_VALIDER_DOSSIER_NON_BLOQUE_COMPLET("A_VALIDER_DOSSIER_NON_BLOQUE_COMPLET"),
  
  A_VALIDER_DOSSIER_BLOQUE_PARTIEL("A_VALIDER_DOSSIER_BLOQUE_PARTIEL"),
  
  A_VALIDER_DOSSIER_NON_BLOQUE_PARTIEL("A_VALIDER_DOSSIER_NON_BLOQUE_PARTIEL");

  private String value;

  StatutGlobalPiece(String value) {
    this.value = value;
  }
  ...
  public static StatutGlobalPiece fromValue(String value) {
    for (StatutGlobalPiece b : StatutGlobalPiece.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatutGlobalPiece> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatutGlobalPiece enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatutGlobalPiece read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatutGlobalPiece.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatutGlobalPiece.fromValue(value);
  }
}
