 ...
 * L&#39;état du dépôt
 */
@JsonAdapter(StatutDepot.Adapter.class)
public enum StatutDepot {
  ...
  NON_CONCERNE_VALIDE("NON_CONCERNE_VALIDE"),
  
  A_VALIDER_DOSSIER_BLOQUE("A_VALIDER_DOSSIER_BLOQUE"),
  
  A_VALIDER_DOSSIER_NON_BLOQUE("A_VALIDER_DOSSIER_NON_BLOQUE"),
  
  VALIDE("VALIDE"),
  
  VALIDATION_FORCEE("VALIDATION_FORCEE"),
  
  REJETE("REJETE");

  private String value;

  StatutDepot(String value) {
    this.value = value;
  }
  ...
  public static StatutDepot fromValue(String value) {
    for (StatutDepot b : StatutDepot.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatutDepot> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatutDepot enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatutDepot read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatutDepot.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatutDepot.fromValue(value);
  }
}
