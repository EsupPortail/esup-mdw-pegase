...
import fr.univlorraine.pegase.chc.model.*;
...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                ...
                .registerTypeSelector(ObjetFormation.class, new TypeSelector<ObjetFormation>() {
                    @Override
                    public Class<? extends ObjetFormation> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("ObjetFormation", ObjetFormation.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "type"));
                    }
          })
                .registerTypeSelector(ObjetFormationOuFormation.class, new TypeSelector<ObjetFormationOuFormation>() {
                    @Override
                    public Class<? extends ObjetFormationOuFormation> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("Formation", Formation.class);
                        classByDiscriminatorValue.put("ObjetFormation", ObjetFormation.class);
                        classByDiscriminatorValue.put("ObjetFormationOuFormation", ObjetFormationOuFormation.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "type"));
                    }
          })
