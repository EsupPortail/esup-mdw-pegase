...
/**
 * La période de mise en œuvre de la formation
 */
...
public class PeriodePourExtraction {
  ...
  public PeriodePourExtraction() {
  }

  public PeriodePourExtraction code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public PeriodePourExtraction libelleCourt(@jakarta.annotation.Nonnull String libelleCourt) {
  ...
  public PeriodePourExtraction libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
  ...
  public PeriodePourExtraction dateDebut(@jakarta.annotation.Nonnull Date dateDebut) {
  ...
  public PeriodePourExtraction dateFin(@jakarta.annotation.Nonnull Date dateFin) {
  ...
  public void setDateFin(@jakarta.annotation.Nonnull Date dateFin) {
    this.dateFin = dateFin;
  }
   ...
   * @return the PeriodePourExtraction instance itself
   */
  public PeriodePourExtraction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeriodePourExtraction periodePourExtraction = (PeriodePourExtraction) o;
    return Objects.equals(this.code, periodePourExtraction.code) &&
        Objects.equals(this.libelleCourt, periodePourExtraction.libelleCourt) &&
        Objects.equals(this.libelleLong, periodePourExtraction.libelleLong) &&
        Objects.equals(this.dateDebut, periodePourExtraction.dateDebut) &&
        Objects.equals(this.dateFin, periodePourExtraction.dateFin)&&
        Objects.equals(this.additionalProperties, periodePourExtraction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, dateDebut, dateFin, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PeriodePourExtraction {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "libelleCourt", "libelleLong", "dateDebut", "dateFin"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "libelleCourt", "libelleLong", "dateDebut", "dateFin"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PeriodePourExtraction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PeriodePourExtraction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PeriodePourExtraction is not found in the empty JSON string", PeriodePourExtraction.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PeriodePourExtraction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeriodePourExtraction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeriodePourExtraction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeriodePourExtraction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeriodePourExtraction.class));

       return (TypeAdapter<T>) new TypeAdapter<PeriodePourExtraction>() {
           @Override
           public void write(JsonWriter out, PeriodePourExtraction value) throws IOException {
           ...
           @Override
           public PeriodePourExtraction read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PeriodePourExtraction instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PeriodePourExtraction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PeriodePourExtraction
   * @throws IOException if the JSON string is invalid with respect to PeriodePourExtraction
   */
  public static PeriodePourExtraction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeriodePourExtraction.class);
  }

  /**
   * Convert an instance of PeriodePourExtraction to an JSON string
   *
   * @return JSON string
   */
