...
import fr.univlorraine.pegase.chc.model.CalendrierPourList;
import fr.univlorraine.pegase.chc.model.Calendriers;
...
public class PagedCalendrier {
  ...
  private List<CalendrierPourList> items = null;
  ...
  public PagedCalendrier() { 
  }

  public PagedCalendrier items(List<CalendrierPourList> items) {
    
    this.items = items;
    return this;
  }

  public PagedCalendrier addItemsItem(CalendrierPourList itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CalendrierPourList>();
    }
  ...
  **/
  ...
  public List<CalendrierPourList> getItems() {
    return items;
  }


  public void setItems(List<CalendrierPourList> items) {
    this.items = items;
  }


  public PagedCalendrier totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedCalendrier totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedCalendrier taille(Integer taille) {
  ...
  **/
  ...
  public PagedCalendrier page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedCalendrier pagedCalendrier = (PagedCalendrier) o;
    return Objects.equals(this.items, pagedCalendrier.items) &&
        Objects.equals(this.totalElements, pagedCalendrier.totalElements) &&
        Objects.equals(this.totalPages, pagedCalendrier.totalPages) &&
        Objects.equals(this.taille, pagedCalendrier.taille) &&
        Objects.equals(this.page, pagedCalendrier.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedCalendrier {\n");
