...
public class CheminObjetMaquettes {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<CheminObjetMaquette> items = null;

  public CheminObjetMaquettes() { 
  }

  public CheminObjetMaquettes items(List<CheminObjetMaquette> items) {
    
    this.items = items;
    return this;
  }

  public CheminObjetMaquettes addItemsItem(CheminObjetMaquette itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CheminObjetMaquettes cheminObjetMaquettes = (CheminObjetMaquettes) o;
    return Objects.equals(this.items, cheminObjetMaquettes.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheminObjetMaquettes {\n");
