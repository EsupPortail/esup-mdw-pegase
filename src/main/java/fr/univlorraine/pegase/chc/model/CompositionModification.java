...
public class CompositionModification {
  ...
  private List<GroupeInfo> listeGroupes = null;

  public CompositionModification() { 
  }

  public CompositionModification active(Boolean active) {
  ...
  **/
  ...
  @ApiModelProperty(value = "temoin vrai si la composition est active, faux si inactive")
  ...
  public CompositionModification descripteursComposition(DescripteursComposition descripteursComposition) {
  ...
  **/
  ...
  public CompositionModification listeGroupes(List<GroupeInfo> listeGroupes) {
    
    this.listeGroupes = listeGroupes;
    return this;
  }

  public CompositionModification addListeGroupesItem(GroupeInfo listeGroupesItem) {
    if (this.listeGroupes == null) {
      this.listeGroupes = new ArrayList<GroupeInfo>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CompositionModification compositionModification = (CompositionModification) o;
    return Objects.equals(this.active, compositionModification.active) &&
        Objects.equals(this.descripteursComposition, compositionModification.descripteursComposition) &&
        Objects.equals(this.listeGroupes, compositionModification.listeGroupes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, descripteursComposition, listeGroupes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompositionModification {\n");
