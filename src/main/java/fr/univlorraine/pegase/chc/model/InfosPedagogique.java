...
public class InfosPedagogique {
  ...
  public static final String SERIALIZED_NAME_AMENAGEMENTS_ACTUELS = "amenagementsActuels";
  public static final String SERIALIZED_NAME_ACQUIS_UTILISABLE_U_U_I_D = "acquisUtilisableUUID";
  public static final String SERIALIZED_NAME_EST_EN_ANOMALIE_DIRECTE = "estEnAnomalieDirecte";
  public static final String SERIALIZED_NAME_ANY_ANOMALIE_CURSUS = "anyAnomalieCursus";
  public static final String SERIALIZED_NAME_COMPLETUDE = "completude";
  public static final String SERIALIZED_NAME_EST_CHOIX_DU_BROUILLON_DIFFERENT = "estChoixDuBrouillonDifferent";
  public static final String SERIALIZED_NAME_NOMBRE_DE_CHOIX_DANS_LA_PLAGE_DE_CHOIX = "nombreDeChoixDansLaPlageDeChoix";
  public static final String SERIALIZED_NAME_EST_RAISON_INCOMPLETUDE_PARENT = "estRaisonIncompletudeParent";
  ...
  @SerializedName(SERIALIZED_NAME_AMENAGEMENTS_ACTUELS)
  private List<Amenagement> amenagementsActuels = null;
  @SerializedName(SERIALIZED_NAME_ACQUIS_UTILISABLE_U_U_I_D)
  private UUID acquisUtilisableUUID;
  @SerializedName(SERIALIZED_NAME_EST_EN_ANOMALIE_DIRECTE)
  private Boolean estEnAnomalieDirecte;
  @SerializedName(SERIALIZED_NAME_ANY_ANOMALIE_CURSUS)
  private Boolean anyAnomalieCursus;
  @SerializedName(SERIALIZED_NAME_COMPLETUDE)
  private CompletudeEnum completude;
  @SerializedName(SERIALIZED_NAME_EST_CHOIX_DU_BROUILLON_DIFFERENT)
  private Boolean estChoixDuBrouillonDifferent;
  @SerializedName(SERIALIZED_NAME_NOMBRE_DE_CHOIX_DANS_LA_PLAGE_DE_CHOIX)
  private Integer nombreDeChoixDansLaPlageDeChoix;
  @SerializedName(SERIALIZED_NAME_EST_RAISON_INCOMPLETUDE_PARENT)
  private Boolean estRaisonIncompletudeParent;

  public InfosPedagogique() {
  }

  public InfosPedagogique typeChoixPedagogiqueActuel(TypeChoixPedagogiqueActuelEnum typeChoixPedagogiqueActuel) {
  ...
  **/
  ...
  public InfosPedagogique amenagementsActuels(List<Amenagement> amenagementsActuels) {

    this.amenagementsActuels = amenagementsActuels;
    return this;
  }

  public InfosPedagogique addAmenagementsActuelsItem(Amenagement amenagementsActuelsItem) {
    if (this.amenagementsActuels == null) {
      this.amenagementsActuels = new ArrayList<Amenagement>();
    }
    this.amenagementsActuels.add(amenagementsActuelsItem);
    return this;
  }
  ...
  **/
  ...
  public void setAmenagementsActuels(List<Amenagement> amenagementsActuels) {
    this.amenagementsActuels = amenagementsActuels;
  }

  public InfosPedagogique acquisUtilisableUUID(UUID acquisUtilisableUUID) {

    this.acquisUtilisableUUID = acquisUtilisableUUID;
    return this;
  }
  ...
  **/
  ...
  public void setAcquisUtilisableUUID(UUID acquisUtilisableUUID) {
    this.acquisUtilisableUUID = acquisUtilisableUUID;
  }

  public InfosPedagogique estEnAnomalieDirecte(Boolean estEnAnomalieDirecte) {

    this.estEnAnomalieDirecte = estEnAnomalieDirecte;
    return this;
  }
  ...
  **/
  ...
  public void setEstEnAnomalieDirecte(Boolean estEnAnomalieDirecte) {
    this.estEnAnomalieDirecte = estEnAnomalieDirecte;
  }

  public InfosPedagogique anyAnomalieCursus(Boolean anyAnomalieCursus) {

    this.anyAnomalieCursus = anyAnomalieCursus;
    return this;
  }
  ...
  **/
  ...
  public void setAnyAnomalieCursus(Boolean anyAnomalieCursus) {
    this.anyAnomalieCursus = anyAnomalieCursus;
  }

  public InfosPedagogique completude(CompletudeEnum completude) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "La valeur de la completude")

  public CompletudeEnum getCompletude() {
    return completude;
  }

  public void setCompletude(CompletudeEnum completude) {
    this.completude = completude;
  }

  public InfosPedagogique estChoixDuBrouillonDifferent(Boolean estChoixDuBrouillonDifferent) {

    this.estChoixDuBrouillonDifferent = estChoixDuBrouillonDifferent;
    return this;
  }
  ...
  **/
  ...
  public void setEstChoixDuBrouillonDifferent(Boolean estChoixDuBrouillonDifferent) {
    this.estChoixDuBrouillonDifferent = estChoixDuBrouillonDifferent;
  }

  public InfosPedagogique nombreDeChoixDansLaPlageDeChoix(Integer nombreDeChoixDansLaPlageDeChoix) {

    this.nombreDeChoixDansLaPlageDeChoix = nombreDeChoixDansLaPlageDeChoix;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "le nombre d'objets formation déjà choisis par l'apprenant dans la plage de choix. Vide si n'est pas un groupement à plage de choix.")

  public Integer getNombreDeChoixDansLaPlageDeChoix() {
    return nombreDeChoixDansLaPlageDeChoix;
  }

  public void setNombreDeChoixDansLaPlageDeChoix(Integer nombreDeChoixDansLaPlageDeChoix) {
    this.nombreDeChoixDansLaPlageDeChoix = nombreDeChoixDansLaPlageDeChoix;
  }

  public InfosPedagogique estRaisonIncompletudeParent(Boolean estRaisonIncompletudeParent) {

    this.estRaisonIncompletudeParent = estRaisonIncompletudeParent;
    return this;
  }

   /**
   * Get estRaisonIncompletudeParent
   * @return estRaisonIncompletudeParent
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Boolean getEstRaisonIncompletudeParent() {
    return estRaisonIncompletudeParent;
  }

  public void setEstRaisonIncompletudeParent(Boolean estRaisonIncompletudeParent) {
    this.estRaisonIncompletudeParent = estRaisonIncompletudeParent;
  }
  ...
  public boolean equals(Object o) {
    ...
    InfosPedagogique infosPedagogique = (InfosPedagogique) o;
    return Objects.equals(this.typeChoixPedagogiqueActuel, infosPedagogique.typeChoixPedagogiqueActuel) &&
        Objects.equals(this.amenagementsActuels, infosPedagogique.amenagementsActuels) &&
        Objects.equals(this.acquisUtilisableUUID, infosPedagogique.acquisUtilisableUUID) &&
        Objects.equals(this.estEnAnomalieDirecte, infosPedagogique.estEnAnomalieDirecte) &&
        Objects.equals(this.anyAnomalieCursus, infosPedagogique.anyAnomalieCursus) &&
        Objects.equals(this.completude, infosPedagogique.completude) &&
        Objects.equals(this.estChoixDuBrouillonDifferent, infosPedagogique.estChoixDuBrouillonDifferent) &&
        Objects.equals(this.nombreDeChoixDansLaPlageDeChoix, infosPedagogique.nombreDeChoixDansLaPlageDeChoix) &&
        Objects.equals(this.estRaisonIncompletudeParent, infosPedagogique.estRaisonIncompletudeParent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeChoixPedagogiqueActuel, amenagementsActuels, acquisUtilisableUUID, estEnAnomalieDirecte, anyAnomalieCursus, completude, estChoixDuBrouillonDifferent, nombreDeChoixDansLaPlageDeChoix, estRaisonIncompletudeParent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfosPedagogique {\n");
    sb.append("    typeChoixPedagogiqueActuel: ").append(toIndentedString(typeChoixPedagogiqueActuel)).append("\n");
    sb.append("    amenagementsActuels: ").append(toIndentedString(amenagementsActuels)).append("\n");
    sb.append("    acquisUtilisableUUID: ").append(toIndentedString(acquisUtilisableUUID)).append("\n");
    sb.append("    estEnAnomalieDirecte: ").append(toIndentedString(estEnAnomalieDirecte)).append("\n");
    sb.append("    anyAnomalieCursus: ").append(toIndentedString(anyAnomalieCursus)).append("\n");
    sb.append("    completude: ").append(toIndentedString(completude)).append("\n");
    sb.append("    estChoixDuBrouillonDifferent: ").append(toIndentedString(estChoixDuBrouillonDifferent)).append("\n");
    sb.append("    nombreDeChoixDansLaPlageDeChoix: ").append(toIndentedString(nombreDeChoixDansLaPlageDeChoix)).append("\n");
    sb.append("    estRaisonIncompletudeParent: ").append(toIndentedString(estRaisonIncompletudeParent)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * La valeur de la completude
   */
  @JsonAdapter(CompletudeEnum.Adapter.class)
  public enum CompletudeEnum {
    COMPLET("COMPLET"),
    ...
    CompletudeEnum(String value) {
      this.value = value;
    }

    public static CompletudeEnum fromValue(String value) {
      for (CompletudeEnum b : CompletudeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<CompletudeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CompletudeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CompletudeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CompletudeEnum.fromValue(value);
      }
    }
  }
