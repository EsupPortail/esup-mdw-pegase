...
import fr.univlorraine.pegase.chc.model.InfoBrouillon;
import fr.univlorraine.pegase.chc.model.LigneAffectationIndividuelle;
...
/**
 * L&#39;ensemble des choix pédagogiques actuels et ceux pouvant être faits en l&#39;état
 */
@ApiModel(description = "L'ensemble des choix pédagogiques actuels et ceux pouvant être faits en l'état")
...
public class LectureAffectationIndividuelle {
  ...
  public static final String SERIALIZED_NAME_EST_COMPLET = "estComplet";
  public static final String SERIALIZED_NAME_INFO_BROUILLON = "infoBrouillon";
  public static final String SERIALIZED_NAME_RACINE = "racine";
  @SerializedName(SERIALIZED_NAME_CURSUS_UUID)
  private UUID cursusUuid;
  @SerializedName(SERIALIZED_NAME_EST_COMPLET)
  private Boolean estComplet;
  @SerializedName(SERIALIZED_NAME_INFO_BROUILLON)
  private InfoBrouillon infoBrouillon;
  @SerializedName(SERIALIZED_NAME_RACINE)
  private LigneAffectationIndividuelle racine;

  public LectureAffectationIndividuelle() { 
  }

  public LectureAffectationIndividuelle cursusUuid(UUID cursusUuid) {
  ...
  **/
  ...
  public LectureAffectationIndividuelle estComplet(Boolean estComplet) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "false", required = true, value = "Indique si le cursus est complet")
  ...
  public LectureAffectationIndividuelle infoBrouillon(InfoBrouillon infoBrouillon) {
    
    this.infoBrouillon = infoBrouillon;
    return this;
  }
  ...
  **/
  ...
  public void setInfoBrouillon(InfoBrouillon infoBrouillon) {
    this.infoBrouillon = infoBrouillon;
  }


  public LectureAffectationIndividuelle racine(LigneAffectationIndividuelle racine) {
  ...
  **/
  ...
  public void setRacine(LigneAffectationIndividuelle racine) {
    this.racine = racine;
  }
  ...
  public boolean equals(Object o) {
    ...
    LectureAffectationIndividuelle lectureAffectationIndividuelle = (LectureAffectationIndividuelle) o;
    return Objects.equals(this.cursusUuid, lectureAffectationIndividuelle.cursusUuid) &&
        Objects.equals(this.estComplet, lectureAffectationIndividuelle.estComplet) &&
        Objects.equals(this.infoBrouillon, lectureAffectationIndividuelle.infoBrouillon) &&
        Objects.equals(this.racine, lectureAffectationIndividuelle.racine);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusUuid, estComplet, infoBrouillon, racine);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LectureAffectationIndividuelle {\n");
    sb.append("    cursusUuid: ").append(toIndentedString(cursusUuid)).append("\n");
    sb.append("    estComplet: ").append(toIndentedString(estComplet)).append("\n");
    sb.append("    infoBrouillon: ").append(toIndentedString(infoBrouillon)).append("\n");
