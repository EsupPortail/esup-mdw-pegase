...
import fr.univlorraine.pegase.chc.model.ObjetFormationComposition;
import fr.univlorraine.pegase.chc.model.ObjetFormationsComposition;
import fr.univlorraine.pegase.chc.model.Paging;
...
/**
 * PagedObjetFormationComposition
 */
...
public class PagedObjetFormationComposition {
  ...
  private List<ObjetFormationComposition> items = null;
  ...
  public PagedObjetFormationComposition() { 
  }

  public PagedObjetFormationComposition items(List<ObjetFormationComposition> items) {
    
    this.items = items;
    return this;
  }

  public PagedObjetFormationComposition addItemsItem(ObjetFormationComposition itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ObjetFormationComposition>();
    }
   ...
   /**
   * Array de ObjetFormationComposition
   * @return items
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array de ObjetFormationComposition")

  public List<ObjetFormationComposition> getItems() {
    return items;
  }


  public void setItems(List<ObjetFormationComposition> items) {
    this.items = items;
  }


  public PagedObjetFormationComposition totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedObjetFormationComposition totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedObjetFormationComposition taille(Integer taille) {
  ...
  **/
  ...
  public PagedObjetFormationComposition page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedObjetFormationComposition pagedObjetFormationComposition = (PagedObjetFormationComposition) o;
    return Objects.equals(this.items, pagedObjetFormationComposition.items) &&
        Objects.equals(this.totalElements, pagedObjetFormationComposition.totalElements) &&
        Objects.equals(this.totalPages, pagedObjetFormationComposition.totalPages) &&
        Objects.equals(this.taille, pagedObjetFormationComposition.taille) &&
        Objects.equals(this.page, pagedObjetFormationComposition.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedObjetFormationComposition {\n");
