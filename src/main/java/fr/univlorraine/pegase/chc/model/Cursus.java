...
public class Cursus {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codeStructure, periode, formation, racinePedagogique);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cursus.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Cursus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
