...
public class TypeObjetFormation {
  ...
  public TypeObjetFormation code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }

  /**
   * Le code du type de l&#39;objet de formation
   * @return code
   */
  @jakarta.annotation.Nonnull
  ...
  public TypeObjetFormation libelleCourt(@jakarta.annotation.Nonnull String libelleCourt) {
    this.libelleCourt = libelleCourt;
    return this;
  }

  /**
   * Le libellé court du type de l&#39;objet de formation
   * @return libelleCourt
   */
  @jakarta.annotation.Nonnull
  ...
  public TypeObjetFormation libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
    this.libelleLong = libelleLong;
    return this;
  }

  /**
   * Le libellé long du type de l&#39;objet de formation
   * @return libelleLong
   */
  @jakarta.annotation.Nonnull
   ...
   * @return the TypeObjetFormation instance itself
   */
  public TypeObjetFormation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, typeObjetFormation.code) &&
        Objects.equals(this.libelleCourt, typeObjetFormation.libelleCourt) &&
        Objects.equals(this.libelleLong, typeObjetFormation.libelleLong)&&
        Objects.equals(this.additionalProperties, typeObjetFormation.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypeObjetFormation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeObjetFormation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TypeObjetFormation is not found in the empty JSON string", TypeObjetFormation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TypeObjetFormation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypeObjetFormation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypeObjetFormation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypeObjetFormation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypeObjetFormation.class));

       return (TypeAdapter<T>) new TypeAdapter<TypeObjetFormation>() {
           @Override
           public void write(JsonWriter out, TypeObjetFormation value) throws IOException {
           ...
           @Override
           public TypeObjetFormation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TypeObjetFormation instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TypeObjetFormation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypeObjetFormation
   * @throws IOException if the JSON string is invalid with respect to TypeObjetFormation
   */
  public static TypeObjetFormation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypeObjetFormation.class);
  }

  /**
   * Convert an instance of TypeObjetFormation to an JSON string
   *
   * @return JSON string
   */
