...
import fr.univlorraine.pegase.chc.model.InfoFormationComposition;
import fr.univlorraine.pegase.chc.model.InfoObjetFormationComposition;
...
/**
 * le wrapper de InfosFormationsComposition et InfoObjetFormationComposition
 */
@ApiModel(description = "le wrapper de InfosFormationsComposition et InfoObjetFormationComposition")
...
public class ObjetFormationComposition {
  public static final String SERIALIZED_NAME_INFO_FORMATIONS = "infoFormations";
  public static final String SERIALIZED_NAME_OBJET_FORMATION = "objetFormation";
  @SerializedName(SERIALIZED_NAME_INFO_FORMATIONS)
  private List<InfoFormationComposition> infoFormations = null;
  @SerializedName(SERIALIZED_NAME_OBJET_FORMATION)
  private InfoObjetFormationComposition objetFormation;

  public ObjetFormationComposition() { 
  }

  public ObjetFormationComposition infoFormations(List<InfoFormationComposition> infoFormations) {
    
    this.infoFormations = infoFormations;
    return this;
  }

  public ObjetFormationComposition addInfoFormationsItem(InfoFormationComposition infoFormationsItem) {
    if (this.infoFormations == null) {
      this.infoFormations = new ArrayList<InfoFormationComposition>();
    }
    this.infoFormations.add(infoFormationsItem);
    return this;
  }

   /**
   * Array de InfoFormationComposition
   * @return infoFormations
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array de InfoFormationComposition")

  public List<InfoFormationComposition> getInfoFormations() {
    return infoFormations;
  }


  public void setInfoFormations(List<InfoFormationComposition> infoFormations) {
    this.infoFormations = infoFormations;
  }


  public ObjetFormationComposition objetFormation(InfoObjetFormationComposition objetFormation) {
  ...
  **/
  ...
  public InfoObjetFormationComposition getObjetFormation() {
    return objetFormation;
  }


  public void setObjetFormation(InfoObjetFormationComposition objetFormation) {
    this.objetFormation = objetFormation;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjetFormationComposition objetFormationComposition = (ObjetFormationComposition) o;
    return Objects.equals(this.infoFormations, objetFormationComposition.infoFormations) &&
        Objects.equals(this.objetFormation, objetFormationComposition.objetFormation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(infoFormations, objetFormation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjetFormationComposition {\n");
    sb.append("    infoFormations: ").append(toIndentedString(infoFormations)).append("\n");
