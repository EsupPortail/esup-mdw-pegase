...
public class CompositionPourListe {
  ...
  public CompositionPourListe() { 
  }

  public CompositionPourListe compositionUuid(UUID compositionUuid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "158c9998-18da-4bef-a8db-4891b1736574", value = "L'UUID de la composition")
  ...
  public CompositionPourListe code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Le code de la composition")
  ...
  public CompositionPourListe libelle(String libelle) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libellé de la composition")
  ...
  public CompositionPourListe libelleCourt(String libelleCourt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libellé court de la composition")
  ...
  public CompositionPourListe libelleLong(String libelleLong) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libellé long de la composition")
  ...
  public CompositionPourListe active(Boolean active) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Est-ce que la composition est active")
  ...
  public CompositionPourListe associee(Boolean associee) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Est ce que la composition est associee à un objet de formation ou une formation")
  ...
  public boolean equals(Object o) {
    ...
    CompositionPourListe compositionPourListe = (CompositionPourListe) o;
    return Objects.equals(this.compositionUuid, compositionPourListe.compositionUuid) &&
        Objects.equals(this.code, compositionPourListe.code) &&
        Objects.equals(this.libelle, compositionPourListe.libelle) &&
        Objects.equals(this.libelleCourt, compositionPourListe.libelleCourt) &&
        Objects.equals(this.libelleLong, compositionPourListe.libelleLong) &&
        Objects.equals(this.active, compositionPourListe.active) &&
        Objects.equals(this.associee, compositionPourListe.associee);
  }

  @Override
  public int hashCode() {
    return Objects.hash(compositionUuid, code, libelle, libelleCourt, libelleLong, active, associee);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompositionPourListe {\n");
