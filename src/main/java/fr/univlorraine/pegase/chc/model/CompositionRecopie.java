...
public class CompositionRecopie {
  public static final String SERIALIZED_NAME_COMPOSITION_UUIDS = "compositionUuids";
  public static final String SERIALIZED_NAME_CODE_PERIODE_CIBLE = "codePeriodeCible";
  @SerializedName(SERIALIZED_NAME_COMPOSITION_UUIDS)
  private List<UUID> compositionUuids = new ArrayList<UUID>();
  @SerializedName(SERIALIZED_NAME_CODE_PERIODE_CIBLE)
  private String codePeriodeCible;

  public CompositionRecopie() { 
  }

  public CompositionRecopie compositionUuids(List<UUID> compositionUuids) {
    
    this.compositionUuids = compositionUuids;
    return this;
  }

  public CompositionRecopie addCompositionUuidsItem(UUID compositionUuidsItem) {
    this.compositionUuids.add(compositionUuidsItem);
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "la liste des uuids des compositions à recopier")
  ...
  public void setCompositionUuids(List<UUID> compositionUuids) {
    this.compositionUuids = compositionUuids;
  }


  public CompositionRecopie codePeriodeCible(String codePeriodeCible) {
    
    this.codePeriodeCible = codePeriodeCible;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code de la période sur laquelle les compositions sont à recopier")
  ...
  public void setCodePeriodeCible(String codePeriodeCible) {
    this.codePeriodeCible = codePeriodeCible;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompositionRecopie compositionRecopie = (CompositionRecopie) o;
    return Objects.equals(this.compositionUuids, compositionRecopie.compositionUuids) &&
        Objects.equals(this.codePeriodeCible, compositionRecopie.codePeriodeCible);
  }

  @Override
  public int hashCode() {
    return Objects.hash(compositionUuids, codePeriodeCible);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompositionRecopie {\n");
    sb.append("    compositionUuids: ").append(toIndentedString(compositionUuids)).append("\n");
    sb.append("    codePeriodeCible: ").append(toIndentedString(codePeriodeCible)).append("\n");
    sb.append("}");
    return sb.toString();
  }
