...
public class ChoisirAmenagementRequest {
  public static final String SERIALIZED_NAME_CODE_CHEMIN_CHOIX_PEDAGOGIQUE = "codeCheminChoixPedagogique";
  public static final String SERIALIZED_NAME_TYPE_AMENAGEMENT_CODE = "typeAmenagementCode";
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_CHOIX_PEDAGOGIQUE)
  private String codeCheminChoixPedagogique;
  @SerializedName(SERIALIZED_NAME_TYPE_AMENAGEMENT_CODE)
  private String typeAmenagementCode;

  public ChoisirAmenagementRequest() { 
  }

  public ChoisirAmenagementRequest codeCheminChoixPedagogique(String codeCheminChoixPedagogique) {
  ...
  **/
  ...
  public ChoisirAmenagementRequest typeAmenagementCode(String typeAmenagementCode) {
    
    this.typeAmenagementCode = typeAmenagementCode;
    return this;
  }

   /**
   * Code du type d&#39;amenagement à ajouter
   * @return typeAmenagementCode
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Code du type d'amenagement à ajouter")

  public String getTypeAmenagementCode() {
    return typeAmenagementCode;
  }


  public void setTypeAmenagementCode(String typeAmenagementCode) {
    this.typeAmenagementCode = typeAmenagementCode;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChoisirAmenagementRequest choisirAmenagementRequest = (ChoisirAmenagementRequest) o;
    return Objects.equals(this.codeCheminChoixPedagogique, choisirAmenagementRequest.codeCheminChoixPedagogique) &&
        Objects.equals(this.typeAmenagementCode, choisirAmenagementRequest.typeAmenagementCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeCheminChoixPedagogique, typeAmenagementCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChoisirAmenagementRequest {\n");
    sb.append("    codeCheminChoixPedagogique: ").append(toIndentedString(codeCheminChoixPedagogique)).append("\n");
    sb.append("    typeAmenagementCode: ").append(toIndentedString(typeAmenagementCode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
