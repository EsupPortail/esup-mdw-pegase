...
import fr.univlorraine.pegase.chc.model.ArbreFormation;
...
public class ArbreLecture {
  public static final String SERIALIZED_NAME_FORMATION_ARBRE = "formationArbre";
  @SerializedName(SERIALIZED_NAME_FORMATION_ARBRE)
  private ArbreFormation formationArbre;

  public ArbreLecture() { 
  }

  public ArbreLecture formationArbre(ArbreFormation formationArbre) {
    
    this.formationArbre = formationArbre;
    return this;
  }
  ...
  **/
  ...
  public void setFormationArbre(ArbreFormation formationArbre) {
    this.formationArbre = formationArbre;
  }
  ...
  public boolean equals(Object o) {
    ...
    ArbreLecture arbreLecture = (ArbreLecture) o;
    return Objects.equals(this.formationArbre, arbreLecture.formationArbre);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formationArbre);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ArbreLecture {\n");
    sb.append("    formationArbre: ").append(toIndentedString(formationArbre)).append("\n");
    sb.append("}");
    return sb.toString();
  }
