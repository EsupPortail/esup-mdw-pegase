...
import fr.univlorraine.pegase.chc.model.ObjetFormationOuFormation;
import fr.univlorraine.pegase.chc.model.ObjetMaquetteCompositionChemins;
...
/**
 * élément de maquette de formation (Formation ou ObjetFormation) avec la liste des chemins compatibles avec les paramètres de recherche
 */
@ApiModel(description = "élément de maquette de formation (Formation ou ObjetFormation) avec la liste des chemins compatibles avec les paramètres de recherche")
...
public class ObjetMaquetteComposition {
  public static final String SERIALIZED_NAME_OBJET_FORMATION_OU_FORMATION = "objetFormationOuFormation";
  public static final String SERIALIZED_NAME_CHEMINS = "chemins";
  @SerializedName(SERIALIZED_NAME_OBJET_FORMATION_OU_FORMATION)
  private ObjetFormationOuFormation objetFormationOuFormation;
  @SerializedName(SERIALIZED_NAME_CHEMINS)
  private List<ObjetMaquetteCompositionChemins> chemins = null;

  public ObjetMaquetteComposition() { 
  }

  public ObjetMaquetteComposition objetFormationOuFormation(ObjetFormationOuFormation objetFormationOuFormation) {
    
    this.objetFormationOuFormation = objetFormationOuFormation;
    return this;
  }
  ...
  **/
  ...
  public void setObjetFormationOuFormation(ObjetFormationOuFormation objetFormationOuFormation) {
    this.objetFormationOuFormation = objetFormationOuFormation;
  }


  public ObjetMaquetteComposition chemins(List<ObjetMaquetteCompositionChemins> chemins) {
    
    this.chemins = chemins;
    return this;
  }

  public ObjetMaquetteComposition addCheminsItem(ObjetMaquetteCompositionChemins cheminsItem) {
    if (this.chemins == null) {
      this.chemins = new ArrayList<ObjetMaquetteCompositionChemins>();
    }
    this.chemins.add(cheminsItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "la liste des chemins (un seul pour une Formation) : - de cet ObjetFormation (ou Formation) lié à cette composition - et compatibles avec les paramètres de recherche")
  ...
  public void setChemins(List<ObjetMaquetteCompositionChemins> chemins) {
    this.chemins = chemins;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjetMaquetteComposition objetMaquetteComposition = (ObjetMaquetteComposition) o;
    return Objects.equals(this.objetFormationOuFormation, objetMaquetteComposition.objetFormationOuFormation) &&
        Objects.equals(this.chemins, objetMaquetteComposition.chemins);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objetFormationOuFormation, chemins);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjetMaquetteComposition {\n");
    sb.append("    objetFormationOuFormation: ").append(toIndentedString(objetFormationOuFormation)).append("\n");
    sb.append("    chemins: ").append(toIndentedString(chemins)).append("\n");
    sb.append("}");
    return sb.toString();
  }
