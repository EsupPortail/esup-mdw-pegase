...
import fr.univlorraine.pegase.chc.model.DescripteursComposition;
import fr.univlorraine.pegase.chc.model.GroupeInfo;
...
public class CompositionCreation {
  ...
  public static final String SERIALIZED_NAME_DESCRIPTEURS_COMPOSITION = "descripteursComposition";
  public static final String SERIALIZED_NAME_LISTE_GROUPES = "listeGroupes";
  @SerializedName(SERIALIZED_NAME_CODE)
  private String code;
  @SerializedName(SERIALIZED_NAME_ACTIVE)
  private Boolean active;
  @SerializedName(SERIALIZED_NAME_DESCRIPTEURS_COMPOSITION)
  private DescripteursComposition descripteursComposition;
  @SerializedName(SERIALIZED_NAME_LISTE_GROUPES)
  private List<GroupeInfo> listeGroupes = new ArrayList<GroupeInfo>();

  public CompositionCreation() { 
  }

  public CompositionCreation code(String code) {
  ...
  **/
  ...
  public CompositionCreation active(Boolean active) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "temoin vrai si la composition est active, faux si inactive")
  ...
  public CompositionCreation descripteursComposition(DescripteursComposition descripteursComposition) {
    
    this.descripteursComposition = descripteursComposition;
    return this;
  }
  ...
  **/
  ...
  public void setDescripteursComposition(DescripteursComposition descripteursComposition) {
    this.descripteursComposition = descripteursComposition;
  }


  public CompositionCreation listeGroupes(List<GroupeInfo> listeGroupes) {
    
    this.listeGroupes = listeGroupes;
    return this;
  }

  public CompositionCreation addListeGroupesItem(GroupeInfo listeGroupesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "liste de groupes de cette composition")
  ...
  public void setListeGroupes(List<GroupeInfo> listeGroupes) {
    this.listeGroupes = listeGroupes;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompositionCreation compositionCreation = (CompositionCreation) o;
    return Objects.equals(this.code, compositionCreation.code) &&
        Objects.equals(this.active, compositionCreation.active) &&
        Objects.equals(this.descripteursComposition, compositionCreation.descripteursComposition) &&
        Objects.equals(this.listeGroupes, compositionCreation.listeGroupes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, active, descripteursComposition, listeGroupes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompositionCreation {\n");
    sb.append("    code: ").append(toIndentedString(code)).append("\n");
    sb.append("    active: ").append(toIndentedString(active)).append("\n");
    sb.append("    descripteursComposition: ").append(toIndentedString(descripteursComposition)).append("\n");
