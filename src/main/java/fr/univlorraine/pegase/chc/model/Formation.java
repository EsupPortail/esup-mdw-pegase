...
public class Formation {
  ...
  public Formation code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public Formation libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
   ...
   * @return the Formation instance itself
   */
  public Formation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, formation.code) &&
        ...
        Objects.equals(this.additionalProperties, formation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, libelleLong, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "libelleLong"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "libelleLong"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Formation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Formation is not found in the empty JSON string", Formation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Formation.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Formation>() {
           ...
           public Formation read(JsonReader in) throws IOException {
             ...
             Formation instance = thisAdapter.fromJsonTree(jsonObj);
