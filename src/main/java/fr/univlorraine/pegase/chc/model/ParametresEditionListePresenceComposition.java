...
import fr.univlorraine.pegase.chc.model.Colonnes;
import fr.univlorraine.pegase.chc.model.InfoCompositionAEditer;
...
/**
 * ParametresEditionListePresenceComposition
 */
...
public class ParametresEditionListePresenceComposition {
  public static final String SERIALIZED_NAME_DATE_DU_COURS = "dateDuCours";
  public static final String SERIALIZED_NAME_INFOS_COMPOSITIONS_A_EDITER = "infosCompositionsAEditer";
  public static final String SERIALIZED_NAME_COLONNES = "colonnes";
  @SerializedName(SERIALIZED_NAME_DATE_DU_COURS)
  private Date dateDuCours;
  @SerializedName(SERIALIZED_NAME_INFOS_COMPOSITIONS_A_EDITER)
  private List<InfoCompositionAEditer> infosCompositionsAEditer = new ArrayList<InfoCompositionAEditer>();
  @SerializedName(SERIALIZED_NAME_COLONNES)
  private Colonnes colonnes;

  public ParametresEditionListePresenceComposition() { 
  }

  public ParametresEditionListePresenceComposition dateDuCours(Date dateDuCours) {
  ...
  **/
  ...
  @ApiModelProperty(value = "date du cours")
  ...
  public ParametresEditionListePresenceComposition infosCompositionsAEditer(List<InfoCompositionAEditer> infosCompositionsAEditer) {
    
    this.infosCompositionsAEditer = infosCompositionsAEditer;
    return this;
  }

  public ParametresEditionListePresenceComposition addInfosCompositionsAEditerItem(InfoCompositionAEditer infosCompositionsAEditerItem) {
    this.infosCompositionsAEditer.add(infosCompositionsAEditerItem);
    return this;
  }

   /**
   * Get infosCompositionsAEditer
   * @return infosCompositionsAEditer
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public List<InfoCompositionAEditer> getInfosCompositionsAEditer() {
    return infosCompositionsAEditer;
  }


  public void setInfosCompositionsAEditer(List<InfoCompositionAEditer> infosCompositionsAEditer) {
    this.infosCompositionsAEditer = infosCompositionsAEditer;
  }


  public ParametresEditionListePresenceComposition colonnes(Colonnes colonnes) {
  ...
  **/
  ...
  public void setColonnes(Colonnes colonnes) {
    this.colonnes = colonnes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ParametresEditionListePresenceComposition parametresEditionListePresenceComposition = (ParametresEditionListePresenceComposition) o;
    return Objects.equals(this.dateDuCours, parametresEditionListePresenceComposition.dateDuCours) &&
        Objects.equals(this.infosCompositionsAEditer, parametresEditionListePresenceComposition.infosCompositionsAEditer) &&
        Objects.equals(this.colonnes, parametresEditionListePresenceComposition.colonnes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateDuCours, infosCompositionsAEditer, colonnes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ParametresEditionListePresenceComposition {\n");
    sb.append("    dateDuCours: ").append(toIndentedString(dateDuCours)).append("\n");
    sb.append("    infosCompositionsAEditer: ").append(toIndentedString(infosCompositionsAEditer)).append("\n");
    sb.append("    colonnes: ").append(toIndentedString(colonnes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
