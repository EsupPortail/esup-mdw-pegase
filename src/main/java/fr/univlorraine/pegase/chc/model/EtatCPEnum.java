...
/**
 * Gets or Sets EtatCPEnum
 */
@JsonAdapter(EtatCPEnum.Adapter.class)
public enum EtatCPEnum {
  
  EMPTY(""),
  
  AFFECTE("AFFECTE"),
  
  AFFECTE_AVEC_AMENAGEMENTS("AFFECTE_AVEC_AMENAGEMENTS"),
  
  ACQUIS_CAPITALISE_UTILISE("ACQUIS_CAPITALISE_UTILISE"),
  
  ACQUIS_PAR_AMENAGEMENT("ACQUIS_PAR_AMENAGEMENT"),
  
  RENONCE("RENONCE"),
  
  DISPENSE_TOTALE("DISPENSE_TOTALE"),
  
  SANS_AFFECTATION("SANS_AFFECTATION");

  private String value;

  EtatCPEnum(String value) {
    this.value = value;
  }
  ...
  public static EtatCPEnum fromValue(String value) {
    for (EtatCPEnum b : EtatCPEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<EtatCPEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final EtatCPEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EtatCPEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EtatCPEnum.fromValue(value);
    }
  }
}
