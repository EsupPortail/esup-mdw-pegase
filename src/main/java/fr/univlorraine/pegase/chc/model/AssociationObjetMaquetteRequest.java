...
/**
 * AssociationObjetMaquetteRequest
 */
...
public class AssociationObjetMaquetteRequest {
  public static final String SERIALIZED_NAME_UUIDS = "uuids";
  @SerializedName(SERIALIZED_NAME_UUIDS)
  private List<UUID> uuids = null;

  public AssociationObjetMaquetteRequest() { 
  }

  public AssociationObjetMaquetteRequest uuids(List<UUID> uuids) {
    
    this.uuids = uuids;
    return this;
  }

  public AssociationObjetMaquetteRequest addUuidsItem(UUID uuidsItem) {
    if (this.uuids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AssociationObjetMaquetteRequest associationObjetMaquetteRequest = (AssociationObjetMaquetteRequest) o;
    return Objects.equals(this.uuids, associationObjetMaquetteRequest.uuids);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociationObjetMaquetteRequest {\n");
