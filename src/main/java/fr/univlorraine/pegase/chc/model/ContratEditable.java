...
public class ContratEditable {
  ...
  public static final String SERIALIZED_NAME_DATE_DERNIERE_EDITION = "dateDerniereEdition";
  ...
  @SerializedName(SERIALIZED_NAME_DATE_DERNIERE_EDITION)
  private Date dateDerniereEdition;

  public ContratEditable() { 
  }

  public ContratEditable cursusId(UUID cursusId) {
  ...
  **/
  ...
  public ContratEditable apprenant(Apprenant apprenant) {
  ...
  **/
  ...
  public ContratEditable dateCreation(Date dateCreation) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date de la création du document")
  ...
  public ContratEditable dateDerniereEdition(Date dateDerniereEdition) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date de la dernière modification du document")
  ...
  public boolean equals(Object o) {
    ...
    ContratEditable contratEditable = (ContratEditable) o;
    return Objects.equals(this.cursusId, contratEditable.cursusId) &&
        Objects.equals(this.apprenant, contratEditable.apprenant) &&
        Objects.equals(this.dateCreation, contratEditable.dateCreation) &&
        Objects.equals(this.dateDerniereEdition, contratEditable.dateDerniereEdition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusId, apprenant, dateCreation, dateDerniereEdition);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContratEditable {\n");
    ...
    sb.append("    dateDerniereEdition: ").append(toIndentedString(dateDerniereEdition)).append("\n");
    sb.append("}");
    return sb.toString();
  }
