...
/**
 * ObjetFormationCompositionDetails
 */
...
public class ObjetFormationCompositionDetails {
  public static final String SERIALIZED_NAME_OBJET_FORMATION_UUID = "objetFormationUuid";
  ...
  @SerializedName(SERIALIZED_NAME_OBJET_FORMATION_UUID)
  ...
  public ObjetFormationCompositionDetails() { 
  }

  public ObjetFormationCompositionDetails objetFormationUuid(UUID objetFormationUuid) {
    
    this.objetFormationUuid = objetFormationUuid;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "L'identifiant technique de l'objet de formation")
  ...
  public void setObjetFormationUuid(UUID objetFormationUuid) {
    this.objetFormationUuid = objetFormationUuid;
  }


  public ObjetFormationCompositionDetails code(String code) {
  ...
  **/
  ...
  public ObjetFormationCompositionDetails libelleCourt(String libelleCourt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le libellé de l'objet de formation")
  ...
  public ObjetFormationCompositionDetails libelleLong(String libelleLong) {
  ...
  **/
  ...
  public ObjetFormationCompositionDetails type(String type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le type de l'objet de formation")
  ...
  public boolean equals(Object o) {
    ...
    ObjetFormationCompositionDetails objetFormationCompositionDetails = (ObjetFormationCompositionDetails) o;
    return Objects.equals(this.objetFormationUuid, objetFormationCompositionDetails.objetFormationUuid) &&
        Objects.equals(this.code, objetFormationCompositionDetails.code) &&
        Objects.equals(this.libelleCourt, objetFormationCompositionDetails.libelleCourt) &&
        Objects.equals(this.libelleLong, objetFormationCompositionDetails.libelleLong) &&
        Objects.equals(this.type, objetFormationCompositionDetails.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objetFormationUuid, code, libelleCourt, libelleLong, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjetFormationCompositionDetails {\n");
    sb.append("    objetFormationUuid: ").append(toIndentedString(objetFormationUuid)).append("\n");
