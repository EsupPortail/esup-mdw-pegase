...
public class Calendriers {
  ...
  public Calendriers items(List<CalendrierPourList> items) {
    
    this.items = items;
    return this;
  }

  public Calendriers addItemsItem(CalendrierPourList itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Calendriers calendriers = (Calendriers) o;
    return Objects.equals(this.items, calendriers.items);
  }
