...
public class DescripteursComposition {
  ...
  public DescripteursComposition() { 
  }

  public DescripteursComposition libelleCourt(String libelleCourt) {
  ...
  **/
  ...
  public DescripteursComposition libelleLong(String libelleLong) {
  ...
  **/
  ...
  public DescripteursComposition description(String description) {
  ...
  **/
  ...
  public DescripteursComposition listeDiffusion(String listeDiffusion) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DescripteursComposition descripteursComposition = (DescripteursComposition) o;
    return Objects.equals(this.libelleCourt, descripteursComposition.libelleCourt) &&
        Objects.equals(this.libelleLong, descripteursComposition.libelleLong) &&
        Objects.equals(this.description, descripteursComposition.description) &&
        Objects.equals(this.listeDiffusion, descripteursComposition.listeDiffusion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(libelleCourt, libelleLong, description, listeDiffusion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescripteursComposition {\n");
