...
/**
 * le ou les filtres de recherche
 */
@ApiModel(description = "le ou les filtres de recherche")
...
public class ElementSelectionne {
  ...
  public static final String SERIALIZED_NAME_GROUPE_UUID = "groupeUuid";
  ...
  @SerializedName(SERIALIZED_NAME_GROUPE_UUID)
  private UUID groupeUuid;

  public ElementSelectionne() { 
  }

  public ElementSelectionne cheminObjetMaquetteUuids(List<UUID> cheminObjetMaquetteUuids) {
    
    this.cheminObjetMaquetteUuids = cheminObjetMaquetteUuids;
    return this;
  }

  public ElementSelectionne addCheminObjetMaquetteUuidsItem(UUID cheminObjetMaquetteUuidsItem) {
    this.cheminObjetMaquetteUuids.add(cheminObjetMaquetteUuidsItem);
    return this;
  }

   /**
   * liste des identifiants techniques chemin objet maquette
   * @return cheminObjetMaquetteUuids
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "liste des identifiants techniques chemin objet maquette")
  ...
  public ElementSelectionne compositionUuid(UUID compositionUuid) {
  ...
  **/
  ...
  public ElementSelectionne groupeUuid(UUID groupeUuid) {
    
    this.groupeUuid = groupeUuid;
    return this;
  }

   /**
   * L&#39; identifiant technique du groupe de la composition spécifiée
   * @return groupeUuid
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L' identifiant technique du groupe de la composition spécifiée")

  public UUID getGroupeUuid() {
    return groupeUuid;
  }


  public void setGroupeUuid(UUID groupeUuid) {
    this.groupeUuid = groupeUuid;
  }
  ...
  public boolean equals(Object o) {
    ...
    ElementSelectionne elementSelectionne = (ElementSelectionne) o;
    return Objects.equals(this.cheminObjetMaquetteUuids, elementSelectionne.cheminObjetMaquetteUuids) &&
        Objects.equals(this.compositionUuid, elementSelectionne.compositionUuid) &&
        Objects.equals(this.groupeUuid, elementSelectionne.groupeUuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cheminObjetMaquetteUuids, compositionUuid, groupeUuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ElementSelectionne {\n");
    ...
    sb.append("    groupeUuid: ").append(toIndentedString(groupeUuid)).append("\n");
    sb.append("}");
    return sb.toString();
  }
