...
public class ArbreObjetFormation {
  ...
  **/
  ...
  public ArbreObjetFormation typeObjetMaquette(TypeObjetMaquetteEnum typeObjetMaquette) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "2c1e120f-4799-414e-90d8-bbda2b869704")
  ...
  public ArbreObjetFormation caractereObligatoire(Boolean caractereObligatoire) {
   ...
   /**
   * est-ce que l&#39;objet de formation est obligatoire ou facultatif, null si dans plage de choix
   * @return caractereObligatoire
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "est-ce que l'objet de formation est obligatoire ou facultatif, null si dans plage de choix")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les crédits E.C.T.S. positionnés sur l'objet de formation")
  ...
  **/
  ...
  public ArbreObjetFormation listeCalendrier(List<CalendrierResponse> listeCalendrier) {

    this.listeCalendrier = listeCalendrier;
    return this;
  }

  public ArbreObjetFormation addListeCalendrierItem(CalendrierResponse listeCalendrierItem) {
  ...
  **/
  ...
  public ArbreObjetFormation etatPia(EtatPiaEnum etatPia) {
  ...
  **/
  ...
  public ArbreObjetFormation ouvertureChcLigne(OuvertureChcLigneEnum ouvertureChcLigne) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, arbreObjetFormation.code) &&
        Objects.equals(this.typeObjetMaquette, arbreObjetFormation.typeObjetMaquette) &&
        ...
        Objects.equals(this.listeCalendrier, arbreObjetFormation.listeCalendrier) &&
        Objects.equals(this.etatPia, arbreObjetFormation.etatPia) &&
        Objects.equals(this.ouvertureChcLigne, arbreObjetFormation.ouvertureChcLigne);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, typeObjetMaquette, libelleCourt, libelleLong, description, categorie, type, mutualise, ouvertureAuChoixDuCursus, idCheminPedagogique, caractereObligatoire, stage, creditEcts, listeObjetFormation, listeGroupement, listeCalendrier, etatPia, ouvertureChcLigne);
  }
