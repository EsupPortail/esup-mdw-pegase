...
import fr.univlorraine.pegase.chc.model.ApprenantChoixPedagogiqueViaChemin;
...
/**
 * ApprenantsChoixPedagogiqueViaChemin
 */
...
public class ApprenantsChoixPedagogiqueViaChemin {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ApprenantChoixPedagogiqueViaChemin> items = null;

  public ApprenantsChoixPedagogiqueViaChemin() { 
  }

  public ApprenantsChoixPedagogiqueViaChemin items(List<ApprenantChoixPedagogiqueViaChemin> items) {
    
    this.items = items;
    return this;
  }

  public ApprenantsChoixPedagogiqueViaChemin addItemsItem(ApprenantChoixPedagogiqueViaChemin itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ApprenantChoixPedagogiqueViaChemin>();
    }
  ...
  **/
  ...
  public List<ApprenantChoixPedagogiqueViaChemin> getItems() {
    return items;
  }


  public void setItems(List<ApprenantChoixPedagogiqueViaChemin> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApprenantsChoixPedagogiqueViaChemin apprenantsChoixPedagogiqueViaChemin = (ApprenantsChoixPedagogiqueViaChemin) o;
    return Objects.equals(this.items, apprenantsChoixPedagogiqueViaChemin.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprenantsChoixPedagogiqueViaChemin {\n");
