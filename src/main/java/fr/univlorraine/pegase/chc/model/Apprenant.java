...
public class Apprenant {
  public static final String SERIALIZED_NAME_APPRENANT_UUID = "apprenantUuid";
  ...
  @SerializedName(SERIALIZED_NAME_APPRENANT_UUID)
  ...
  **/
  ...
  @ApiModelProperty(value = "L'UUID de l'apprenant")
