 ...
 */
@ApiModel(description = "liste des code chemins des objet de formation (ou formation) de son cursus associés à la composition")
...
public class ApprenantCompositionCursus {
  ...
  public ApprenantCompositionCursus() { 
  }

  public ApprenantCompositionCursus codeChemin(String codeChemin) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApprenantCompositionCursus apprenantCompositionCursus = (ApprenantCompositionCursus) o;
    return Objects.equals(this.codeChemin, apprenantCompositionCursus.codeChemin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeChemin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApprenantCompositionCursus {\n");
