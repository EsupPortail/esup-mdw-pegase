...
public class ArbreGroupement {
  ...
  public ArbreGroupement() {
  }

  public ArbreGroupement code(String code) {
  ...
  **/
  ...
  public ArbreGroupement typeObjetMaquette(TypeObjetMaquetteEnum typeObjetMaquette) {
  ...
  **/
  ...
  public ArbreGroupement caractereObligatoire(Boolean caractereObligatoire) {
  ...
  **/
  ...
  public ArbreGroupement libelleCourt(String libelleCourt) {
  ...
  **/
  ...
  public ArbreGroupement libelleLong(String libelleLong) {
  ...
  **/
  ...
  public ArbreGroupement plageChoix(Boolean plageChoix) {
  ...
  **/
  ...
  public void setPlageChoix(Boolean plageChoix) {
    this.plageChoix = plageChoix;
  }

  public ArbreGroupement plageMin(Integer plageMin) {
  ...
  **/
  ...
  public ArbreGroupement plageMax(Integer plageMax) {
  ...
  **/
  ...
  public ArbreGroupement mutualise(Boolean mutualise) {
  ...
  **/
  ...
  public ArbreGroupement listeObjetFormation(List<ArbreObjetFormation> listeObjetFormation) {

    this.listeObjetFormation = listeObjetFormation;
    return this;
  }

  public ArbreGroupement addListeObjetFormationItem(ArbreObjetFormation listeObjetFormationItem) {
  ...
  **/
  ...
  public ArbreGroupement listeGroupement(List<ArbreGroupement> listeGroupement) {

    this.listeGroupement = listeGroupement;
    return this;
  }

  public ArbreGroupement addListeGroupementItem(ArbreGroupement listeGroupementItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ArbreGroupement arbreGroupement = (ArbreGroupement) o;
    return Objects.equals(this.code, arbreGroupement.code) &&
        Objects.equals(this.typeObjetMaquette, arbreGroupement.typeObjetMaquette) &&
        Objects.equals(this.caractereObligatoire, arbreGroupement.caractereObligatoire) &&
        Objects.equals(this.libelleCourt, arbreGroupement.libelleCourt) &&
        Objects.equals(this.libelleLong, arbreGroupement.libelleLong) &&
        Objects.equals(this.plageChoix, arbreGroupement.plageChoix) &&
        Objects.equals(this.plageMin, arbreGroupement.plageMin) &&
        Objects.equals(this.plageMax, arbreGroupement.plageMax) &&
        Objects.equals(this.mutualise, arbreGroupement.mutualise) &&
        Objects.equals(this.listeObjetFormation, arbreGroupement.listeObjetFormation) &&
        Objects.equals(this.listeGroupement, arbreGroupement.listeGroupement);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, typeObjetMaquette, caractereObligatoire, libelleCourt, libelleLong, plageChoix, plageMin, plageMax, mutualise, listeObjetFormation, listeGroupement);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ArbreGroupement {\n");
