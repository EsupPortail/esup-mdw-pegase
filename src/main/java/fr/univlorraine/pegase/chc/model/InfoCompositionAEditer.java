...
/**
 * Composition et chemin objets maquettes sélectionnés pour l&#39;édition
 */
@ApiModel(description = "Composition et chemin objets maquettes sélectionnés pour l'édition")
...
public class InfoCompositionAEditer {
  public static final String SERIALIZED_NAME_CHEMIN_OBJET_MAQUETTE_UUIDS = "cheminObjetMaquetteUuids";
  public static final String SERIALIZED_NAME_COMPOSITION_UUID = "compositionUuid";
  @SerializedName(SERIALIZED_NAME_CHEMIN_OBJET_MAQUETTE_UUIDS)
  private List<UUID> cheminObjetMaquetteUuids = new ArrayList<UUID>();
  @SerializedName(SERIALIZED_NAME_COMPOSITION_UUID)
  private UUID compositionUuid;

  public InfoCompositionAEditer() { 
  }

  public InfoCompositionAEditer cheminObjetMaquetteUuids(List<UUID> cheminObjetMaquetteUuids) {
    
    this.cheminObjetMaquetteUuids = cheminObjetMaquetteUuids;
    return this;
  }

  public InfoCompositionAEditer addCheminObjetMaquetteUuidsItem(UUID cheminObjetMaquetteUuidsItem) {
    this.cheminObjetMaquetteUuids.add(cheminObjetMaquetteUuidsItem);
    return this;
  }

   /**
   * Liste des identifiants techniques des Chemin-Objet-Maquette sélectionnés. Seuls les apprenants ayant un choix de type affectation ou renonciation sur au moins un de ces chemins et affectés à un groupe de la ou des compositions à éditer, seront présents dans l&#39;édition. Les Objet-Maquette désignés par les chemins sélectionnés doivent être associés à la Composition (Formation ou ObjetFormation)
   * @return cheminObjetMaquetteUuids
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Liste des identifiants techniques des Chemin-Objet-Maquette sélectionnés. Seuls les apprenants ayant un choix de type affectation ou renonciation sur au moins un de ces chemins et affectés à un groupe de la ou des compositions à éditer, seront présents dans l'édition. Les Objet-Maquette désignés par les chemins sélectionnés doivent être associés à la Composition (Formation ou ObjetFormation)")

  public List<UUID> getCheminObjetMaquetteUuids() {
    return cheminObjetMaquetteUuids;
  }


  public void setCheminObjetMaquetteUuids(List<UUID> cheminObjetMaquetteUuids) {
    this.cheminObjetMaquetteUuids = cheminObjetMaquetteUuids;
  }


  public InfoCompositionAEditer compositionUuid(UUID compositionUuid) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "L'identifiant technique de la composition")
  ...
  public boolean equals(Object o) {
    ...
    InfoCompositionAEditer infoCompositionAEditer = (InfoCompositionAEditer) o;
    return Objects.equals(this.cheminObjetMaquetteUuids, infoCompositionAEditer.cheminObjetMaquetteUuids) &&
        Objects.equals(this.compositionUuid, infoCompositionAEditer.compositionUuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cheminObjetMaquetteUuids, compositionUuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfoCompositionAEditer {\n");
    sb.append("    cheminObjetMaquetteUuids: ").append(toIndentedString(cheminObjetMaquetteUuids)).append("\n");
