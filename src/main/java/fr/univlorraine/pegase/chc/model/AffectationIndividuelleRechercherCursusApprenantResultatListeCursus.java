...
import fr.univlorraine.pegase.chc.model.AffectationIndividuelleRechercherCursusApprenantResultatCursus;
...
/**
 * AffectationIndividuelleRechercherCursusApprenantResultatListeCursus
 */
...
public class AffectationIndividuelleRechercherCursusApprenantResultatListeCursus {
  public static final String SERIALIZED_NAME_CURSUS_LIST = "cursusList";
  @SerializedName(SERIALIZED_NAME_CURSUS_LIST)
  private List<AffectationIndividuelleRechercherCursusApprenantResultatCursus> cursusList = null;

  public AffectationIndividuelleRechercherCursusApprenantResultatListeCursus() { 
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatListeCursus cursusList(List<AffectationIndividuelleRechercherCursusApprenantResultatCursus> cursusList) {
    
    this.cursusList = cursusList;
    return this;
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatListeCursus addCursusListItem(AffectationIndividuelleRechercherCursusApprenantResultatCursus cursusListItem) {
    if (this.cursusList == null) {
      this.cursusList = new ArrayList<AffectationIndividuelleRechercherCursusApprenantResultatCursus>();
    }
    this.cursusList.add(cursusListItem);
    return this;
  }
  ...
  **/
  ...
  public List<AffectationIndividuelleRechercherCursusApprenantResultatCursus> getCursusList() {
    return cursusList;
  }


  public void setCursusList(List<AffectationIndividuelleRechercherCursusApprenantResultatCursus> cursusList) {
    this.cursusList = cursusList;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationIndividuelleRechercherCursusApprenantResultatListeCursus affectationIndividuelleRechercherCursusApprenantResultatListeCursus = (AffectationIndividuelleRechercherCursusApprenantResultatListeCursus) o;
    return Objects.equals(this.cursusList, affectationIndividuelleRechercherCursusApprenantResultatListeCursus.cursusList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationIndividuelleRechercherCursusApprenantResultatListeCursus {\n");
    sb.append("    cursusList: ").append(toIndentedString(cursusList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
