...
public class AffectationMasseResultat {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<AffectationMasse> items = null;

  public AffectationMasseResultat() { 
  }

  public AffectationMasseResultat items(List<AffectationMasse> items) {
    
    this.items = items;
    return this;
  }

  public AffectationMasseResultat addItemsItem(AffectationMasse itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AffectationMasseResultat affectationMasseResultat = (AffectationMasseResultat) o;
    return Objects.equals(this.items, affectationMasseResultat.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class AffectationMasseResultat {\n");
