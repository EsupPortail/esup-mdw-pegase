...
import fr.univlorraine.pegase.chc.model.Apprenants;
...
public class PagedApprenants {
  ...
  public PagedApprenants() { 
  }

  public PagedApprenants items(List<Apprenant> items) {
    
    this.items = items;
    return this;
  }

  public PagedApprenants addItemsItem(Apprenant itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Apprenant>();
    }
  ...
  **/
  ...
  public PagedApprenants totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedApprenants totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedApprenants taille(Integer taille) {
  ...
  **/
  ...
  public PagedApprenants page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedApprenants pagedApprenants = (PagedApprenants) o;
    return Objects.equals(this.items, pagedApprenants.items) &&
        Objects.equals(this.totalElements, pagedApprenants.totalElements) &&
        Objects.equals(this.totalPages, pagedApprenants.totalPages) &&
        Objects.equals(this.taille, pagedApprenants.taille) &&
        Objects.equals(this.page, pagedApprenants.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedApprenants {\n");
