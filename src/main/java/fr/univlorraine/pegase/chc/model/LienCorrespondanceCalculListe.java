...
import fr.univlorraine.pegase.chc.model.LienCorrespondanceCalcul;
...
public class LienCorrespondanceCalculListe {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<LienCorrespondanceCalcul> items = null;

  public LienCorrespondanceCalculListe() { 
  }

  public LienCorrespondanceCalculListe items(List<LienCorrespondanceCalcul> items) {
    
    this.items = items;
    return this;
  }

  public LienCorrespondanceCalculListe addItemsItem(LienCorrespondanceCalcul itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LienCorrespondanceCalculListe lienCorrespondanceCalculListe = (LienCorrespondanceCalculListe) o;
    return Objects.equals(this.items, lienCorrespondanceCalculListe.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class LienCorrespondanceCalculListe {\n");
