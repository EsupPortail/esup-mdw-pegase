...
public class FormationCompositionDetails {
  public static final String SERIALIZED_NAME_FORMATION_UUID = "formationUuid";
  ...
  @SerializedName(SERIALIZED_NAME_FORMATION_UUID)
  ...
  public FormationCompositionDetails() { 
  }

  public FormationCompositionDetails formationUuid(UUID formationUuid) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "L'identifiant technique de la formation")
  ...
  public FormationCompositionDetails code(String code) {
  ...
  **/
  ...
  public FormationCompositionDetails libelleCourt(String libelleCourt) {
  ...
  **/
  ...
  public FormationCompositionDetails libelleLong(String libelleLong) {
  ...
  **/
  ...
  public FormationCompositionDetails type(String type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le type de la formation")
  ...
  public boolean equals(Object o) {
    ...
    FormationCompositionDetails formationCompositionDetails = (FormationCompositionDetails) o;
    return Objects.equals(this.formationUuid, formationCompositionDetails.formationUuid) &&
        Objects.equals(this.code, formationCompositionDetails.code) &&
        Objects.equals(this.libelleCourt, formationCompositionDetails.libelleCourt) &&
        Objects.equals(this.libelleLong, formationCompositionDetails.libelleLong) &&
        Objects.equals(this.type, formationCompositionDetails.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formationUuid, code, libelleCourt, libelleLong, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormationCompositionDetails {\n");
    sb.append("    formationUuid: ").append(toIndentedString(formationUuid)).append("\n");
