...
/**
 * calculs relatifs à la liste des contextes demandés en argument
 */
@ApiModel(description = "calculs relatifs à la liste des contextes demandés en argument")
...
public class StatsChemins {
  public static final String SERIALIZED_NAME_A_AFFECTER_A_UN_GROUPE = "aAffecterAUnGroupe";
  public static final String SERIALIZED_NAME_TOTAL = "total";
  @SerializedName(SERIALIZED_NAME_A_AFFECTER_A_UN_GROUPE)
  ...
  public StatsChemins aAffecterAUnGroupe(Integer aAffecterAUnGroupe) {
    
    this.aAffecterAUnGroupe = aAffecterAUnGroupe;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "nombre d'apprenants a affecter à un groupe de cette composition au titre d'au moins un des contextes demandés en argument")
  ...
  public void setaAffecterAUnGroupe(Integer aAffecterAUnGroupe) {
    this.aAffecterAUnGroupe = aAffecterAUnGroupe;
  }


  public StatsChemins total(Integer total) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "nombre d'apprenants affectés ou affectables à un groupe de cette composition au titre d'au moins un des contextes demandés en argument")
  ...
  public boolean equals(Object o) {
    ...
    StatsChemins statsChemins = (StatsChemins) o;
    return Objects.equals(this.aAffecterAUnGroupe, statsChemins.aAffecterAUnGroupe) &&
        Objects.equals(this.total, statsChemins.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aAffecterAUnGroupe, total);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatsChemins {\n");
    sb.append("    aAffecterAUnGroupe: ").append(toIndentedString(aAffecterAUnGroupe)).append("\n");
