...
public class ObjetLibellePourExtraction {
  ...
  public ObjetLibellePourExtraction() {
  }

  public ObjetLibellePourExtraction code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ObjetLibellePourExtraction libelleCourt(@jakarta.annotation.Nullable String libelleCourt) {
  ...
  public ObjetLibellePourExtraction libelleLong(@jakarta.annotation.Nullable String libelleLong) {
   ...
   * @return the ObjetLibellePourExtraction instance itself
   */
  public ObjetLibellePourExtraction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObjetLibellePourExtraction objetLibellePourExtraction = (ObjetLibellePourExtraction) o;
    return Objects.equals(this.code, objetLibellePourExtraction.code) &&
        Objects.equals(this.libelleCourt, objetLibellePourExtraction.libelleCourt) &&
        Objects.equals(this.libelleLong, objetLibellePourExtraction.libelleLong)&&
        Objects.equals(this.additionalProperties, objetLibellePourExtraction.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjetLibellePourExtraction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjetLibellePourExtraction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjetLibellePourExtraction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ObjetLibellePourExtraction is not found in the empty JSON string", ObjetLibellePourExtraction.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjetLibellePourExtraction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjetLibellePourExtraction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjetLibellePourExtraction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjetLibellePourExtraction.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjetLibellePourExtraction>() {
           @Override
           public void write(JsonWriter out, ObjetLibellePourExtraction value) throws IOException {
           ...
           @Override
           public ObjetLibellePourExtraction read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ObjetLibellePourExtraction instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ObjetLibellePourExtraction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjetLibellePourExtraction
   * @throws IOException if the JSON string is invalid with respect to ObjetLibellePourExtraction
   */
  public static ObjetLibellePourExtraction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjetLibellePourExtraction.class);
  }

  /**
   * Convert an instance of ObjetLibellePourExtraction to an JSON string
   *
   * @return JSON string
   */
