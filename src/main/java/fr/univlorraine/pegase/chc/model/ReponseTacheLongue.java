...
public class ReponseTacheLongue {
  public static final String SERIALIZED_NAME_IDENTIFIANT_TACHE = "identifiantTache";
  @SerializedName(SERIALIZED_NAME_IDENTIFIANT_TACHE)
  private String identifiantTache;

  public ReponseTacheLongue() { 
  }

  public ReponseTacheLongue identifiantTache(String identifiantTache) {
  ...
  **/
  ...
  @ApiModelProperty(value = "identifiant de la tache en cours")
  ...
  public void setIdentifiantTache(String identifiantTache) {
    this.identifiantTache = identifiantTache;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReponseTacheLongue reponseTacheLongue = (ReponseTacheLongue) o;
    return Objects.equals(this.identifiantTache, reponseTacheLongue.identifiantTache);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifiantTache);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReponseTacheLongue {\n");
    sb.append("    identifiantTache: ").append(toIndentedString(identifiantTache)).append("\n");
    sb.append("}");
    return sb.toString();
  }
