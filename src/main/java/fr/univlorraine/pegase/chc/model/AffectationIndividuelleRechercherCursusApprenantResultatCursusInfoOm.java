...
/**
 * informations sur un objet maquette
 */
@ApiModel(description = "informations sur un objet maquette")
...
public class AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm {
  ...
  public AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm() { 
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(example = "L2", required = true, value = "")
  ...
  public AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm libelleCourt(String libelleCourt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Licence 2", required = true, value = "")
  ...
  public AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm libelleLong(String libelleLong) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Licence 2eme année", value = "")
  ...
  public boolean equals(Object o) {
    ...
    AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm affectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm = (AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm) o;
    return Objects.equals(this.code, affectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm.code) &&
        Objects.equals(this.libelleCourt, affectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm.libelleCourt) &&
        Objects.equals(this.libelleLong, affectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm.libelleLong);
  }
  ...
  public String toString() {
    ...
    sb.append("class AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm {\n");
