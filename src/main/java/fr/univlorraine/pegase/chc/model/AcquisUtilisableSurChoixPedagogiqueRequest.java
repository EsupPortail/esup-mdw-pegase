...
/**
 * AcquisUtilisableSurChoixPedagogiqueRequest
 */
...
public class AcquisUtilisableSurChoixPedagogiqueRequest {
  ...
  public AcquisUtilisableSurChoixPedagogiqueRequest() { 
  }

  public AcquisUtilisableSurChoixPedagogiqueRequest codeCheminChoixPedagogique(String codeCheminChoixPedagogique) {
   ...
   /**
   * le code chemin de l&#39;objet maquette pour lequel on veut le detail de l&#39;acquis utilisable.
   * @return codeCheminChoixPedagogique
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "le code chemin de l'objet maquette pour lequel on veut le detail de l'acquis utilisable.")
  ...
  public boolean equals(Object o) {
    ...
    AcquisUtilisableSurChoixPedagogiqueRequest acquisUtilisableSurChoixPedagogiqueRequest = (AcquisUtilisableSurChoixPedagogiqueRequest) o;
    return Objects.equals(this.codeCheminChoixPedagogique, acquisUtilisableSurChoixPedagogiqueRequest.codeCheminChoixPedagogique);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeCheminChoixPedagogique);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AcquisUtilisableSurChoixPedagogiqueRequest {\n");
