...
import fr.univlorraine.pegase.chc.model.AffectationMasse;
import fr.univlorraine.pegase.chc.model.AffectationMasseResultat;
...
public class PagedAffectationMasseBatch {
  ...
  private List<AffectationMasse> items = null;
  ...
  public PagedAffectationMasseBatch() { 
  }

  public PagedAffectationMasseBatch items(List<AffectationMasse> items) {
    
    this.items = items;
    return this;
  }

  public PagedAffectationMasseBatch addItemsItem(AffectationMasse itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<AffectationMasse>();
    }
  ...
  **/
  ...
  public List<AffectationMasse> getItems() {
    return items;
  }


  public void setItems(List<AffectationMasse> items) {
    this.items = items;
  }


  public PagedAffectationMasseBatch totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedAffectationMasseBatch totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedAffectationMasseBatch taille(Integer taille) {
  ...
  **/
  ...
  public PagedAffectationMasseBatch page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedAffectationMasseBatch pagedAffectationMasseBatch = (PagedAffectationMasseBatch) o;
    return Objects.equals(this.items, pagedAffectationMasseBatch.items) &&
        Objects.equals(this.totalElements, pagedAffectationMasseBatch.totalElements) &&
        Objects.equals(this.totalPages, pagedAffectationMasseBatch.totalPages) &&
        Objects.equals(this.taille, pagedAffectationMasseBatch.taille) &&
        Objects.equals(this.page, pagedAffectationMasseBatch.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedAffectationMasseBatch {\n");
