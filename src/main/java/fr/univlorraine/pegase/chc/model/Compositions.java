...
public class Compositions {
  ...
  public Compositions items(List<CompositionPourListe> items) {
    
    this.items = items;
    return this;
  }

  public Compositions addItemsItem(CompositionPourListe itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Compositions compositions = (Compositions) o;
    return Objects.equals(this.items, compositions.items);
  }
