...
public class GroupeDetails {
  ...
  public GroupeDetails() { 
  }

  public GroupeDetails code(String code) {
  ...
  **/
  ...
  public GroupeDetails libelleCourt(String libelleCourt) {
  ...
  **/
  ...
  public GroupeDetails libelleLong(String libelleLong) {
  ...
  **/
  ...
  public GroupeDetails horsOffreFormation(Boolean horsOffreFormation) {
  ...
  **/
  ...
  public GroupeDetails description(String description) {
  ...
  **/
  ...
  public GroupeDetails listeDiffusion(String listeDiffusion) {
  ...
  **/
  ...
  public GroupeDetails capacite(Integer capacite) {
  ...
  **/
  ...
  public GroupeDetails capaciteBloquante(Boolean capaciteBloquante) {
  ...
  **/
  ...
  public GroupeDetails placesReservees(Integer placesReservees) {
  ...
  **/
  ...
  public GroupeDetails planifiable(Boolean planifiable) {
  ...
  **/
  ...
  public GroupeDetails actif(Boolean actif) {
  ...
  **/
  ...
  public GroupeDetails codeType(String codeType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Le code type de groupe")
  ...
  public GroupeDetails listeEnseignant(List<String> listeEnseignant) {
    
    this.listeEnseignant = listeEnseignant;
    return this;
  }

  public GroupeDetails addListeEnseignantItem(String listeEnseignantItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GroupeDetails groupeDetails = (GroupeDetails) o;
    return Objects.equals(this.code, groupeDetails.code) &&
        Objects.equals(this.libelleCourt, groupeDetails.libelleCourt) &&
        Objects.equals(this.libelleLong, groupeDetails.libelleLong) &&
        Objects.equals(this.horsOffreFormation, groupeDetails.horsOffreFormation) &&
        Objects.equals(this.description, groupeDetails.description) &&
        Objects.equals(this.listeDiffusion, groupeDetails.listeDiffusion) &&
        Objects.equals(this.capacite, groupeDetails.capacite) &&
        Objects.equals(this.capaciteBloquante, groupeDetails.capaciteBloquante) &&
        Objects.equals(this.placesReservees, groupeDetails.placesReservees) &&
        Objects.equals(this.planifiable, groupeDetails.planifiable) &&
        Objects.equals(this.actif, groupeDetails.actif) &&
        Objects.equals(this.codeType, groupeDetails.codeType) &&
        Objects.equals(this.listeEnseignant, groupeDetails.listeEnseignant);
  }
