...
/**
 * FaireChoixPedagogiqueAvecPropositionRequest
 */
...
public class FaireChoixPedagogiqueAvecPropositionRequest {
  public static final String SERIALIZED_NAME_AVEC_PROPAGATION = "avecPropagation";
  public static final String SERIALIZED_NAME_CODE_CHEMIN_CHOIX_PEDAGOGIQUE = "codeCheminChoixPedagogique";
  @SerializedName(SERIALIZED_NAME_AVEC_PROPAGATION)
  private Boolean avecPropagation;
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_CHOIX_PEDAGOGIQUE)
  private String codeCheminChoixPedagogique;

  public FaireChoixPedagogiqueAvecPropositionRequest() { 
  }

  public FaireChoixPedagogiqueAvecPropositionRequest avecPropagation(Boolean avecPropagation) {
    
    this.avecPropagation = avecPropagation;
    return this;
  }
   ...
   * @return avecPropagation
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Si les propositions pédagogiques doivent être faites à la création du brouillon. C'est à dire choix affectation ou choix capitalisé lorsque possible sur les OF obligatoires et hors plage de choix")

  public Boolean getAvecPropagation() {
    return avecPropagation;
  }


  public void setAvecPropagation(Boolean avecPropagation) {
    this.avecPropagation = avecPropagation;
  }


  public FaireChoixPedagogiqueAvecPropositionRequest codeCheminChoixPedagogique(String codeCheminChoixPedagogique) {
    
    this.codeCheminChoixPedagogique = codeCheminChoixPedagogique;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "le code chemin de l'objet maquette sur lequel on veut faire un choix pédagogique")
  ...
  public void setCodeCheminChoixPedagogique(String codeCheminChoixPedagogique) {
    this.codeCheminChoixPedagogique = codeCheminChoixPedagogique;
  }
  ...
  public boolean equals(Object o) {
    ...
    FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest = (FaireChoixPedagogiqueAvecPropositionRequest) o;
    return Objects.equals(this.avecPropagation, faireChoixPedagogiqueAvecPropositionRequest.avecPropagation) &&
        Objects.equals(this.codeCheminChoixPedagogique, faireChoixPedagogiqueAvecPropositionRequest.codeCheminChoixPedagogique);
  }

  @Override
  public int hashCode() {
    return Objects.hash(avecPropagation, codeCheminChoixPedagogique);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FaireChoixPedagogiqueAvecPropositionRequest {\n");
    sb.append("    avecPropagation: ").append(toIndentedString(avecPropagation)).append("\n");
    sb.append("    codeCheminChoixPedagogique: ").append(toIndentedString(codeCheminChoixPedagogique)).append("\n");
    sb.append("}");
    return sb.toString();
  }
