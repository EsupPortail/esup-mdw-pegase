...
/**
 * capacités d&#39;accueil de ce groupe
 */
@ApiModel(description = "capacités d'accueil de ce groupe")
...
public class GroupeCapaciteAccueil {
  public static final String SERIALIZED_NAME_TOTALE = "totale";
  public static final String SERIALIZED_NAME_RESTANTE = "restante";
  @SerializedName(SERIALIZED_NAME_TOTALE)
  private Integer totale;
  @SerializedName(SERIALIZED_NAME_RESTANTE)
  private Integer restante;

  public GroupeCapaciteAccueil() { 
  }

  public GroupeCapaciteAccueil totale(Integer totale) {
  ...
  **/
  ...
  @ApiModelProperty(value = "capacité d'accueil totale de ce groupe")
  ...
  public GroupeCapaciteAccueil restante(Integer restante) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "capacité d'accueil restante de ce groupe")
  ...
  public boolean equals(Object o) {
    ...
    GroupeCapaciteAccueil groupeCapaciteAccueil = (GroupeCapaciteAccueil) o;
    return Objects.equals(this.totale, groupeCapaciteAccueil.totale) &&
        Objects.equals(this.restante, groupeCapaciteAccueil.restante);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totale, restante);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupeCapaciteAccueil {\n");
    sb.append("    totale: ").append(toIndentedString(totale)).append("\n");
    sb.append("    restante: ").append(toIndentedString(restante)).append("\n");
    sb.append("}");
    return sb.toString();
  }
