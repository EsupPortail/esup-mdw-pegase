...
public class AffectationMasse {
  ...
  public static final String SERIALIZED_NAME_LIBELLE_COURT_O_M = "libelleCourtOM";
  ...
  public static final String SERIALIZED_NAME_GESTIONNAIRE = "gestionnaire";
  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;
  @SerializedName(SERIALIZED_NAME_CODE_OBJET_MAQUETTE)
  private String codeObjetMaquette;
  @SerializedName(SERIALIZED_NAME_LIBELLE_COURT_O_M)
  ...
  @SerializedName(SERIALIZED_NAME_GESTIONNAIRE)
  ...
  **/
  ...
  @ApiModelProperty(example = "123456789", value = "L'identifiant technique du job executé")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "libelle court de l'objet maquette")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "code chemin")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date de début de traitement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date de fin de traitement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "gestionnaire")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le type du traitement")
   ...
   * Gets or Sets etat
   */
  @JsonAdapter(EtatEnum.Adapter.class)
  public enum EtatEnum {
    ...
    public static class Adapter extends TypeAdapter<EtatEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final EtatEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public EtatEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return EtatEnum.fromValue(value);
      }
    }
  }
