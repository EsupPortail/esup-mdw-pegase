...
import fr.univlorraine.pegase.chc.model.AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm;
...
/**
 * AffectationIndividuelleRechercherCursusApprenantResultatCursus
 */
...
public class AffectationIndividuelleRechercherCursusApprenantResultatCursus {
  ...
  public static final String SERIALIZED_NAME_EST_OM_IA_OUVERT_AU_CHC = "estOmIaOuvertAuChc";
  public static final String SERIALIZED_NAME_CODE_CHEMIN_OM_IA = "codeCheminOmIa";
  public static final String SERIALIZED_NAME_STATUT_IA = "statutIa";
  public static final String SERIALIZED_NAME_INFO_OBJETS_MAQUETTE_CHEMIN_IA_LIST = "infoObjetsMaquetteCheminIaList";
  @SerializedName(SERIALIZED_NAME_CURSUS_UUID)
  private UUID cursusUuid;
  @SerializedName(SERIALIZED_NAME_EST_OM_IA_OUVERT_AU_CHC)
  private Boolean estOmIaOuvertAuChc;
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN_OM_IA)
  private String codeCheminOmIa;
  @SerializedName(SERIALIZED_NAME_STATUT_IA)
  private StatutIaEnum statutIa;
  @SerializedName(SERIALIZED_NAME_INFO_OBJETS_MAQUETTE_CHEMIN_IA_LIST)
  private List<AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm> infoObjetsMaquetteCheminIaList = null;
  public AffectationIndividuelleRechercherCursusApprenantResultatCursus() {
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursus cursusUuid(UUID cursusUuid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "158c9998-18da-4bef-a8db-4891b1736574", required = true, value = "L'UUID du cursus")
  ...
  public AffectationIndividuelleRechercherCursusApprenantResultatCursus estOmIaOuvertAuChc(Boolean estOmIaOuvertAuChc) {

    this.estOmIaOuvertAuChc = estOmIaOuvertAuChc;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "si l'objet maquette qui porte l'inscription administrative est ouvert au chc")

  public Boolean getEstOmIaOuvertAuChc() {
    return estOmIaOuvertAuChc;
  }

  public void setEstOmIaOuvertAuChc(Boolean estOmIaOuvertAuChc) {
    this.estOmIaOuvertAuChc = estOmIaOuvertAuChc;
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursus codeCheminOmIa(String codeCheminOmIa) {

    this.codeCheminOmIa = codeCheminOmIa;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "LICENCE-INFO>L2>SEMESTRE-1", value = "code chemin de l'objet maquette qui porte l'inscription administrative")

  public String getCodeCheminOmIa() {
    return codeCheminOmIa;
  }

  public void setCodeCheminOmIa(String codeCheminOmIa) {
    this.codeCheminOmIa = codeCheminOmIa;
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursus statutIa(StatutIaEnum statutIa) {
  ...
  **/
  ...
  public void setStatutIa(StatutIaEnum statutIa) {
    this.statutIa = statutIa;
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursus infoObjetsMaquetteCheminIaList(List<AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm> infoObjetsMaquetteCheminIaList) {

    this.infoObjetsMaquetteCheminIaList = infoObjetsMaquetteCheminIaList;
    return this;
  }

  public AffectationIndividuelleRechercherCursusApprenantResultatCursus addInfoObjetsMaquetteCheminIaListItem(AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm infoObjetsMaquetteCheminIaListItem) {
    if (this.infoObjetsMaquetteCheminIaList == null) {
      this.infoObjetsMaquetteCheminIaList = new ArrayList<AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm>();
    }
    this.infoObjetsMaquetteCheminIaList.add(infoObjetsMaquetteCheminIaListItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "liste ordonnée des informations sur les OM, de l'OM racine jusqu'à l'OM qui porte l'IA")

  public List<AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm> getInfoObjetsMaquetteCheminIaList() {
    return infoObjetsMaquetteCheminIaList;
  }

  public void setInfoObjetsMaquetteCheminIaList(List<AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm> infoObjetsMaquetteCheminIaList) {
    this.infoObjetsMaquetteCheminIaList = infoObjetsMaquetteCheminIaList;
  }
  ...
  public boolean equals(Object o) {
    ...
    AffectationIndividuelleRechercherCursusApprenantResultatCursus affectationIndividuelleRechercherCursusApprenantResultatCursus = (AffectationIndividuelleRechercherCursusApprenantResultatCursus) o;
    return Objects.equals(this.cursusUuid, affectationIndividuelleRechercherCursusApprenantResultatCursus.cursusUuid) &&
        Objects.equals(this.estOmIaOuvertAuChc, affectationIndividuelleRechercherCursusApprenantResultatCursus.estOmIaOuvertAuChc) &&
        Objects.equals(this.codeCheminOmIa, affectationIndividuelleRechercherCursusApprenantResultatCursus.codeCheminOmIa) &&
        Objects.equals(this.statutIa, affectationIndividuelleRechercherCursusApprenantResultatCursus.statutIa) &&
        Objects.equals(this.infoObjetsMaquetteCheminIaList, affectationIndividuelleRechercherCursusApprenantResultatCursus.infoObjetsMaquetteCheminIaList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursusUuid, estOmIaOuvertAuChc, codeCheminOmIa, statutIa, infoObjetsMaquetteCheminIaList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationIndividuelleRechercherCursusApprenantResultatCursus {\n");
    sb.append("    cursusUuid: ").append(toIndentedString(cursusUuid)).append("\n");
    sb.append("    estOmIaOuvertAuChc: ").append(toIndentedString(estOmIaOuvertAuChc)).append("\n");
    sb.append("    codeCheminOmIa: ").append(toIndentedString(codeCheminOmIa)).append("\n");
    sb.append("    statutIa: ").append(toIndentedString(statutIa)).append("\n");
    sb.append("    infoObjetsMaquetteCheminIaList: ").append(toIndentedString(infoObjetsMaquetteCheminIaList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * le statut de l&#39;inscription
   */
  @JsonAdapter(StatutIaEnum.Adapter.class)
  public enum StatutIaEnum {
    VALIDE("VALIDE"),
    ...
    StatutIaEnum(String value) {
      this.value = value;
    }

    public static StatutIaEnum fromValue(String value) {
      for (StatutIaEnum b : StatutIaEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<StatutIaEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StatutIaEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StatutIaEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return StatutIaEnum.fromValue(value);
      }
    }
  }
