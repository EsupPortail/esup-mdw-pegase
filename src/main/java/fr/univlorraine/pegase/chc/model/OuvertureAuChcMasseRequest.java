...
public class OuvertureAuChcMasseRequest {
  public static final String SERIALIZED_NAME_IDS_CHEMIN_PEDAGOGIQUE = "idsCheminPedagogique";
  public static final String SERIALIZED_NAME_AVEC_OUVERTURE_A_LA_DESCENDANCE = "avecOuvertureALaDescendance";
  @SerializedName(SERIALIZED_NAME_IDS_CHEMIN_PEDAGOGIQUE)
  private List<UUID> idsCheminPedagogique = null;
  @SerializedName(SERIALIZED_NAME_AVEC_OUVERTURE_A_LA_DESCENDANCE)
  private Boolean avecOuvertureALaDescendance;

  public OuvertureAuChcMasseRequest() { 
  }

  public OuvertureAuChcMasseRequest idsCheminPedagogique(List<UUID> idsCheminPedagogique) {
    
    this.idsCheminPedagogique = idsCheminPedagogique;
    return this;
  }

  public OuvertureAuChcMasseRequest addIdsCheminPedagogiqueItem(UUID idsCheminPedagogiqueItem) {
    if (this.idsCheminPedagogique == null) {
      this.idsCheminPedagogique = new ArrayList<UUID>();
    }
    this.idsCheminPedagogique.add(idsCheminPedagogiqueItem);
    return this;
  }

   /**
   * Get idsCheminPedagogique
   * @return idsCheminPedagogique
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<UUID> getIdsCheminPedagogique() {
    return idsCheminPedagogique;
  }


  public void setIdsCheminPedagogique(List<UUID> idsCheminPedagogique) {
    this.idsCheminPedagogique = idsCheminPedagogique;
  }


  public OuvertureAuChcMasseRequest avecOuvertureALaDescendance(Boolean avecOuvertureALaDescendance) {
    
    this.avecOuvertureALaDescendance = avecOuvertureALaDescendance;
    return this;
  }

   /**
   * spécifie si on doit également ouvrir au chc la descendance
   * @return avecOuvertureALaDescendance
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "spécifie si on doit également ouvrir au chc la descendance")

  public Boolean getAvecOuvertureALaDescendance() {
    return avecOuvertureALaDescendance;
  }


  public void setAvecOuvertureALaDescendance(Boolean avecOuvertureALaDescendance) {
    this.avecOuvertureALaDescendance = avecOuvertureALaDescendance;
  }
  ...
  public boolean equals(Object o) {
    ...
    OuvertureAuChcMasseRequest ouvertureAuChcMasseRequest = (OuvertureAuChcMasseRequest) o;
    return Objects.equals(this.idsCheminPedagogique, ouvertureAuChcMasseRequest.idsCheminPedagogique) &&
        Objects.equals(this.avecOuvertureALaDescendance, ouvertureAuChcMasseRequest.avecOuvertureALaDescendance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idsCheminPedagogique, avecOuvertureALaDescendance);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OuvertureAuChcMasseRequest {\n");
    sb.append("    idsCheminPedagogique: ").append(toIndentedString(idsCheminPedagogique)).append("\n");
    sb.append("    avecOuvertureALaDescendance: ").append(toIndentedString(avecOuvertureALaDescendance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
