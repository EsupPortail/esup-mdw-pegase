...
/**
 * Les informations de l&#39;objet formation de composition
 */
@ApiModel(description = "Les informations de l'objet formation de composition")
...
public class InfoObjetFormationComposition {
  ...
  public InfoObjetFormationComposition() { 
  }

  public InfoObjetFormationComposition code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Le code de l'objet formation de composition")
  ...
  public InfoObjetFormationComposition libelle(String libelle) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le libelle de l'objet formation de composition")
  ...
  public InfoObjetFormationComposition id(UUID id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "l'id de l'objet formation de composition")
  ...
  public InfoObjetFormationComposition codeType(String codeType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le codeType de l'objet formation de composition")
  ...
  public boolean equals(Object o) {
    ...
    InfoObjetFormationComposition infoObjetFormationComposition = (InfoObjetFormationComposition) o;
    return Objects.equals(this.code, infoObjetFormationComposition.code) &&
        Objects.equals(this.libelle, infoObjetFormationComposition.libelle) &&
        Objects.equals(this.id, infoObjetFormationComposition.id) &&
        Objects.equals(this.codeType, infoObjetFormationComposition.codeType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, libelle, id, codeType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfoObjetFormationComposition {\n");
