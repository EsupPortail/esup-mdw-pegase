...
import fr.univlorraine.pegase.chc.model.FormationMasse;
import fr.univlorraine.pegase.chc.model.GroupementMasse;
import fr.univlorraine.pegase.chc.model.ObjetFormationMasse;
...
public class CheminObjetMaquette {
  public static final String SERIALIZED_NAME_ID_CHEMIN_OBJET_MAQUETTE = "idCheminObjetMaquette";
  ...
  public static final String SERIALIZED_NAME_PERIODE_EST_ACTIVE = "periodeEstActive";
  ...
  public static final String SERIALIZED_NAME_EST_PLAGE_DE_CHOIX = "estPlageDeChoix";
  ...
  @SerializedName(SERIALIZED_NAME_ID_CHEMIN_OBJET_MAQUETTE)
  ...
  @SerializedName(SERIALIZED_NAME_PERIODE_EST_ACTIVE)
  ...
  @SerializedName(SERIALIZED_NAME_EST_PLAGE_DE_CHOIX)
  ...
  **/
  ...
  @ApiModelProperty(value = "L'id technique du chemin objet maquette")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L'id technique du chemin pédagogique")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Définit si la periode est active ou pas")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "temoin d'obligation")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ouverture au choix du cursus")
  ...
  **/
   ...
   * ouverture au choix du cursus
   */
  @JsonAdapter(OuverteChoixCursusEnum.Adapter.class)
  public enum OuverteChoixCursusEnum {
    ...
    public static class Adapter extends TypeAdapter<OuverteChoixCursusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OuverteChoixCursusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OuverteChoixCursusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return OuverteChoixCursusEnum.fromValue(value);
      }
    }
  }
