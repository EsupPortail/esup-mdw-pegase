...
import fr.univlorraine.pegase.chc.model.ApprenantPourext;
import fr.univlorraine.pegase.chc.model.ObjetFormationPourext;
...
/**
 * Une affectation aux choix du cursus sur la période demandée
 */
...
public class CursusPourext {
  ...
  private ObjetFormationPourext objetFormation;

  public static final String SERIALIZED_NAME_LISTE_APPRENANTS = "listeApprenants";
  @SerializedName(SERIALIZED_NAME_LISTE_APPRENANTS)
  @jakarta.annotation.Nonnull
  private List<ApprenantPourext> listeApprenants = new ArrayList<>();

  public CursusPourext() {
  }

  public CursusPourext objetFormation(@jakarta.annotation.Nonnull ObjetFormationPourext objetFormation) {
   ...
   */
  @jakarta.annotation.Nonnull
  public ObjetFormationPourext getObjetFormation() {
    return objetFormation;
  }

  public void setObjetFormation(@jakarta.annotation.Nonnull ObjetFormationPourext objetFormation) {
    this.objetFormation = objetFormation;
  }


  public CursusPourext listeApprenants(@jakarta.annotation.Nonnull List<ApprenantPourext> listeApprenants) {
    this.listeApprenants = listeApprenants;
    return this;
  }

  public CursusPourext addListeApprenantsItem(ApprenantPourext listeApprenantsItem) {
    if (this.listeApprenants == null) {
      this.listeApprenants = new ArrayList<>();
    }
    this.listeApprenants.add(listeApprenantsItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  public List<ApprenantPourext> getListeApprenants() {
    return listeApprenants;
  }

  public void setListeApprenants(@jakarta.annotation.Nonnull List<ApprenantPourext> listeApprenants) {
    this.listeApprenants = listeApprenants;
  }
   ...
   * @return the CursusPourext instance itself
   */
  public CursusPourext putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CursusPourext cursusPourext = (CursusPourext) o;
    return Objects.equals(this.objetFormation, cursusPourext.objetFormation) &&
        Objects.equals(this.listeApprenants, cursusPourext.listeApprenants)&&
        Objects.equals(this.additionalProperties, cursusPourext.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objetFormation, listeApprenants, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CursusPourext {\n");
    sb.append("    objetFormation: ").append(toIndentedString(objetFormation)).append("\n");
    sb.append("    listeApprenants: ").append(toIndentedString(listeApprenants)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("objetFormation", "listeApprenants"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("objetFormation", "listeApprenants"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CursusPourext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CursusPourext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CursusPourext is not found in the empty JSON string", CursusPourext.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CursusPourext.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `objetFormation`
      ObjetFormationPourext.validateJsonElement(jsonObj.get("objetFormation"));
      if (jsonObj.get("listeApprenants") != null) {
        if (!jsonObj.get("listeApprenants").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `listeApprenants` to be an array in the JSON string but got `%s`", jsonObj.get("listeApprenants").toString()));
        }
        JsonArray jsonArraylisteApprenants = jsonObj.getAsJsonArray("listeApprenants");
        // validate the required field `listeApprenants` (array)
        for (int i = 0; i < jsonArraylisteApprenants.size(); i++) {
          ApprenantPourext.validateJsonElement(jsonArraylisteApprenants.get(i));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CursusPourext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CursusPourext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CursusPourext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CursusPourext.class));

       return (TypeAdapter<T>) new TypeAdapter<CursusPourext>() {
           @Override
           public void write(JsonWriter out, CursusPourext value) throws IOException {
           ...
           @Override
           public CursusPourext read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CursusPourext instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CursusPourext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CursusPourext
   * @throws IOException if the JSON string is invalid with respect to CursusPourext
   */
  public static CursusPourext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CursusPourext.class);
  }

  /**
   * Convert an instance of CursusPourext to an JSON string
   *
   * @return JSON string
   */
