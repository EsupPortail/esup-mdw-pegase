...
public class CursusPourext {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(objetFormation, listeApprenants);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CursusPourext.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CursusPourext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
