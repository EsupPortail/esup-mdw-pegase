...
public class ObjetFormationOuFormation {
  ...
  public static final String SERIALIZED_NAME_OBJET_MAQUETTE_UUID = "objetMaquetteUuid";
  ...
  @SerializedName(SERIALIZED_NAME_OBJET_MAQUETTE_UUID)
  private UUID objetMaquetteUuid;
  ...
  **/
  ...
  public ObjetFormationOuFormation objetMaquetteUuid(UUID objetMaquetteUuid) {

    this.objetMaquetteUuid = objetMaquetteUuid;
    return this;
  }

   /**
   * L&#39;identifiant technique de la formation ou de l&#39;objet formation
   * @return objetMaquetteUuid
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L'identifiant technique de la formation ou de l'objet formation")

  public UUID getObjetMaquetteUuid() {
    return objetMaquetteUuid;
  }

  public void setObjetMaquetteUuid(UUID objetMaquetteUuid) {
    this.objetMaquetteUuid = objetMaquetteUuid;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, objetFormationOuFormation.type) &&
        ...
        Objects.equals(this.objetMaquetteUuid, objetFormationOuFormation.objetMaquetteUuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, code, libelleCourt, libelleLong, mutualise, objetMaquetteUuid);
  }
  ...
  public String toString() {
    ...
    sb.append("    objetMaquetteUuid: ").append(toIndentedString(objetMaquetteUuid)).append("\n");
    sb.append("}");
    return sb.toString();
  }
