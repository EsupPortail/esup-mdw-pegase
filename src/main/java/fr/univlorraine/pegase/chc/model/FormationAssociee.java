...
public class FormationAssociee {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormationAssociee.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FormationAssociee` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
