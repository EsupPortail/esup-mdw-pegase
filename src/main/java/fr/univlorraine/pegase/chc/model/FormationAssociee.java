...
/**
 * La formation associée à la composition
 */
...
public class FormationAssociee {
  ...
  public FormationAssociee() {
  }

  public FormationAssociee code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public FormationAssociee libelleCourt(@jakarta.annotation.Nonnull String libelleCourt) {
  ...
  public FormationAssociee libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
   ...
   * @return the FormationAssociee instance itself
   */
  public FormationAssociee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FormationAssociee formationAssociee = (FormationAssociee) o;
    return Objects.equals(this.code, formationAssociee.code) &&
        Objects.equals(this.libelleCourt, formationAssociee.libelleCourt) &&
        Objects.equals(this.libelleLong, formationAssociee.libelleLong)&&
        Objects.equals(this.additionalProperties, formationAssociee.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormationAssociee {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormationAssociee
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormationAssociee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FormationAssociee is not found in the empty JSON string", FormationAssociee.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FormationAssociee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormationAssociee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormationAssociee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormationAssociee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormationAssociee.class));

       return (TypeAdapter<T>) new TypeAdapter<FormationAssociee>() {
           @Override
           public void write(JsonWriter out, FormationAssociee value) throws IOException {
           ...
           @Override
           public FormationAssociee read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FormationAssociee instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FormationAssociee given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormationAssociee
   * @throws IOException if the JSON string is invalid with respect to FormationAssociee
   */
  public static FormationAssociee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormationAssociee.class);
  }

  /**
   * Convert an instance of FormationAssociee to an JSON string
   *
   * @return JSON string
   */
