...
public class InfoBrouillon {
  public static final String SERIALIZED_NAME_EST_BROUILLON_EXISTANT = "estBrouillonExistant";
  public static final String SERIALIZED_NAME_EST_UTILISATEUR_PROPRIETAIRE_BROUILLON = "estUtilisateurProprietaireBrouillon";
  @SerializedName(SERIALIZED_NAME_EST_BROUILLON_EXISTANT)
  private Boolean estBrouillonExistant;
  @SerializedName(SERIALIZED_NAME_EST_UTILISATEUR_PROPRIETAIRE_BROUILLON)
  private Boolean estUtilisateurProprietaireBrouillon;

  public InfoBrouillon() { 
  }

  public InfoBrouillon estBrouillonExistant(Boolean estBrouillonExistant) {
    
    this.estBrouillonExistant = estBrouillonExistant;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Indique si il existe un brouillon pour le cursus")
  ...
  public void setEstBrouillonExistant(Boolean estBrouillonExistant) {
    this.estBrouillonExistant = estBrouillonExistant;
  }


  public InfoBrouillon estUtilisateurProprietaireBrouillon(Boolean estUtilisateurProprietaireBrouillon) {
    
    this.estUtilisateurProprietaireBrouillon = estUtilisateurProprietaireBrouillon;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indique si l'utilisateur est le propriétaire du brouillon du cursus")
  ...
  public void setEstUtilisateurProprietaireBrouillon(Boolean estUtilisateurProprietaireBrouillon) {
    this.estUtilisateurProprietaireBrouillon = estUtilisateurProprietaireBrouillon;
  }
  ...
  public boolean equals(Object o) {
    ...
    InfoBrouillon infoBrouillon = (InfoBrouillon) o;
    return Objects.equals(this.estBrouillonExistant, infoBrouillon.estBrouillonExistant) &&
        Objects.equals(this.estUtilisateurProprietaireBrouillon, infoBrouillon.estUtilisateurProprietaireBrouillon);
  }

  @Override
  public int hashCode() {
    return Objects.hash(estBrouillonExistant, estUtilisateurProprietaireBrouillon);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InfoBrouillon {\n");
    sb.append("    estBrouillonExistant: ").append(toIndentedString(estBrouillonExistant)).append("\n");
    sb.append("    estUtilisateurProprietaireBrouillon: ").append(toIndentedString(estUtilisateurProprietaireBrouillon)).append("\n");
    sb.append("}");
    return sb.toString();
  }
