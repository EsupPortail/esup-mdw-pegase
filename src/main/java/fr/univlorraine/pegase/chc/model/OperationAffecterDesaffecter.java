...
public class OperationAffecterDesaffecter {
  ...
  public static final String SERIALIZED_NAME_UUID_APPRENANT = "uuidApprenant";
  public static final String SERIALIZED_NAME_CODE_GROUPE = "codeGroupe";
  @SerializedName(SERIALIZED_NAME_OP)
  private OpEnum op;
  @SerializedName(SERIALIZED_NAME_UUID_APPRENANT)
  private UUID uuidApprenant;
  @SerializedName(SERIALIZED_NAME_CODE_GROUPE)
  private String codeGroupe;
  public OperationAffecterDesaffecter() {
  }

  public OperationAffecterDesaffecter op(OpEnum op) {
  ...
  **/
  ...
  @ApiModelProperty(value = "opération à effectuer")
  ...
  public OperationAffecterDesaffecter uuidApprenant(UUID uuidApprenant) {

    this.uuidApprenant = uuidApprenant;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "identifiant unique de l'apprenant")

  public UUID getUuidApprenant() {
    return uuidApprenant;
  }

  public void setUuidApprenant(UUID uuidApprenant) {
    this.uuidApprenant = uuidApprenant;
  }

  public OperationAffecterDesaffecter codeGroupe(String codeGroupe) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "code du groupe dans lequel effectuer l'opération sur l'apprenant")
  ...
  public boolean equals(Object o) {
    ...
    OperationAffecterDesaffecter operationAffecterDesaffecter = (OperationAffecterDesaffecter) o;
    return Objects.equals(this.op, operationAffecterDesaffecter.op) &&
        Objects.equals(this.uuidApprenant, operationAffecterDesaffecter.uuidApprenant) &&
        Objects.equals(this.codeGroupe, operationAffecterDesaffecter.codeGroupe);
  }

  @Override
  public int hashCode() {
    return Objects.hash(op, uuidApprenant, codeGroupe);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OperationAffecterDesaffecter {\n");
    sb.append("    op: ").append(toIndentedString(op)).append("\n");
    sb.append("    uuidApprenant: ").append(toIndentedString(uuidApprenant)).append("\n");
