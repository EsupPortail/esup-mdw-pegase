...
/**
 * Les infos à afficher dans le document généré
 */
@ApiModel(description = "Les infos à afficher dans le document généré")
...
public class ElementsAAffiches {
  public static final String SERIALIZED_NAME_AFFICHER_SIGNATURE_RESPONSABLE = "afficherSignatureResponsable";
  public static final String SERIALIZED_NAME_AFFICHER_SIGNATURE_APPRENANT = "afficherSignatureApprenant";
  public static final String SERIALIZED_NAME_RESPONSABLE = "responsable";
  @SerializedName(SERIALIZED_NAME_AFFICHER_SIGNATURE_RESPONSABLE)
  private Boolean afficherSignatureResponsable = false;
  @SerializedName(SERIALIZED_NAME_AFFICHER_SIGNATURE_APPRENANT)
  private Boolean afficherSignatureApprenant = false;
  @SerializedName(SERIALIZED_NAME_RESPONSABLE)
  private String responsable;

  public ElementsAAffiches() { 
  }

  public ElementsAAffiches afficherSignatureResponsable(Boolean afficherSignatureResponsable) {
    
    this.afficherSignatureResponsable = afficherSignatureResponsable;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Est-ce qu'il faut afficher le champ signature du responsable ?")
  ...
  public void setAfficherSignatureResponsable(Boolean afficherSignatureResponsable) {
    this.afficherSignatureResponsable = afficherSignatureResponsable;
  }


  public ElementsAAffiches afficherSignatureApprenant(Boolean afficherSignatureApprenant) {
    
    this.afficherSignatureApprenant = afficherSignatureApprenant;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Est-ce qu'il faut afficher le champ signature de l'apprenant ?")
  ...
  public void setAfficherSignatureApprenant(Boolean afficherSignatureApprenant) {
    this.afficherSignatureApprenant = afficherSignatureApprenant;
  }


  public ElementsAAffiches responsable(String responsable) {
  ...
  **/
  ...
  @ApiModelProperty(value = "nom et prénom du responsable (saisie libre)")
  ...
  public boolean equals(Object o) {
    ...
    ElementsAAffiches elementsAAffiches = (ElementsAAffiches) o;
    return Objects.equals(this.afficherSignatureResponsable, elementsAAffiches.afficherSignatureResponsable) &&
        Objects.equals(this.afficherSignatureApprenant, elementsAAffiches.afficherSignatureApprenant) &&
        Objects.equals(this.responsable, elementsAAffiches.responsable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(afficherSignatureResponsable, afficherSignatureApprenant, responsable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ElementsAAffiches {\n");
    sb.append("    afficherSignatureResponsable: ").append(toIndentedString(afficherSignatureResponsable)).append("\n");
    sb.append("    afficherSignatureApprenant: ").append(toIndentedString(afficherSignatureApprenant)).append("\n");
