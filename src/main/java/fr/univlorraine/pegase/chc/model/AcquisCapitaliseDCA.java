...
public class AcquisCapitaliseDCA {
  ...
  public static final String SERIALIZED_NAME_AMENAGEMENTS_ACQUIS_UTILISABLE_DCA = "amenagementsAcquisUtilisableDca";
  ...
  @SerializedName(SERIALIZED_NAME_AMENAGEMENTS_ACQUIS_UTILISABLE_DCA)
  private List<String> amenagementsAcquisUtilisableDca = null;

  public AcquisCapitaliseDCA() { 
  }

  public AcquisCapitaliseDCA libelleAffichagePeriodeAcquisition(String libelleAffichagePeriodeAcquisition) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Code de la période à laquelle il y a eu l'acquisition")
  ...
  public void setLibelleAffichagePeriodeAcquisition(String libelleAffichagePeriodeAcquisition) {
    this.libelleAffichagePeriodeAcquisition = libelleAffichagePeriodeAcquisition;
  }


  public AcquisCapitaliseDCA codeObjetFormationAcquisition(String codeObjetFormationAcquisition) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L'objet sur lequel il y a eu l'acquisition (différent de l'objet du chemin dans le cas des LCC par exemple)")
  ...
  public AcquisCapitaliseDCA trouveViaLienCorrespondancePourCalcul(Boolean trouveViaLienCorrespondancePourCalcul) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Vrai si le code de l'OF acqui est different du code OM")
  ...
  public void setTrouveViaLienCorrespondancePourCalcul(Boolean trouveViaLienCorrespondancePourCalcul) {
    this.trouveViaLienCorrespondancePourCalcul = trouveViaLienCorrespondancePourCalcul;
  }


  public AcquisCapitaliseDCA noteFinale(String noteFinale) {
  ...
  **/
  ...
  public AcquisCapitaliseDCA bareme(Integer bareme) {
  ...
  **/
  ...
  public AcquisCapitaliseDCA libelleResultatFinal(String libelleResultatFinal) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le libellé long du résultat final")
  ...
  public void setLibelleResultatFinal(String libelleResultatFinal) {
    this.libelleResultatFinal = libelleResultatFinal;
  }


  public AcquisCapitaliseDCA amenagementsAcquisUtilisableDca(List<String> amenagementsAcquisUtilisableDca) {
    
    this.amenagementsAcquisUtilisableDca = amenagementsAcquisUtilisableDca;
    return this;
  }

  public AcquisCapitaliseDCA addAmenagementsAcquisUtilisableDcaItem(String amenagementsAcquisUtilisableDcaItem) {
    if (this.amenagementsAcquisUtilisableDca == null) {
      this.amenagementsAcquisUtilisableDca = new ArrayList<String>();
    }
    this.amenagementsAcquisUtilisableDca.add(amenagementsAcquisUtilisableDcaItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "les aménagements de l'acquis capitalisé")
  ...
  public void setAmenagementsAcquisUtilisableDca(List<String> amenagementsAcquisUtilisableDca) {
    this.amenagementsAcquisUtilisableDca = amenagementsAcquisUtilisableDca;
  }
  ...
  public boolean equals(Object o) {
    ...
    AcquisCapitaliseDCA acquisCapitaliseDCA = (AcquisCapitaliseDCA) o;
    return Objects.equals(this.libelleAffichagePeriodeAcquisition, acquisCapitaliseDCA.libelleAffichagePeriodeAcquisition) &&
        Objects.equals(this.codeObjetFormationAcquisition, acquisCapitaliseDCA.codeObjetFormationAcquisition) &&
        Objects.equals(this.trouveViaLienCorrespondancePourCalcul, acquisCapitaliseDCA.trouveViaLienCorrespondancePourCalcul) &&
        Objects.equals(this.noteFinale, acquisCapitaliseDCA.noteFinale) &&
        Objects.equals(this.bareme, acquisCapitaliseDCA.bareme) &&
        Objects.equals(this.libelleResultatFinal, acquisCapitaliseDCA.libelleResultatFinal) &&
        Objects.equals(this.amenagementsAcquisUtilisableDca, acquisCapitaliseDCA.amenagementsAcquisUtilisableDca);
  }

  @Override
  public int hashCode() {
    return Objects.hash(libelleAffichagePeriodeAcquisition, codeObjetFormationAcquisition, trouveViaLienCorrespondancePourCalcul, noteFinale, bareme, libelleResultatFinal, amenagementsAcquisUtilisableDca);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AcquisCapitaliseDCA {\n");
    ...
    sb.append("    amenagementsAcquisUtilisableDca: ").append(toIndentedString(amenagementsAcquisUtilisableDca)).append("\n");
    sb.append("}");
    return sb.toString();
  }
