...
import fr.univlorraine.pegase.chc.model.ElementsAAffiches;
...
public class ParametresEditionListeContratEtudesRecapitulatifAutre {
  public static final String SERIALIZED_NAME_TITRE_DOCUMENT = "titreDocument";
  public static final String SERIALIZED_NAME_PREVISUALISATION = "previsualisation";
  public static final String SERIALIZED_NAME_ELEMENTS_A_AFFICHES = "elementsAAffiches";
  public static final String SERIALIZED_NAME_LISTE_ID_CURSUS = "listeIdCursus";
  @SerializedName(SERIALIZED_NAME_TITRE_DOCUMENT)
  private String titreDocument;
  @SerializedName(SERIALIZED_NAME_PREVISUALISATION)
  private Boolean previsualisation;
  @SerializedName(SERIALIZED_NAME_ELEMENTS_A_AFFICHES)
  private ElementsAAffiches elementsAAffiches;
  @SerializedName(SERIALIZED_NAME_LISTE_ID_CURSUS)
  private List<UUID> listeIdCursus = null;
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "titre du document")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "est-ce une demande de prévisualisation du document ?")
  ...
  **/
  ...
  public ParametresEditionListeContratEtudesRecapitulatifAutre addListeIdCursusItem(UUID listeIdCursusItem) {
    if (this.listeIdCursus == null) {
      this.listeIdCursus = new ArrayList<UUID>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"e327bb5a-83a9-4b04-921d-eaaca8f64345\",\"5831effb-3570-4692-a63d-e1d88c56b289\",\"72532bd4-ec5e-479f-b16e-416e93efe478\"]", value = "la liste des cursus sur ayant les choix pedagogiques du contrat à éditer")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(titreDocument, previsualisation, elementsAAffiches, listeIdCursus);
  }
