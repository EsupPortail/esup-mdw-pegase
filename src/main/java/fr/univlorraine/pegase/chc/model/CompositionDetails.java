...
import fr.univlorraine.pegase.chc.model.FormationCompositionDetails;
import fr.univlorraine.pegase.chc.model.GroupeDetails;
import fr.univlorraine.pegase.chc.model.ObjetFormationCompositionDetails;
...
public class CompositionDetails {
  ...
  private List<GroupeDetails> listeGroupes = null;
  @SerializedName(SERIALIZED_NAME_LISTE_OBJETS_FORMATION)
  private List<ObjetFormationCompositionDetails> listeObjetsFormation = null;
  @SerializedName(SERIALIZED_NAME_LISTE_FORMATIONS)
  private List<FormationCompositionDetails> listeFormations = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "158c9998-18da-4bef-a8db-4891b1736574", value = "L'identifiant technique de la composition")
  ...
  **/
  ...
  public CompositionDetails addListeGroupesItem(GroupeDetails listeGroupesItem) {
    if (this.listeGroupes == null) {
      this.listeGroupes = new ArrayList<GroupeDetails>();
    }
  ...
  **/
  ...
  public CompositionDetails addListeObjetsFormationItem(ObjetFormationCompositionDetails listeObjetsFormationItem) {
    if (this.listeObjetsFormation == null) {
      this.listeObjetsFormation = new ArrayList<ObjetFormationCompositionDetails>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "liste des associations de cette composition dans les objets de formation")
  ...
  public CompositionDetails addListeFormationsItem(FormationCompositionDetails listeFormationsItem) {
    if (this.listeFormations == null) {
      this.listeFormations = new ArrayList<FormationCompositionDetails>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "liste des associations de cette composition aux formations")
