...
public class ObjetFormationPourext {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, typeObjetFormation, caractereObligatoire, capaciteAccueil, chemin);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjetFormationPourext.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ObjetFormationPourext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
