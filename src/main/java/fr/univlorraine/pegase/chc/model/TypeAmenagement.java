...
public class TypeAmenagement {
  ...
  public TypeAmenagement code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public TypeAmenagement libelleAffichage(@jakarta.annotation.Nullable String libelleAffichage) {
    this.libelleAffichage = libelleAffichage;
    return this;
  }

  /**
   * Le libellé affichage du type d&#39;aménagament
  ...
  public TypeAmenagement motif(@jakarta.annotation.Nullable String motif) {
    this.motif = motif;
    return this;
  }

  /**
   * Le motif de type aménagament
   * @return motif
   */
  @jakarta.annotation.Nullable
  ...
  public void setMotif(@jakarta.annotation.Nullable String motif) {
    this.motif = motif;
  }


  public TypeAmenagement priseEnCompte(@jakarta.annotation.Nonnull String priseEnCompte) {
  ...
  public void setPriseEnCompte(@jakarta.annotation.Nonnull String priseEnCompte) {
    this.priseEnCompte = priseEnCompte;
  }
   ...
   * @return the TypeAmenagement instance itself
   */
  public TypeAmenagement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, typeAmenagement.code) &&
        ...
        Objects.equals(this.additionalProperties, typeAmenagement.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleAffichage, motif, priseEnCompte, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "libelleAffichage", "motif", "priseEnCompte"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "priseEnCompte"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypeAmenagement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeAmenagement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TypeAmenagement is not found in the empty JSON string", TypeAmenagement.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TypeAmenagement.openapiRequiredFields) {
      ...
      if ((jsonObj.get("libelleAffichage") != null && !jsonObj.get("libelleAffichage").isJsonNull()) && !jsonObj.get("libelleAffichage").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("motif") != null && !jsonObj.get("motif").isJsonNull()) && !jsonObj.get("motif").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `motif` to be a primitive type in the JSON string but got `%s`", jsonObj.get("motif").toString()));
      }
      if (!jsonObj.get("priseEnCompte").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `priseEnCompte` to be a primitive type in the JSON string but got `%s`", jsonObj.get("priseEnCompte").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypeAmenagement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypeAmenagement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypeAmenagement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypeAmenagement.class));

       return (TypeAdapter<T>) new TypeAdapter<TypeAmenagement>() {
           @Override
           public void write(JsonWriter out, TypeAmenagement value) throws IOException {
           ...
           @Override
           public TypeAmenagement read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TypeAmenagement instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TypeAmenagement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypeAmenagement
   * @throws IOException if the JSON string is invalid with respect to TypeAmenagement
   */
  public static TypeAmenagement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypeAmenagement.class);
  }

  /**
   * Convert an instance of TypeAmenagement to an JSON string
   *
   * @return JSON string
   */
