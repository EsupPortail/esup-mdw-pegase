...
public class TypeAmenagement {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleAffichage, motif, priseEnCompte);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypeAmenagement.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TypeAmenagement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
