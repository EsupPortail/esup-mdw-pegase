...
public class AcquisCapitalise {
  ...
  public AcquisCapitalise libelleResultatFinal(@jakarta.annotation.Nullable String libelleResultatFinal) {
  ...
  public void setLibelleResultatFinal(@jakarta.annotation.Nullable String libelleResultatFinal) {
    this.libelleResultatFinal = libelleResultatFinal;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("libelleAffichagePeriodeAcquisition", "codeObjetFormationAcquisition", "trouveViaLienCorrespondancePourCalcul"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcquisCapitalise.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AcquisCapitalise` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
      ...
      if ((jsonObj.get("libelleResultatFinal") != null && !jsonObj.get("libelleResultatFinal").isJsonNull()) && !jsonObj.get("libelleResultatFinal").isJsonPrimitive()) {
