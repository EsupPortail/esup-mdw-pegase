...
import fr.univlorraine.pegase.chc.model.Compositions;
...
public class PagedComposition {
  ...
  private List<CompositionPourListe> items = null;
  ...
  public PagedComposition() { 
  }

  public PagedComposition items(List<CompositionPourListe> items) {
    
    this.items = items;
    return this;
  }

  public PagedComposition addItemsItem(CompositionPourListe itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CompositionPourListe>();
    }
  ...
  **/
  ...
  public List<CompositionPourListe> getItems() {
    return items;
  }


  public void setItems(List<CompositionPourListe> items) {
    this.items = items;
  }


  public PagedComposition totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedComposition totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedComposition taille(Integer taille) {
  ...
  **/
  ...
  public PagedComposition page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedComposition pagedComposition = (PagedComposition) o;
    return Objects.equals(this.items, pagedComposition.items) &&
        Objects.equals(this.totalElements, pagedComposition.totalElements) &&
        Objects.equals(this.totalPages, pagedComposition.totalPages) &&
        Objects.equals(this.taille, pagedComposition.taille) &&
        Objects.equals(this.page, pagedComposition.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedComposition {\n");
