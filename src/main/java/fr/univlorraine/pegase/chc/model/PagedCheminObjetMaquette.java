...
import fr.univlorraine.pegase.chc.model.CheminObjetMaquette;
import fr.univlorraine.pegase.chc.model.CheminObjetMaquettes;
...
public class PagedCheminObjetMaquette {
  ...
  private List<CheminObjetMaquette> items = null;
  ...
  public PagedCheminObjetMaquette() { 
  }

  public PagedCheminObjetMaquette items(List<CheminObjetMaquette> items) {
    
    this.items = items;
    return this;
  }

  public PagedCheminObjetMaquette addItemsItem(CheminObjetMaquette itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<CheminObjetMaquette>();
    }
  ...
  **/
  ...
  public List<CheminObjetMaquette> getItems() {
    return items;
  }


  public void setItems(List<CheminObjetMaquette> items) {
    this.items = items;
  }


  public PagedCheminObjetMaquette totalElements(Long totalElements) {
  ...
  **/
  ...
  public PagedCheminObjetMaquette totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedCheminObjetMaquette taille(Integer taille) {
  ...
  **/
  ...
  public PagedCheminObjetMaquette page(Integer page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedCheminObjetMaquette pagedCheminObjetMaquette = (PagedCheminObjetMaquette) o;
    return Objects.equals(this.items, pagedCheminObjetMaquette.items) &&
        Objects.equals(this.totalElements, pagedCheminObjetMaquette.totalElements) &&
        Objects.equals(this.totalPages, pagedCheminObjetMaquette.totalPages) &&
        Objects.equals(this.taille, pagedCheminObjetMaquette.taille) &&
        Objects.equals(this.page, pagedCheminObjetMaquette.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedCheminObjetMaquette {\n");
