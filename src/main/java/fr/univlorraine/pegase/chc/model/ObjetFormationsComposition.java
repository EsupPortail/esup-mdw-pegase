...
public class ObjetFormationsComposition {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ObjetFormationComposition> items = null;

  public ObjetFormationsComposition() { 
  }

  public ObjetFormationsComposition items(List<ObjetFormationComposition> items) {
    
    this.items = items;
    return this;
  }

  public ObjetFormationsComposition addItemsItem(ObjetFormationComposition itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObjetFormationsComposition objetFormationsComposition = (ObjetFormationsComposition) o;
    return Objects.equals(this.items, objetFormationsComposition.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjetFormationsComposition {\n");
