...
/**
 * Les informations de la formation de composition
 */
@ApiModel(description = "Les informations de la formation de composition")
...
public class InfoFormationComposition {
  ...
  public InfoFormationComposition() { 
  }

  public InfoFormationComposition code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Le code de la formation de composition")
  ...
  public InfoFormationComposition libelle(String libelle) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le libelle de la formation de composition")
  ...
  public boolean equals(Object o) {
    ...
    InfoFormationComposition infoFormationComposition = (InfoFormationComposition) o;
    return Objects.equals(this.code, infoFormationComposition.code) &&
        Objects.equals(this.libelle, infoFormationComposition.libelle);
  }
  ...
  public String toString() {
    ...
    sb.append("class InfoFormationComposition {\n");
