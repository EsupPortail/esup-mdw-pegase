...
public class IdCalendrier {
  public static final String SERIALIZED_NAME_UUID_CALENDRIER = "uuidCalendrier";
  @SerializedName(SERIALIZED_NAME_UUID_CALENDRIER)
  private UUID uuidCalendrier;

  public IdCalendrier() { 
  }

  public IdCalendrier uuidCalendrier(UUID uuidCalendrier) {
    
    this.uuidCalendrier = uuidCalendrier;
    return this;
  }

   /**
   * identifiant technique du calendrier
   * @return uuidCalendrier
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "identifiant technique du calendrier")

  public UUID getUuidCalendrier() {
    return uuidCalendrier;
  }


  public void setUuidCalendrier(UUID uuidCalendrier) {
    this.uuidCalendrier = uuidCalendrier;
  }
  ...
  public boolean equals(Object o) {
    ...
    IdCalendrier idCalendrier = (IdCalendrier) o;
    return Objects.equals(this.uuidCalendrier, idCalendrier.uuidCalendrier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuidCalendrier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdCalendrier {\n");
    sb.append("    uuidCalendrier: ").append(toIndentedString(uuidCalendrier)).append("\n");
    sb.append("}");
    return sb.toString();
  }
