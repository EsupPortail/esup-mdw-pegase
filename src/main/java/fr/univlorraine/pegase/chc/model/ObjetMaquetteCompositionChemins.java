...
/**
 * ObjetMaquetteCompositionChemins
 */
...
public class ObjetMaquetteCompositionChemins {
  public static final String SERIALIZED_NAME_CHEMIN_OBJET_MAQUETTE_UUID = "cheminObjetMaquetteUuid";
  ...
  @SerializedName(SERIALIZED_NAME_CHEMIN_OBJET_MAQUETTE_UUID)
  private UUID cheminObjetMaquetteUuid;
  @SerializedName(SERIALIZED_NAME_CODE_CHEMIN)
  private String codeChemin;
  @SerializedName(SERIALIZED_NAME_FORMATION)
  private Formation formation;

  public ObjetMaquetteCompositionChemins() { 
  }

  public ObjetMaquetteCompositionChemins cheminObjetMaquetteUuid(UUID cheminObjetMaquetteUuid) {
    
    this.cheminObjetMaquetteUuid = cheminObjetMaquetteUuid;
    return this;
  }

   /**
   * L&#39;identifiant technique du chemin objet maquette
   * @return cheminObjetMaquetteUuid
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L'identifiant technique du chemin objet maquette")

  public UUID getCheminObjetMaquetteUuid() {
    return cheminObjetMaquetteUuid;
  }


  public void setCheminObjetMaquetteUuid(UUID cheminObjetMaquetteUuid) {
    this.cheminObjetMaquetteUuid = cheminObjetMaquetteUuid;
  }


  public ObjetMaquetteCompositionChemins codeChemin(String codeChemin) {
   ...
   /**
   * chemin de cet ObjetFormation (ou Formation)
   * @return codeChemin
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "chemin de cet ObjetFormation (ou Formation)")
  ...
  public ObjetMaquetteCompositionChemins formation(Formation formation) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObjetMaquetteCompositionChemins objetMaquetteCompositionChemins = (ObjetMaquetteCompositionChemins) o;
    return Objects.equals(this.cheminObjetMaquetteUuid, objetMaquetteCompositionChemins.cheminObjetMaquetteUuid) &&
        Objects.equals(this.codeChemin, objetMaquetteCompositionChemins.codeChemin) &&
        Objects.equals(this.formation, objetMaquetteCompositionChemins.formation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cheminObjetMaquetteUuid, codeChemin, formation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjetMaquetteCompositionChemins {\n");
    sb.append("    cheminObjetMaquetteUuid: ").append(toIndentedString(cheminObjetMaquetteUuid)).append("\n");
