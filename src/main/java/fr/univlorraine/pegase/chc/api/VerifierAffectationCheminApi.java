...
public class VerifierAffectationCheminApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public VerifierAffectationCheminApi() {
        this(Configuration.getDefaultApiClient());
    }

    public VerifierAffectationCheminApi(ApiClient apiClient) {
    ...
    /**
     * Build call for verifierAffectationChemin
     * @param uuidChemin L&#39;uuid du chemin a vérifier (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Valeur booléenne, faux si il y a aucun choix sur le chemin, vrai si il existe un choix sur le chemin </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Si aucun chemin n&#39;a été trouvé pour l&#39;uuid spécifié ou si l&#39;uuid est au mauvais format. </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call verifierAffectationCheminCall(String uuidChemin, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/verifier-affectation-chemin/{uuidChemin}"
    ...
    private okhttp3.Call verifierAffectationCheminValidateBeforeCall(String uuidChemin, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidChemin' is set
        if (uuidChemin == null) {
            throw new ApiException("Missing the required parameter 'uuidChemin' when calling verifierAffectationChemin(Async)");
        }
        

        okhttp3.Call localVarCall = verifierAffectationCheminCall(uuidChemin, _callback);
        return localVarCall;

    }

    /**
     * Vérifier l&#39;existance de choix sur un chemin quelque soit le cursus
     * 
     * @param uuidChemin L&#39;uuid du chemin a vérifier (required)
     * @return Boolean
     ...
     */
    public Boolean verifierAffectationChemin(String uuidChemin) throws ApiException {
        ApiResponse<Boolean> localVarResp = verifierAffectationCheminWithHttpInfo(uuidChemin);
     ...
     */
    public ApiResponse<Boolean> verifierAffectationCheminWithHttpInfo(String uuidChemin) throws ApiException {
        okhttp3.Call localVarCall = verifierAffectationCheminValidateBeforeCall(uuidChemin, null);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Vérifier l&#39;existance de choix sur un chemin quelque soit le cursus (asynchronously)
     * 
     * @param uuidChemin L&#39;uuid du chemin a vérifier (required)
     ...
     */
    public okhttp3.Call verifierAffectationCheminAsync(String uuidChemin, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifierAffectationCheminValidateBeforeCall(uuidChemin, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for verifierAffectationCheminPourApprenant
     * @param uuidChemin L&#39;uuid chemin a vérifier (required)
     * @param codeApprenant Le code de l&#39;apprenant à vérifier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Valeur booléenne, faux si il y a aucun choix pour l&#39;apprenant sur le chemin, vrai si il existe un choix sur le chemin </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Si aucun chemin n&#39;a été trouvé pour l&#39;uuid spécifié ou si l&#39;apprenant n&#39;est pas trouvé </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Si l&#39;utilisateur n&#39;est pas authentifié. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Si l&#39;utilisateur n&#39;a pas les droits de vérification. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call verifierAffectationCheminPourApprenantCall(String uuidChemin, String codeApprenant, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/verifier-affectation-chemin/{uuidChemin}/{codeApprenant}"
            .replaceAll("\\{" + "uuidChemin" + "\\}", localVarApiClient.escapeString(uuidChemin.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifierAffectationCheminPourApprenantValidateBeforeCall(String uuidChemin, String codeApprenant, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidChemin' is set
        if (uuidChemin == null) {
            throw new ApiException("Missing the required parameter 'uuidChemin' when calling verifierAffectationCheminPourApprenant(Async)");
        }
        
        // verify the required parameter 'codeApprenant' is set
        if (codeApprenant == null) {
            throw new ApiException("Missing the required parameter 'codeApprenant' when calling verifierAffectationCheminPourApprenant(Async)");
        }
        

        okhttp3.Call localVarCall = verifierAffectationCheminPourApprenantCall(uuidChemin, codeApprenant, _callback);
        return localVarCall;

    }

    /**
     * Vérifier l&#39;existance de choix sur un chemin pour les cursus de l&#39;apprenant
     * 
     * @param uuidChemin L&#39;uuid chemin a vérifier (required)
     * @param codeApprenant Le code de l&#39;apprenant à vérifier (required)
     * @return Boolean
     ...
     */
    public Boolean verifierAffectationCheminPourApprenant(String uuidChemin, String codeApprenant) throws ApiException {
        ApiResponse<Boolean> localVarResp = verifierAffectationCheminPourApprenantWithHttpInfo(uuidChemin, codeApprenant);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Boolean> verifierAffectationCheminPourApprenantWithHttpInfo(String uuidChemin, String codeApprenant) throws ApiException {
        okhttp3.Call localVarCall = verifierAffectationCheminPourApprenantValidateBeforeCall(uuidChemin, codeApprenant, null);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Vérifier l&#39;existance de choix sur un chemin pour les cursus de l&#39;apprenant (asynchronously)
     * 
     * @param uuidChemin L&#39;uuid chemin a vérifier (required)
     * @param codeApprenant Le code de l&#39;apprenant à vérifier (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call verifierAffectationCheminPourApprenantAsync(String uuidChemin, String codeApprenant, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifierAffectationCheminPourApprenantValidateBeforeCall(uuidChemin, codeApprenant, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
