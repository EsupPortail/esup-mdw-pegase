...
import fr.univlorraine.pegase.chc.model.CalendrierCreeRequest;
import fr.univlorraine.pegase.chc.model.CalendrierModifieRequest;
import fr.univlorraine.pegase.chc.model.CalendrierResponse;
import fr.univlorraine.pegase.chc.model.CustomPageable;
import java.util.Date;
import fr.univlorraine.pegase.chc.model.PagedCalendrier;
...
public class CalendrierApi {
    ...
    public CalendrierApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CalendrierApi(ApiClient apiClient) {
    ...
    /**
     * Build call for creerCalendrier
     * @param uuidPeriode  (required)
     * @param calendrierCreeRequest  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Calendrier créé avec succès </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Requête invalide (erreur de validation ou données manquantes) </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Erreur interne du serveur </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call creerCalendrierCall(UUID uuidPeriode, CalendrierCreeRequest calendrierCreeRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = calendrierCreeRequest;

        // create path and map variables
        String localVarPath = "/periodes/{uuidPeriode}/calendriers"
            .replaceAll("\\{" + "uuidPeriode" + "\\}", localVarApiClient.escapeString(uuidPeriode.toString()));
    ...
    private okhttp3.Call creerCalendrierValidateBeforeCall(UUID uuidPeriode, CalendrierCreeRequest calendrierCreeRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidPeriode' is set
        if (uuidPeriode == null) {
            throw new ApiException("Missing the required parameter 'uuidPeriode' when calling creerCalendrier(Async)");
        }
        
        // verify the required parameter 'calendrierCreeRequest' is set
        if (calendrierCreeRequest == null) {
            throw new ApiException("Missing the required parameter 'calendrierCreeRequest' when calling creerCalendrier(Async)");
        }
        

        okhttp3.Call localVarCall = creerCalendrierCall(uuidPeriode, calendrierCreeRequest, _callback);
        return localVarCall;

    }

    /**
     * Création d&#39;un nouveau calendrier pour une période spécifique
     * Crée un nouveau calendrier sur la période spécifiée.
     * @param uuidPeriode  (required)
     * @param calendrierCreeRequest  (required)
     * @return CalendrierResponse
     ...
     */
    public CalendrierResponse creerCalendrier(UUID uuidPeriode, CalendrierCreeRequest calendrierCreeRequest) throws ApiException {
        ApiResponse<CalendrierResponse> localVarResp = creerCalendrierWithHttpInfo(uuidPeriode, calendrierCreeRequest);
     ...
     * @param uuidPeriode  (required)
     * @param calendrierCreeRequest  (required)
     * @return ApiResponse&lt;CalendrierResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CalendrierResponse> creerCalendrierWithHttpInfo(UUID uuidPeriode, CalendrierCreeRequest calendrierCreeRequest) throws ApiException {
        okhttp3.Call localVarCall = creerCalendrierValidateBeforeCall(uuidPeriode, calendrierCreeRequest, null);
        Type localVarReturnType = new TypeToken<CalendrierResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Création d&#39;un nouveau calendrier pour une période spécifique (asynchronously)
     * Crée un nouveau calendrier sur la période spécifiée.
     * @param uuidPeriode  (required)
     * @param calendrierCreeRequest  (required)
     ...
     */
    public okhttp3.Call creerCalendrierAsync(UUID uuidPeriode, CalendrierCreeRequest calendrierCreeRequest, final ApiCallback<CalendrierResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = creerCalendrierValidateBeforeCall(uuidPeriode, calendrierCreeRequest, _callback);
        Type localVarReturnType = new TypeToken<CalendrierResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for modifierCalendrier
     * @param uuidCalendrier L&#39;identifiant technique du calendrier (required)
     * @param calendrierModifieRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Calendrier modifié avec succès </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Requête invalide (erreur de validation ou données manquantes) </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Erreur interne du serveur </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call modifierCalendrierCall(UUID uuidCalendrier, CalendrierModifieRequest calendrierModifieRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        Object localVarPostBody = calendrierModifieRequest;

        // create path and map variables
        String localVarPath = "/calendrier/{uuidCalendrier}"
            .replaceAll("\\{" + "uuidCalendrier" + "\\}", localVarApiClient.escapeString(uuidCalendrier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call modifierCalendrierValidateBeforeCall(UUID uuidCalendrier, CalendrierModifieRequest calendrierModifieRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidCalendrier' is set
        if (uuidCalendrier == null) {
            throw new ApiException("Missing the required parameter 'uuidCalendrier' when calling modifierCalendrier(Async)");
        }
        
        // verify the required parameter 'calendrierModifieRequest' is set
        if (calendrierModifieRequest == null) {
            throw new ApiException("Missing the required parameter 'calendrierModifieRequest' when calling modifierCalendrier(Async)");
        }
        

        okhttp3.Call localVarCall = modifierCalendrierCall(uuidCalendrier, calendrierModifieRequest, _callback);
        return localVarCall;
     ...
     */
    public CalendrierResponse modifierCalendrier(UUID uuidCalendrier, CalendrierModifieRequest calendrierModifieRequest) throws ApiException {
        ApiResponse<CalendrierResponse> localVarResp = modifierCalendrierWithHttpInfo(uuidCalendrier, calendrierModifieRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CalendrierResponse> modifierCalendrierWithHttpInfo(UUID uuidCalendrier, CalendrierModifieRequest calendrierModifieRequest) throws ApiException {
        okhttp3.Call localVarCall = modifierCalendrierValidateBeforeCall(uuidCalendrier, calendrierModifieRequest, null);
        Type localVarReturnType = new TypeToken<CalendrierResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Modification d&#39;un calendrier (asynchronously)
     * Modifier un calendrier
     * @param uuidCalendrier L&#39;identifiant technique du calendrier (required)
     * @param calendrierModifieRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call modifierCalendrierAsync(UUID uuidCalendrier, CalendrierModifieRequest calendrierModifieRequest, final ApiCallback<CalendrierResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = modifierCalendrierValidateBeforeCall(uuidCalendrier, calendrierModifieRequest, _callback);
        Type localVarReturnType = new TypeToken<CalendrierResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for rechercherCalendriers
     * @param uuidPeriode  (required)
     * @param pageable Les tris possibles sont :         * code         * libelleCourt         * date         * active (optional)
     * @param codeOuLibelle Le code ou le libellé du calendrier (optional)
     * @param date La date de recherche des calendriers valides (optional)
     * @param active L&#39;état du temoin (active/inactive) (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> La liste des calendriers </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call rechercherCalendriersCall(UUID uuidPeriode, CustomPageable pageable, String codeOuLibelle, Date date, Boolean active, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rechercherCalendriersValidateBeforeCall(UUID uuidPeriode, CustomPageable pageable, String codeOuLibelle, Date date, Boolean active, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidPeriode' is set
        if (uuidPeriode == null) {
            throw new ApiException("Missing the required parameter 'uuidPeriode' when calling rechercherCalendriers(Async)");
        }
        

        okhttp3.Call localVarCall = rechercherCalendriersCall(uuidPeriode, pageable, codeOuLibelle, date, active, _callback);
        return localVarCall;

    }

    /**
     * Rechercher les calendriers correspondants aux critères
     * 
     * @param uuidPeriode  (required)
     * @param pageable Les tris possibles sont :         * code         * libelleCourt         * date         * active (optional)
     * @param codeOuLibelle Le code ou le libellé du calendrier (optional)
     ...
     */
    public PagedCalendrier rechercherCalendriers(UUID uuidPeriode, CustomPageable pageable, String codeOuLibelle, Date date, Boolean active) throws ApiException {
        ApiResponse<PagedCalendrier> localVarResp = rechercherCalendriersWithHttpInfo(uuidPeriode, pageable, codeOuLibelle, date, active);
        return localVarResp.getData();
    }
     ...
     * @param date La date de recherche des calendriers valides (optional)
     * @param active L&#39;état du temoin (active/inactive) (optional)
     * @return ApiResponse&lt;PagedCalendrier&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedCalendrier> rechercherCalendriersWithHttpInfo(UUID uuidPeriode, CustomPageable pageable, String codeOuLibelle, Date date, Boolean active) throws ApiException {
        okhttp3.Call localVarCall = rechercherCalendriersValidateBeforeCall(uuidPeriode, pageable, codeOuLibelle, date, active, null);
        Type localVarReturnType = new TypeToken<PagedCalendrier>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Rechercher les calendriers correspondants aux critères (asynchronously)
     * 
     * @param uuidPeriode  (required)
     * @param pageable Les tris possibles sont :         * code         * libelleCourt         * date         * active (optional)
     * @param codeOuLibelle Le code ou le libellé du calendrier (optional)
     ...
     */
    public okhttp3.Call rechercherCalendriersAsync(UUID uuidPeriode, CustomPageable pageable, String codeOuLibelle, Date date, Boolean active, final ApiCallback<PagedCalendrier> _callback) throws ApiException {

        okhttp3.Call localVarCall = rechercherCalendriersValidateBeforeCall(uuidPeriode, pageable, codeOuLibelle, date, active, _callback);
        Type localVarReturnType = new TypeToken<PagedCalendrier>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for supprimerCalendrier
     * @param uuidCalendrier L&#39;UUID du calendrier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Calendrier supprimé </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Suppression du calendrier impossible, supprimer les associations préalablement </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> calendrier non trouvé </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call supprimerCalendrierCall(UUID uuidCalendrier, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call supprimerCalendrierValidateBeforeCall(UUID uuidCalendrier, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuidCalendrier' is set
        if (uuidCalendrier == null) {
            throw new ApiException("Missing the required parameter 'uuidCalendrier' when calling supprimerCalendrier(Async)");
        }
        

        okhttp3.Call localVarCall = supprimerCalendrierCall(uuidCalendrier, _callback);
        return localVarCall;
     ...
     */
    public void supprimerCalendrier(UUID uuidCalendrier) throws ApiException {
        supprimerCalendrierWithHttpInfo(uuidCalendrier);
    }
     ...
     */
    public ApiResponse<Void> supprimerCalendrierWithHttpInfo(UUID uuidCalendrier) throws ApiException {
        okhttp3.Call localVarCall = supprimerCalendrierValidateBeforeCall(uuidCalendrier, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Supprimer un calendrier (asynchronously)
     * Supprimer un calendrier
     * @param uuidCalendrier L&#39;UUID du calendrier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call supprimerCalendrierAsync(UUID uuidCalendrier, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = supprimerCalendrierValidateBeforeCall(uuidCalendrier, _callback);
