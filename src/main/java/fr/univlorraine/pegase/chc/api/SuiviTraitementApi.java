...
import java.io.File;
import fr.univlorraine.pegase.chc.model.PagedAffectationMasseBatch;
...
public class SuiviTraitementApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SuiviTraitementApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SuiviTraitementApi(ApiClient apiClient) {
    ...
    /**
     * Build call for recupererCsvSuiviTraitement
     * @param identifiantBatch L&#39;identifiant du batch dont on souhaite le détail (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Identifiant batch manquant </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Vous n&#39;avez pas accès au chemin demandé </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Ressource non trouvée </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call recupererCsvSuiviTraitementCall(String identifiantBatch, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/suivi-traitement/choix-pedagogique-via-chemin/{identifiantBatch}/csv"
            .replaceAll("\\{" + "identifiantBatch" + "\\}", localVarApiClient.escapeString(identifiantBatch.toString()));
    ...
    private okhttp3.Call recupererCsvSuiviTraitementValidateBeforeCall(String identifiantBatch, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'identifiantBatch' is set
        if (identifiantBatch == null) {
            throw new ApiException("Missing the required parameter 'identifiantBatch' when calling recupererCsvSuiviTraitement(Async)");
        }
        

        okhttp3.Call localVarCall = recupererCsvSuiviTraitementCall(identifiantBatch, _callback);
        return localVarCall;

    }

    /**
     * Recupère un fichier csv traçant les traitements effectués par le batch.
     * 
     * @param identifiantBatch L&#39;identifiant du batch dont on souhaite le détail (required)
     * @return File
     ...
     */
    public File recupererCsvSuiviTraitement(String identifiantBatch) throws ApiException {
        ApiResponse<File> localVarResp = recupererCsvSuiviTraitementWithHttpInfo(identifiantBatch);
     ...
     */
    public ApiResponse<File> recupererCsvSuiviTraitementWithHttpInfo(String identifiantBatch) throws ApiException {
        okhttp3.Call localVarCall = recupererCsvSuiviTraitementValidateBeforeCall(identifiantBatch, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Recupère un fichier csv traçant les traitements effectués par le batch. (asynchronously)
     * 
     * @param identifiantBatch L&#39;identifiant du batch dont on souhaite le détail (required)
     ...
     */
    public okhttp3.Call recupererCsvSuiviTraitementAsync(String identifiantBatch, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = recupererCsvSuiviTraitementValidateBeforeCall(identifiantBatch, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for traitementsAffectationMasseBatchResulat
     * @param periodeUuid L&#39;identifiant technique du de la période (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Les traitements batch des affectation/désaffectation en masse </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call traitementsAffectationMasseBatchResulatCall(UUID periodeUuid, CustomPageable pageable, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/suivi-traitement/choix-pedagogique-via-chemin/periode/{periodeUuid}"
            .replaceAll("\\{" + "periodeUuid" + "\\}", localVarApiClient.escapeString(periodeUuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call traitementsAffectationMasseBatchResulatValidateBeforeCall(UUID periodeUuid, CustomPageable pageable, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'periodeUuid' is set
        if (periodeUuid == null) {
            throw new ApiException("Missing the required parameter 'periodeUuid' when calling traitementsAffectationMasseBatchResulat(Async)");
        }
        

        okhttp3.Call localVarCall = traitementsAffectationMasseBatchResulatCall(periodeUuid, pageable, _callback);
        return localVarCall;

    }

    /**
     * résultats des traitement de l&#39;affectation/désaffectation en masse batch
     * 
     * @param periodeUuid L&#39;identifiant technique du de la période (required)
     * @param pageable  (optional)
     * @return PagedAffectationMasseBatch
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public PagedAffectationMasseBatch traitementsAffectationMasseBatchResulat(UUID periodeUuid, CustomPageable pageable) throws ApiException {
        ApiResponse<PagedAffectationMasseBatch> localVarResp = traitementsAffectationMasseBatchResulatWithHttpInfo(periodeUuid, pageable);
        return localVarResp.getData();
    }
     ...
     * @param periodeUuid L&#39;identifiant technique du de la période (required)
     * @param pageable  (optional)
     * @return ApiResponse&lt;PagedAffectationMasseBatch&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedAffectationMasseBatch> traitementsAffectationMasseBatchResulatWithHttpInfo(UUID periodeUuid, CustomPageable pageable) throws ApiException {
        okhttp3.Call localVarCall = traitementsAffectationMasseBatchResulatValidateBeforeCall(periodeUuid, pageable, null);
        Type localVarReturnType = new TypeToken<PagedAffectationMasseBatch>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * résultats des traitement de l&#39;affectation/désaffectation en masse batch (asynchronously)
     * 
     * @param periodeUuid L&#39;identifiant technique du de la période (required)
     * @param pageable  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call traitementsAffectationMasseBatchResulatAsync(UUID periodeUuid, CustomPageable pageable, final ApiCallback<PagedAffectationMasseBatch> _callback) throws ApiException {

        okhttp3.Call localVarCall = traitementsAffectationMasseBatchResulatValidateBeforeCall(periodeUuid, pageable, _callback);
        Type localVarReturnType = new TypeToken<PagedAffectationMasseBatch>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
