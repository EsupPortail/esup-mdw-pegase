...
import java.io.File;
import fr.univlorraine.pegase.chc.model.ParametresEditionListeAppelEmargement;
import fr.univlorraine.pegase.chc.model.ParametresEditionListePresenceComposition;
...
public class ListesPresencesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ListesPresencesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ListesPresencesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for editerListesDePresencesCsvDeCompositionsAsZIP
     * @param typeDocument type de document à éditer (required)
     * @param parametresEditionListePresenceComposition Les différents paramètres de l&#39;édition des listes d&#39;appel ou d&#39;émargement (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Un zip contenant les listes d&#39;appel ou d&#39;émergement </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Vous n&#39;avez pas accès au chemin demandé </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Ressource non trouvée </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call editerListesDePresencesCsvDeCompositionsAsZIPCall(String typeDocument, ParametresEditionListePresenceComposition parametresEditionListePresenceComposition, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = parametresEditionListePresenceComposition;

        // create path and map variables
        String localVarPath = "/editions/exportzip/composition";
    ...
    private okhttp3.Call editerListesDePresencesCsvDeCompositionsAsZIPValidateBeforeCall(String typeDocument, ParametresEditionListePresenceComposition parametresEditionListePresenceComposition, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'typeDocument' is set
        if (typeDocument == null) {
            throw new ApiException("Missing the required parameter 'typeDocument' when calling editerListesDePresencesCsvDeCompositionsAsZIP(Async)");
        }
        
        // verify the required parameter 'parametresEditionListePresenceComposition' is set
        if (parametresEditionListePresenceComposition == null) {
            throw new ApiException("Missing the required parameter 'parametresEditionListePresenceComposition' when calling editerListesDePresencesCsvDeCompositionsAsZIP(Async)");
        }
        

        okhttp3.Call localVarCall = editerListesDePresencesCsvDeCompositionsAsZIPCall(typeDocument, parametresEditionListePresenceComposition, _callback);
        return localVarCall;

    }

    /**
     * Editer des listes d&#39;appel ou d&#39;émargement en format CSV par groupe pour les apprenants d&#39;une composition, avec les apprenants dont l&#39;inscription est validée et dont au moins une affectation/renonciation est choisie sur l&#39;un des chemins sélectionnés.
     * Permet d&#39;éditer des listes d&#39;appel ou d&#39;émargement pour les apprenants d&#39;une composition. Seuls les apprenants dont l&#39;inscription est validée et avec au moins une affectation/renonciation choisie sur l&#39;un des chemins sélectionnés seront affichés. Vous pouvez choisir les colonnes à afficher. La liste d&#39;émargement contient une colonne supplémentaire \&quot;Observation\&quot; qui peut contenir l&#39;aménagement dispense d&#39;assiduité si un aménagement est positionné sur le choix pédagogique de l&#39;apprenant.
     * @param typeDocument type de document à éditer (required)
     * @param parametresEditionListePresenceComposition Les différents paramètres de l&#39;édition des listes d&#39;appel ou d&#39;émargement (required)
     * @return File
     ...
     */
    public File editerListesDePresencesCsvDeCompositionsAsZIP(String typeDocument, ParametresEditionListePresenceComposition parametresEditionListePresenceComposition) throws ApiException {
        ApiResponse<File> localVarResp = editerListesDePresencesCsvDeCompositionsAsZIPWithHttpInfo(typeDocument, parametresEditionListePresenceComposition);
     ...
     */
    public ApiResponse<File> editerListesDePresencesCsvDeCompositionsAsZIPWithHttpInfo(String typeDocument, ParametresEditionListePresenceComposition parametresEditionListePresenceComposition) throws ApiException {
        okhttp3.Call localVarCall = editerListesDePresencesCsvDeCompositionsAsZIPValidateBeforeCall(typeDocument, parametresEditionListePresenceComposition, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Editer des listes d&#39;appel ou d&#39;émargement en format CSV par groupe pour les apprenants d&#39;une composition, avec les apprenants dont l&#39;inscription est validée et dont au moins une affectation/renonciation est choisie sur l&#39;un des chemins sélectionnés. (asynchronously)
     * Permet d&#39;éditer des listes d&#39;appel ou d&#39;émargement pour les apprenants d&#39;une composition. Seuls les apprenants dont l&#39;inscription est validée et avec au moins une affectation/renonciation choisie sur l&#39;un des chemins sélectionnés seront affichés. Vous pouvez choisir les colonnes à afficher. La liste d&#39;émargement contient une colonne supplémentaire \&quot;Observation\&quot; qui peut contenir l&#39;aménagement dispense d&#39;assiduité si un aménagement est positionné sur le choix pédagogique de l&#39;apprenant.
     * @param typeDocument type de document à éditer (required)
     * @param parametresEditionListePresenceComposition Les différents paramètres de l&#39;édition des listes d&#39;appel ou d&#39;émargement (required)
     ...
     */
    public okhttp3.Call editerListesDePresencesCsvDeCompositionsAsZIPAsync(String typeDocument, ParametresEditionListePresenceComposition parametresEditionListePresenceComposition, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = editerListesDePresencesCsvDeCompositionsAsZIPValidateBeforeCall(typeDocument, parametresEditionListePresenceComposition, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
     ...
     */
    public okhttp3.Call genererListeAppelEmargementCall(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call genererListeAppelEmargementValidateBeforeCall(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = genererListeAppelEmargementCall(typeDocument, parametresEditionListeAppelEmargement, _callback);
        return localVarCall;
     ...
     */
    public File genererListeAppelEmargement(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement) throws ApiException {
        ApiResponse<File> localVarResp = genererListeAppelEmargementWithHttpInfo(typeDocument, parametresEditionListeAppelEmargement);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> genererListeAppelEmargementWithHttpInfo(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement) throws ApiException {
        okhttp3.Call localVarCall = genererListeAppelEmargementValidateBeforeCall(typeDocument, parametresEditionListeAppelEmargement, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call genererListeAppelEmargementAsync(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = genererListeAppelEmargementValidateBeforeCall(typeDocument, parametresEditionListeAppelEmargement, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for genererZipDeListeAppelEmargementCsv
     ...
     */
    public okhttp3.Call genererZipDeListeAppelEmargementCsvCall(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/editions/exportzip";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call genererZipDeListeAppelEmargementCsvValidateBeforeCall(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'typeDocument' is set
        if (typeDocument == null) {
            throw new ApiException("Missing the required parameter 'typeDocument' when calling genererZipDeListeAppelEmargementCsv(Async)");
        }
        
        // verify the required parameter 'parametresEditionListeAppelEmargement' is set
        if (parametresEditionListeAppelEmargement == null) {
            throw new ApiException("Missing the required parameter 'parametresEditionListeAppelEmargement' when calling genererZipDeListeAppelEmargementCsv(Async)");
        }
        

        okhttp3.Call localVarCall = genererZipDeListeAppelEmargementCsvCall(typeDocument, parametresEditionListeAppelEmargement, _callback);
        return localVarCall;
     ...
     */
    public File genererZipDeListeAppelEmargementCsv(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement) throws ApiException {
        ApiResponse<File> localVarResp = genererZipDeListeAppelEmargementCsvWithHttpInfo(typeDocument, parametresEditionListeAppelEmargement);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> genererZipDeListeAppelEmargementCsvWithHttpInfo(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement) throws ApiException {
        okhttp3.Call localVarCall = genererZipDeListeAppelEmargementCsvValidateBeforeCall(typeDocument, parametresEditionListeAppelEmargement, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call genererZipDeListeAppelEmargementCsvAsync(String typeDocument, ParametresEditionListeAppelEmargement parametresEditionListeAppelEmargement, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = genererZipDeListeAppelEmargementCsvValidateBeforeCall(typeDocument, parametresEditionListeAppelEmargement, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
