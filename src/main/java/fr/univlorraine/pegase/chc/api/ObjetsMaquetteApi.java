...
import fr.univlorraine.pegase.chc.model.ObjetMaquette;
import fr.univlorraine.pegase.chc.model.PagedCheminObjetMaquette;
import fr.univlorraine.pegase.chc.model.PagedObjetFormationComposition;
...
public class ObjetsMaquetteApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Les objets maquette ont été récupérées </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Liste des objets maquette de type formation
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
    ...
    /**
     * Liste des objets maquette de type formation (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
    ...
    /**
     * Liste des objets maquette de type objet de formation
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @return List&lt;ObjetMaquette&gt;
    ...
    /**
     * Liste des objets maquette de type objet de formation (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for rechercherFormationsPourCompo
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     ...
     */
    public okhttp3.Call rechercherFormationsPourCompoCall(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, List<String> etatOuvertureAuChc, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/structure/{codeStructure}/formation-composition"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rechercherFormationsPourCompoValidateBeforeCall(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, List<String> etatOuvertureAuChc, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling rechercherFormationsPourCompo(Async)");
        }
        
        // verify the required parameter 'codePeriode' is set
        if (codePeriode == null) {
            throw new ApiException("Missing the required parameter 'codePeriode' when calling rechercherFormationsPourCompo(Async)");
        }
        

        okhttp3.Call localVarCall = rechercherFormationsPourCompoCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, etatOuvertureAuChc, _callback);
        return localVarCall;
     ...
     */
    public PagedCheminObjetMaquette rechercherFormationsPourCompo(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, List<String> etatOuvertureAuChc) throws ApiException {
        ApiResponse<PagedCheminObjetMaquette> localVarResp = rechercherFormationsPourCompoWithHttpInfo(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, etatOuvertureAuChc);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedCheminObjetMaquette> rechercherFormationsPourCompoWithHttpInfo(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, List<String> etatOuvertureAuChc) throws ApiException {
        okhttp3.Call localVarCall = rechercherFormationsPourCompoValidateBeforeCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, etatOuvertureAuChc, null);
     ...
     */
    public okhttp3.Call rechercherFormationsPourCompoAsync(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, List<String> etatOuvertureAuChc, final ApiCallback<PagedCheminObjetMaquette> _callback) throws ApiException {

        okhttp3.Call localVarCall = rechercherFormationsPourCompoValidateBeforeCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, etatOuvertureAuChc, _callback);
        Type localVarReturnType = new TypeToken<PagedCheminObjetMaquette>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for rechercherObjetsFormationComposition
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param pageable Les tris possibles sont :          * objetFormation.code          * objetFormation.libelleCourt          * objetFormation.codeType          * formation.code           * formation.libelle (optional)
     * @param codeOuLibelleFormation Le code ou le libellé de la formation (optional)
     * @param codeTypeFormation Le code type de la formation (optional)
     ...
     */
    public okhttp3.Call rechercherObjetsFormationCompositionCall(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, String codeOuLibelleObjetFormation, String codeTypeObjetFormation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/structure/{codeStructure}/objet-formation-composition"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rechercherObjetsFormationCompositionValidateBeforeCall(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, String codeOuLibelleObjetFormation, String codeTypeObjetFormation, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling rechercherObjetsFormationComposition(Async)");
        }
        
        // verify the required parameter 'codePeriode' is set
        if (codePeriode == null) {
            throw new ApiException("Missing the required parameter 'codePeriode' when calling rechercherObjetsFormationComposition(Async)");
        }
        

        okhttp3.Call localVarCall = rechercherObjetsFormationCompositionCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, codeOuLibelleObjetFormation, codeTypeObjetFormation, _callback);
        return localVarCall;

    }

    /**
     * Rechercher les objets formations avec leur liste de formations
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param pageable Les tris possibles sont :          * objetFormation.code          * objetFormation.libelleCourt          * objetFormation.codeType          * formation.code           * formation.libelle (optional)
     ...
     * @param codeOuLibelleObjetFormation Le code ou le libellé de l&#39;objet formation (optional)
     * @param codeTypeObjetFormation Le code du type de l&#39;objet formation (optional)
     * @return PagedObjetFormationComposition
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public PagedObjetFormationComposition rechercherObjetsFormationComposition(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, String codeOuLibelleObjetFormation, String codeTypeObjetFormation) throws ApiException {
        ApiResponse<PagedObjetFormationComposition> localVarResp = rechercherObjetsFormationCompositionWithHttpInfo(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, codeOuLibelleObjetFormation, codeTypeObjetFormation);
        return localVarResp.getData();
    }
     ...
     * @param codeOuLibelleObjetFormation Le code ou le libellé de l&#39;objet formation (optional)
     * @param codeTypeObjetFormation Le code du type de l&#39;objet formation (optional)
     * @return ApiResponse&lt;PagedObjetFormationComposition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedObjetFormationComposition> rechercherObjetsFormationCompositionWithHttpInfo(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, String codeOuLibelleObjetFormation, String codeTypeObjetFormation) throws ApiException {
        okhttp3.Call localVarCall = rechercherObjetsFormationCompositionValidateBeforeCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, codeOuLibelleObjetFormation, codeTypeObjetFormation, null);
        Type localVarReturnType = new TypeToken<PagedObjetFormationComposition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Rechercher les objets formations avec leur liste de formations (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param pageable Les tris possibles sont :          * objetFormation.code          * objetFormation.libelleCourt          * objetFormation.codeType          * formation.code           * formation.libelle (optional)
     ...
     */
    public okhttp3.Call rechercherObjetsFormationCompositionAsync(String codeStructure, String codePeriode, CustomPageable pageable, String codeOuLibelleFormation, String codeTypeFormation, String codeOuLibelleObjetFormation, String codeTypeObjetFormation, final ApiCallback<PagedObjetFormationComposition> _callback) throws ApiException {

        okhttp3.Call localVarCall = rechercherObjetsFormationCompositionValidateBeforeCall(codeStructure, codePeriode, pageable, codeOuLibelleFormation, codeTypeFormation, codeOuLibelleObjetFormation, codeTypeObjetFormation, _callback);
        Type localVarReturnType = new TypeToken<PagedObjetFormationComposition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
