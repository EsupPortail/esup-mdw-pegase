...
import fr.univlorraine.pegase.chc.model.AcquisUtilisableSurChoixPedagogiqueRequest;
import fr.univlorraine.pegase.chc.model.AffectationIndividuelleAcquisUtilisable;
import fr.univlorraine.pegase.chc.model.AffectationIndividuelleRechercherCursusApprenantResultatListeCursus;
import fr.univlorraine.pegase.chc.model.ChoisirAmenagementRequest;
import fr.univlorraine.pegase.chc.model.CustomPageable;
import java.util.Date;
import fr.univlorraine.pegase.chc.model.FaireChoixPedagogiqueAvecPropositionRequest;
import fr.univlorraine.pegase.chc.model.FaireChoixPedagogiqueRequest;
import fr.univlorraine.pegase.chc.model.LectureAffectationIndividuelle;
...
public class AffectationIndividuelleApi {
     ...
     * @param choisirAmenagementRequest Le choix pedagogique sur lequel on veut ajouter un amenagement (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Cursus ou brouillon non trouvé </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueRequest Le choix pedagogique sur lequel on veut annuler l&#39;affectation de l&#39;apprenant (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueRequest Le choix pedagogique sur lequel on veut annuler l&#39;utilisation de l&#39;acquis (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueRequest Le choix pedagogique sur lequel on veut annuler le choix renonciation de l&#39;apprenant (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueAvecPropositionRequest Le choix pedagogique sur lequel on veut affecter cet apprenant, et l&#39;option &#39;propositions pédagogiques automatiques sur les descendants&#39; (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Choisir une affectation pour cet apprenant pour ce choix pedagogique
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueAvecPropositionRequest Le choix pedagogique sur lequel on veut affecter cet apprenant, et l&#39;option &#39;propositions pédagogiques automatiques sur les descendants&#39; (required)
    ...
    /**
     * Choisir une affectation pour cet apprenant pour ce choix pedagogique (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueAvecPropositionRequest Le choix pedagogique sur lequel on veut affecter cet apprenant, et l&#39;option &#39;propositions pédagogiques automatiques sur les descendants&#39; (required)
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueRequest Le choix pedagogique pour lequel on veut utiliser l&#39;acquis disponible (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueAvecPropositionRequest Le choix pedagogique pour lequel l&#39;apprenant veut renoncer à l&#39;utilisation de son acquis, c&#39;est à dire une affectation malgré la présence d&#39;un acquis disponible (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call affectationIndividuelleChoisirRenonciationCall(String codeStructure, UUID cursusUuid, FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call affectationIndividuelleChoisirRenonciationValidateBeforeCall(String codeStructure, UUID cursusUuid, FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'faireChoixPedagogiqueAvecPropositionRequest' is set
        if (faireChoixPedagogiqueAvecPropositionRequest == null) {
            throw new ApiException("Missing the required parameter 'faireChoixPedagogiqueAvecPropositionRequest' when calling affectationIndividuelleChoisirRenonciation(Async)");
        }
        

        okhttp3.Call localVarCall = affectationIndividuelleChoisirRenonciationCall(codeStructure, cursusUuid, faireChoixPedagogiqueAvecPropositionRequest, _callback);
        return localVarCall;
     ...
     */
    public LectureAffectationIndividuelle affectationIndividuelleChoisirRenonciation(String codeStructure, UUID cursusUuid, FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest) throws ApiException {
        ApiResponse<LectureAffectationIndividuelle> localVarResp = affectationIndividuelleChoisirRenonciationWithHttpInfo(codeStructure, cursusUuid, faireChoixPedagogiqueAvecPropositionRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LectureAffectationIndividuelle> affectationIndividuelleChoisirRenonciationWithHttpInfo(String codeStructure, UUID cursusUuid, FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest) throws ApiException {
        okhttp3.Call localVarCall = affectationIndividuelleChoisirRenonciationValidateBeforeCall(codeStructure, cursusUuid, faireChoixPedagogiqueAvecPropositionRequest, null);
        Type localVarReturnType = new TypeToken<LectureAffectationIndividuelle>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call affectationIndividuelleChoisirRenonciationAsync(String codeStructure, UUID cursusUuid, FaireChoixPedagogiqueAvecPropositionRequest faireChoixPedagogiqueAvecPropositionRequest, final ApiCallback<LectureAffectationIndividuelle> _callback) throws ApiException {

        okhttp3.Call localVarCall = affectationIndividuelleChoisirRenonciationValidateBeforeCall(codeStructure, cursusUuid, faireChoixPedagogiqueAvecPropositionRequest, _callback);
        Type localVarReturnType = new TypeToken<LectureAffectationIndividuelle>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param faireChoixPedagogiqueRequest Le choix pedagogique sur lequel on veut effectuer une correction d&#39;anomalie (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for affectationIndividuelleCreerBrouillon
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     ...
     */
    public okhttp3.Call affectationIndividuelleCreerBrouillonCall(String codeStructure, UUID cursusUuid, Boolean avecPropositions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/structure/{codeStructure}/affectation-individuelle/{cursusUuid}/creer-brouillon"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()))
            .replaceAll("\\{" + "cursusUuid" + "\\}", localVarApiClient.escapeString(cursusUuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call affectationIndividuelleCreerBrouillonValidateBeforeCall(String codeStructure, UUID cursusUuid, Boolean avecPropositions, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling affectationIndividuelleCreerBrouillon(Async)");
        }
        
        // verify the required parameter 'cursusUuid' is set
        if (cursusUuid == null) {
            throw new ApiException("Missing the required parameter 'cursusUuid' when calling affectationIndividuelleCreerBrouillon(Async)");
        }
        
        // verify the required parameter 'avecPropositions' is set
        if (avecPropositions == null) {
            throw new ApiException("Missing the required parameter 'avecPropositions' when calling affectationIndividuelleCreerBrouillon(Async)");
        }
        

        okhttp3.Call localVarCall = affectationIndividuelleCreerBrouillonCall(codeStructure, cursusUuid, avecPropositions, _callback);
        return localVarCall;

    }

    /**
     * création d&#39;un brouillon pédagogique
     * creation d&#39;un brouillon pédagogique sur le cursus. Ce brouillon appartient à l&#39;utilisateur connecté et a un accès exclusif.
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param avecPropositions Si les propositions pédagogiques doivent être faites à la création du brouillon. C&#39;est à dire choix affectation ou choix capitalisé lorsque possible sur les OF obligatoires et hors plage de choix (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     ...
     */
    public void affectationIndividuelleCreerBrouillon(String codeStructure, UUID cursusUuid, Boolean avecPropositions) throws ApiException {
        affectationIndividuelleCreerBrouillonWithHttpInfo(codeStructure, cursusUuid, avecPropositions);
    }
     ...
     */
    public ApiResponse<Void> affectationIndividuelleCreerBrouillonWithHttpInfo(String codeStructure, UUID cursusUuid, Boolean avecPropositions) throws ApiException {
        okhttp3.Call localVarCall = affectationIndividuelleCreerBrouillonValidateBeforeCall(codeStructure, cursusUuid, avecPropositions, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * création d&#39;un brouillon pédagogique (asynchronously)
     * creation d&#39;un brouillon pédagogique sur le cursus. Ce brouillon appartient à l&#39;utilisateur connecté et a un accès exclusif.
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param avecPropositions Si les propositions pédagogiques doivent être faites à la création du brouillon. C&#39;est à dire choix affectation ou choix capitalisé lorsque possible sur les OF obligatoires et hors plage de choix (required)
     ...
     */
    public okhttp3.Call affectationIndividuelleCreerBrouillonAsync(String codeStructure, UUID cursusUuid, Boolean avecPropositions, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = affectationIndividuelleCreerBrouillonValidateBeforeCall(codeStructure, cursusUuid, avecPropositions, _callback);
    ...
    /**
     * Lecture d&#39;un Cursus pour l&#39;affectation individuelle
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @return LectureAffectationIndividuelle
    ...
    /**
     * Lecture d&#39;un Cursus pour l&#39;affectation individuelle (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Rechercher les apprenants sur la période
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param pageable  (optional)
    ...
    /**
     * Rechercher les apprenants sur la période (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param pageable  (optional)
    ...
    /**
     * Rechercher les cursus de l&#39;apprenant sur la période
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param apprenantUuid L&#39;UUID de l&#39;apprenant (required)
    ...
    /**
     * Rechercher les cursus de l&#39;apprenant sur la période (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param apprenantUuid L&#39;UUID de l&#39;apprenant (required)
     ...
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param choisirAmenagementRequest Le choix pedagogique sur lequel on veut retirer un amenagement (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Build call for affectationIndividuelleSupprimerBrouillon
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Le brouillon a été supprimé </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Cursus ou brouillon non trouvé </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call affectationIndividuelleSupprimerBrouillonCall(String codeStructure, UUID cursusUuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/structure/{codeStructure}/affectation-individuelle/{cursusUuid}/supprimer-brouillon"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()))
            .replaceAll("\\{" + "cursusUuid" + "\\}", localVarApiClient.escapeString(cursusUuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call affectationIndividuelleSupprimerBrouillonValidateBeforeCall(String codeStructure, UUID cursusUuid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling affectationIndividuelleSupprimerBrouillon(Async)");
        }
        
        // verify the required parameter 'cursusUuid' is set
        if (cursusUuid == null) {
            throw new ApiException("Missing the required parameter 'cursusUuid' when calling affectationIndividuelleSupprimerBrouillon(Async)");
        }
        

        okhttp3.Call localVarCall = affectationIndividuelleSupprimerBrouillonCall(codeStructure, cursusUuid, _callback);
        return localVarCall;
    ...
    /**
     * cursus
     * suppression du brouillon pédagogique sur le cursus. Le brouillon ne peut être supprimé que s&#39;il appartient à l&#39;utilisateur connecté.
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     ...
     */
    public void affectationIndividuelleSupprimerBrouillon(String codeStructure, UUID cursusUuid) throws ApiException {
        affectationIndividuelleSupprimerBrouillonWithHttpInfo(codeStructure, cursusUuid);
    }
     ...
     */
    public ApiResponse<Void> affectationIndividuelleSupprimerBrouillonWithHttpInfo(String codeStructure, UUID cursusUuid) throws ApiException {
        okhttp3.Call localVarCall = affectationIndividuelleSupprimerBrouillonValidateBeforeCall(codeStructure, cursusUuid, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call affectationIndividuelleSupprimerBrouillonAsync(String codeStructure, UUID cursusUuid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = affectationIndividuelleSupprimerBrouillonValidateBeforeCall(codeStructure, cursusUuid, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for affectationIndividuelleValiderBrouillon
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Le brouillon a été validé </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Cursus ou brouillon non trouvé </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call affectationIndividuelleValiderBrouillonCall(String codeStructure, UUID cursusUuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/structure/{codeStructure}/affectation-individuelle/{cursusUuid}/valider-brouillon"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()))
            .replaceAll("\\{" + "cursusUuid" + "\\}", localVarApiClient.escapeString(cursusUuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call affectationIndividuelleValiderBrouillonValidateBeforeCall(String codeStructure, UUID cursusUuid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling affectationIndividuelleValiderBrouillon(Async)");
        }
        
        // verify the required parameter 'cursusUuid' is set
        if (cursusUuid == null) {
            throw new ApiException("Missing the required parameter 'cursusUuid' when calling affectationIndividuelleValiderBrouillon(Async)");
        }
        

        okhttp3.Call localVarCall = affectationIndividuelleValiderBrouillonCall(codeStructure, cursusUuid, _callback);
        return localVarCall;
    ...
    /**
     * cursus
     * validation du brouillon sur le cursus. Le brouillon ne peut être validé que s&#39;il appartient à l&#39;utilisateur connecté.
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param cursusUuid L&#39;identifiant technique du Cursus (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     ...
     */
    public void affectationIndividuelleValiderBrouillon(String codeStructure, UUID cursusUuid) throws ApiException {
        affectationIndividuelleValiderBrouillonWithHttpInfo(codeStructure, cursusUuid);
    }
     ...
     */
    public ApiResponse<Void> affectationIndividuelleValiderBrouillonWithHttpInfo(String codeStructure, UUID cursusUuid) throws ApiException {
        okhttp3.Call localVarCall = affectationIndividuelleValiderBrouillonValidateBeforeCall(codeStructure, cursusUuid, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call affectationIndividuelleValiderBrouillonAsync(String codeStructure, UUID cursusUuid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = affectationIndividuelleValiderBrouillonValidateBeforeCall(codeStructure, cursusUuid, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
