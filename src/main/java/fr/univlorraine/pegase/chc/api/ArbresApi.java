...
import fr.univlorraine.pegase.chc.model.ArbreLecture;
...
public class ArbresApi {
    ...
    public ArbresApi(ApiClient apiClient) {
    ...
    /**
     * Build call for arbrePourUneFormation
     * @param formationUuid L&#39;identifiant technique du chemin de la cible (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> L&#39;arbre de la période </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call arbrePourUneFormationCall(UUID formationUuid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/arbre/{formationUuid}"
            .replaceAll("\\{" + "formationUuid" + "\\}", localVarApiClient.escapeString(formationUuid.toString()));
    ...
    private okhttp3.Call arbrePourUneFormationValidateBeforeCall(UUID formationUuid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'formationUuid' is set
        if (formationUuid == null) {
            throw new ApiException("Missing the required parameter 'formationUuid' when calling arbrePourUneFormation(Async)");
        }
        

        okhttp3.Call localVarCall = arbrePourUneFormationCall(formationUuid, _callback);
        return localVarCall;

    }

    /**
     * Lire un arbre pour un établissement et une période
     * 
     * @param formationUuid L&#39;identifiant technique du chemin de la cible (required)
     * @return ArbreLecture
     ...
     */
    public ArbreLecture arbrePourUneFormation(UUID formationUuid) throws ApiException {
        ApiResponse<ArbreLecture> localVarResp = arbrePourUneFormationWithHttpInfo(formationUuid);
     ...
     * 
     * @param formationUuid L&#39;identifiant technique du chemin de la cible (required)
     * @return ApiResponse&lt;ArbreLecture&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ArbreLecture> arbrePourUneFormationWithHttpInfo(UUID formationUuid) throws ApiException {
        okhttp3.Call localVarCall = arbrePourUneFormationValidateBeforeCall(formationUuid, null);
        Type localVarReturnType = new TypeToken<ArbreLecture>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Lire un arbre pour un établissement et une période (asynchronously)
     * 
     * @param formationUuid L&#39;identifiant technique du chemin de la cible (required)
     ...
     */
    public okhttp3.Call arbrePourUneFormationAsync(UUID formationUuid, final ApiCallback<ArbreLecture> _callback) throws ApiException {

        okhttp3.Call localVarCall = arbrePourUneFormationValidateBeforeCall(formationUuid, _callback);
        Type localVarReturnType = new TypeToken<ArbreLecture>(){}.getType();
