...
import fr.univlorraine.pegase.chc.model.FormationPourModification;
...
public class FormationsApi {
    ...
    /**
     * Build call for lire
     * @param codeFormation Le code formation (required)
     * @param uuidPeriode L&#39;identifiant technique de la période (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> La formation mise en œuvre </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call lireCall(String codeFormation, UUID uuidPeriode, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/formations/{codeFormation}/{uuidPeriode}"
            .replaceAll("\\{" + "codeFormation" + "\\}", localVarApiClient.escapeString(codeFormation.toString()))
    ...
    private okhttp3.Call lireValidateBeforeCall(String codeFormation, UUID uuidPeriode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeFormation' is set
        if (codeFormation == null) {
            throw new ApiException("Missing the required parameter 'codeFormation' when calling lire(Async)");
        }
        
        // verify the required parameter 'uuidPeriode' is set
        if (uuidPeriode == null) {
            throw new ApiException("Missing the required parameter 'uuidPeriode' when calling lire(Async)");
        }
        

        okhttp3.Call localVarCall = lireCall(codeFormation, uuidPeriode, _callback);
        return localVarCall;

    }

    /**
     * Lire une formation mise en œuvre
     * 
     * @param codeFormation Le code formation (required)
     * @param uuidPeriode L&#39;identifiant technique de la période (required)
     * @return FormationPourModification
     ...
     */
    public FormationPourModification lire(String codeFormation, UUID uuidPeriode) throws ApiException {
        ApiResponse<FormationPourModification> localVarResp = lireWithHttpInfo(codeFormation, uuidPeriode);
     ...
     * @param codeFormation Le code formation (required)
     * @param uuidPeriode L&#39;identifiant technique de la période (required)
     * @return ApiResponse&lt;FormationPourModification&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FormationPourModification> lireWithHttpInfo(String codeFormation, UUID uuidPeriode) throws ApiException {
        okhttp3.Call localVarCall = lireValidateBeforeCall(codeFormation, uuidPeriode, null);
        Type localVarReturnType = new TypeToken<FormationPourModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Lire une formation mise en œuvre (asynchronously)
     * 
     * @param codeFormation Le code formation (required)
     * @param uuidPeriode L&#39;identifiant technique de la période (required)
     ...
     */
    public okhttp3.Call lireAsync(String codeFormation, UUID uuidPeriode, final ApiCallback<FormationPourModification> _callback) throws ApiException {

        okhttp3.Call localVarCall = lireValidateBeforeCall(codeFormation, uuidPeriode, _callback);
        Type localVarReturnType = new TypeToken<FormationPourModification>(){}.getType();
