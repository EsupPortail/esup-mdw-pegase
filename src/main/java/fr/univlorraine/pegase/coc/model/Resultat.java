...
public class Resultat {
  ...
  public Resultat code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public Resultat libelleCourt(@jakarta.annotation.Nonnull String libelleCourt) {
  ...
  public Resultat libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
  ...
  public Resultat libelleAffichage(@jakarta.annotation.Nonnull String libelleAffichage) {
   ...
   * @return the Resultat instance itself
   */
  public Resultat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, resultat.code) &&
        ...
        Objects.equals(this.additionalProperties, resultat.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Resultat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Resultat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Resultat is not found in the empty JSON string", Resultat.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Resultat.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Resultat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Resultat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Resultat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Resultat.class));

       return (TypeAdapter<T>) new TypeAdapter<Resultat>() {
           @Override
           public void write(JsonWriter out, Resultat value) throws IOException {
           ...
           @Override
           public Resultat read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             Resultat instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of Resultat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Resultat
   * @throws IOException if the JSON string is invalid with respect to Resultat
   */
  public static Resultat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Resultat.class);
  }

  /**
   * Convert an instance of Resultat to an JSON string
   *
   * @return JSON string
   */
