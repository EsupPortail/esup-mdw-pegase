...
public class TypeControle {
  ...
  public TypeControle code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }

  /**
   * Le code du type de contrôle
   * @return code
   */
  @jakarta.annotation.Nonnull
  ...
  public TypeControle libelleCourt(@jakarta.annotation.Nonnull String libelleCourt) {
    this.libelleCourt = libelleCourt;
    return this;
  }

  /**
   * Le libellé court du type de contrôle
   * @return libelleCourt
   */
  @jakarta.annotation.Nonnull
  ...
  public TypeControle libelleLong(@jakarta.annotation.Nonnull String libelleLong) {
    this.libelleLong = libelleLong;
    return this;
  }

  /**
   * Le libellé long du type de contrôle
   * @return libelleLong
   */
  @jakarta.annotation.Nonnull
  ...
  public TypeControle libelleAffichage(@jakarta.annotation.Nonnull String libelleAffichage) {
    this.libelleAffichage = libelleAffichage;
    return this;
  }

  /**
   * Le libellé d&#39;affichage (celui présenté aux apprenants) du type de contrôle
   ...
   * @return the TypeControle instance itself
   */
  public TypeControle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TypeControle typeControle = (TypeControle) o;
    return Objects.equals(this.code, typeControle.code) &&
        Objects.equals(this.libelleCourt, typeControle.libelleCourt) &&
        Objects.equals(this.libelleLong, typeControle.libelleLong) &&
        Objects.equals(this.libelleAffichage, typeControle.libelleAffichage)&&
        Objects.equals(this.additionalProperties, typeControle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, libelleAffichage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TypeControle {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "libelleCourt", "libelleLong", "libelleAffichage"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "libelleCourt", "libelleLong", "libelleAffichage"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypeControle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeControle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TypeControle is not found in the empty JSON string", TypeControle.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TypeControle.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypeControle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypeControle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypeControle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypeControle.class));

       return (TypeAdapter<T>) new TypeAdapter<TypeControle>() {
           @Override
           public void write(JsonWriter out, TypeControle value) throws IOException {
           ...
           @Override
           public TypeControle read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TypeControle instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TypeControle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypeControle
   * @throws IOException if the JSON string is invalid with respect to TypeControle
   */
  public static TypeControle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypeControle.class);
  }

  /**
   * Convert an instance of TypeControle to an JSON string
   *
   * @return JSON string
   */
