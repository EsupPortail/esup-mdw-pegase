 ...
 */
@ApiModel(description = "Le GPA (Grade Point Average) (paramétrage \"GradePointAverage\" venant du référentiel)")
...
public class Gpa {
  ...
  **/
  ...
  @ApiModelProperty(example = "GPA001", required = true, value = "Le code de la nomenclature GPA")
  ...
  public Gpa valeur(String valeur) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "0.70", required = true, value = "La valeur de la nomenclature GPA")
