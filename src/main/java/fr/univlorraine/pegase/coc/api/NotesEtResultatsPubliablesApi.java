...
public class NotesEtResultatsPubliablesApi {
     ...
     */
    public okhttp3.Call listerCursusPubliableApprenantCall(@jakarta.annotation.Nonnull String codeStructureEtablissement, @jakarta.annotation.Nonnull String codePeriode, @jakarta.annotation.Nonnull String codeApprenant, @jakarta.annotation.Nonnull String codeChemin, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listerCursusPubliableApprenantValidateBeforeCall(@jakarta.annotation.Nonnull String codeStructureEtablissement, @jakarta.annotation.Nonnull String codePeriode, @jakarta.annotation.Nonnull String codeApprenant, @jakarta.annotation.Nonnull String codeChemin, final ApiCallback _callback) throws ApiException {
        ...
        return listerCursusPubliableApprenantCall(codeStructureEtablissement, codePeriode, codeApprenant, codeChemin, _callback);
     ...
     */
    public List<Chemin> listerCursusPubliableApprenant(@jakarta.annotation.Nonnull String codeStructureEtablissement, @jakarta.annotation.Nonnull String codePeriode, @jakarta.annotation.Nonnull String codeApprenant, @jakarta.annotation.Nonnull String codeChemin) throws ApiException {
     ...
     */
    public ApiResponse<List<Chemin>> listerCursusPubliableApprenantWithHttpInfo(@jakarta.annotation.Nonnull String codeStructureEtablissement, @jakarta.annotation.Nonnull String codePeriode, @jakarta.annotation.Nonnull String codeApprenant, @jakarta.annotation.Nonnull String codeChemin) throws ApiException {
     ...
     */
    public okhttp3.Call listerCursusPubliableApprenantAsync(@jakarta.annotation.Nonnull String codeStructureEtablissement, @jakarta.annotation.Nonnull String codePeriode, @jakarta.annotation.Nonnull String codeApprenant, @jakarta.annotation.Nonnull String codeChemin, final ApiCallback<List<Chemin>> _callback) throws ApiException {
