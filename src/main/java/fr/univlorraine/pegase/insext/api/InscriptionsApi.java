...
public class InscriptionsApi {
     ...
     */
    public okhttp3.Call lireInscriptionsCall(@jakarta.annotation.Nonnull String codeStructure, @jakarta.annotation.Nonnull String codeApprenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call lireInscriptionsValidateBeforeCall(@jakarta.annotation.Nonnull String codeStructure, @jakarta.annotation.Nonnull String codeApprenant, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApprenantEtInscriptions lireInscriptions(@jakarta.annotation.Nonnull String codeStructure, @jakarta.annotation.Nonnull String codeApprenant) throws ApiException {
     ...
     */
    public ApiResponse<ApprenantEtInscriptions> lireInscriptionsWithHttpInfo(@jakarta.annotation.Nonnull String codeStructure, @jakarta.annotation.Nonnull String codeApprenant) throws ApiException {
     ...
     */
    public okhttp3.Call lireInscriptionsAsync(@jakarta.annotation.Nonnull String codeStructure, @jakarta.annotation.Nonnull String codeApprenant, final ApiCallback<ApprenantEtInscriptions> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listerFluxInscriptionsPagineCall(@jakarta.annotation.Nullable Long depuis, @jakarta.annotation.Nullable Long jusqua, @jakarta.annotation.Nullable Boolean photo, @jakarta.annotation.Nullable String codePeriode, @jakarta.annotation.Nullable Pageable pageable, @jakarta.annotation.Nullable String codeApprenant, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listerFluxInscriptionsPagineValidateBeforeCall(@jakarta.annotation.Nullable Long depuis, @jakarta.annotation.Nullable Long jusqua, @jakarta.annotation.Nullable Boolean photo, @jakarta.annotation.Nullable String codePeriode, @jakarta.annotation.Nullable Pageable pageable, @jakarta.annotation.Nullable String codeApprenant, final ApiCallback _callback) throws ApiException {
     ...
     */
    public VueInscriptions listerFluxInscriptionsPagine(@jakarta.annotation.Nullable Long depuis, @jakarta.annotation.Nullable Long jusqua, @jakarta.annotation.Nullable Boolean photo, @jakarta.annotation.Nullable String codePeriode, @jakarta.annotation.Nullable Pageable pageable, @jakarta.annotation.Nullable String codeApprenant) throws ApiException {
     ...
     */
    public ApiResponse<VueInscriptions> listerFluxInscriptionsPagineWithHttpInfo(@jakarta.annotation.Nullable Long depuis, @jakarta.annotation.Nullable Long jusqua, @jakarta.annotation.Nullable Boolean photo, @jakarta.annotation.Nullable String codePeriode, @jakarta.annotation.Nullable Pageable pageable, @jakarta.annotation.Nullable String codeApprenant) throws ApiException {
     ...
     */
    public okhttp3.Call listerFluxInscriptionsPagineAsync(@jakarta.annotation.Nullable Long depuis, @jakarta.annotation.Nullable Long jusqua, @jakarta.annotation.Nullable Boolean photo, @jakarta.annotation.Nullable String codePeriode, @jakarta.annotation.Nullable Pageable pageable, @jakarta.annotation.Nullable String codeApprenant, final ApiCallback<VueInscriptions> _callback) throws ApiException {
