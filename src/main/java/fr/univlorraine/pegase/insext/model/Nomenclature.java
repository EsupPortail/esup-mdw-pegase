...
public class Nomenclature {
  ...
  @jakarta.annotation.Nullable
  protected Integer prioriteAffichage;
  ...
  @JsonProperty(value = JSON_PROPERTY_TYPE_NOMENCLATURE, required = true)
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LIBELLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PRIORITE_AFFICHAGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
