...
public class CibleInscription extends ObjetAvecLibelle {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, codeStructure, formation, uaIStructurePrincipale, chemin, periode, super.hashCode());
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("est1", "code", "libelleCourt", "libelleLong", "id", "codeStructure", "formation", "UAIStructurePrincipale", "chemin", "periode"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CibleInscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CibleInscription is not found in the empty JSON string", CibleInscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CibleInscription.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CibleInscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
