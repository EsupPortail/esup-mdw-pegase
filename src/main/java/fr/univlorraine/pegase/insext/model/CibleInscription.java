...
import fr.univlorraine.pegase.insext.model.CibleInscriptionAllOf;
...
public class CibleInscription extends ObjetAvecLibelle {
  ...
  public CibleInscription id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "l'UUID du chemin de la formation ou de l'objet de formation")
  ...
  **/
  ...
  public CibleInscription uaIStructurePrincipale(String uaIStructurePrincipale) {
