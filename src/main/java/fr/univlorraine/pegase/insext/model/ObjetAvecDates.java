...
public class ObjetAvecDates {
  ...
  public ObjetAvecDates est1(@jakarta.annotation.Nonnull String est1) {
    this.est1 = est1;
    return this;
  }
  ...
  public ObjetAvecDates dateDebut(@jakarta.annotation.Nullable String dateDebut) {
  ...
  public ObjetAvecDates dateFin(@jakarta.annotation.Nullable String dateFin) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("est1", "dateDebut", "dateFin"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjetAvecDates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ObjetAvecDates is not found in the empty JSON string", ObjetAvecDates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjetAvecDates.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ObjetAvecDates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
