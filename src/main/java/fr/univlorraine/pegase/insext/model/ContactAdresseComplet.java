 ...
 */
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-07-16T12:15:50.519641300+02:00[Europe/Paris]", comments = "Generator version: 7.20.0")
public class ContactAdresseComplet extends ContactComplet {
  ...
  public ContactAdresseComplet() {
    ...
    this.canalCommunication = CanalCommunicationEnum.CONTACT_ADRESSE_COMPLET;
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("canalCommunication", "demandeDeContact", "proprietaire", "pays", "libellePays", "ligne1OuEtage", "ligne2OuBatiment", "ligne3OuVoie", "ligne4OuComplement", "ligne5Etranger", "codePegaseCommune", "codePostal", "commune", "libelleCommune"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pays", "canalCommunication", "demandeDeContact"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactAdresseComplet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContactAdresseComplet is not found in the empty JSON string", ContactAdresseComplet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactAdresseComplet.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContactAdresseComplet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
