...
public class ObjetAvecLibelle {
  ...
  public ObjetAvecLibelle est1(@jakarta.annotation.Nonnull String est1) {
    this.est1 = est1;
    return this;
  }
  ...
  public ObjetAvecLibelle code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public ObjetAvecLibelle libelleCourt(@jakarta.annotation.Nullable String libelleCourt) {
  ...
  public ObjetAvecLibelle libelleLong(@jakarta.annotation.Nullable String libelleLong) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("est1", "code", "libelleCourt", "libelleLong"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjetAvecLibelle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjetAvecLibelle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ObjetAvecLibelle is not found in the empty JSON string", ObjetAvecLibelle.openapiRequiredFields.toString()));
        }
      }

      String discriminatorValue = jsonElement.getAsJsonObject().get("est1").getAsString();
      switch (discriminatorValue) {
        case "CibleInscription":
          CibleInscription.validateJsonElement(jsonElement);
          break;
        case "Formation":
          Formation.validateJsonElement(jsonElement);
          break;
        case "ObjetFormationOuGroupement":
          ObjetFormationOuGroupement.validateJsonElement(jsonElement);
          break;
        case "Periode":
          Periode.validateJsonElement(jsonElement);
          break;
        default:
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The value of the `est1` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }


  /**
   * Create an instance of ObjetAvecLibelle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjetAvecLibelle
   * @throws IOException if the JSON string is invalid with respect to ObjetAvecLibelle
   */
  public static ObjetAvecLibelle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjetAvecLibelle.class);
  }

  /**
   * Convert an instance of ObjetAvecLibelle to an JSON string
   *
   * @return JSON string
   */
