...
public class InscriptionComplete {
  ...
  public InscriptionComplete idApprenant(String idApprenant) {
  ...
  **/
  ...
  @ApiModelProperty(value = "L'id de l'apprenant transmis par IDT")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le numéro de candidature n'est plus utilisé. Valorisé à null")
