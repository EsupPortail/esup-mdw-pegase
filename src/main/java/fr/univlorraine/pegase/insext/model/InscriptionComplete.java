...
public class InscriptionComplete {
  ...
  public InscriptionComplete dateInscription(@jakarta.annotation.Nullable String dateInscription) {
    this.dateInscription = dateInscription;
    return this;
  }

  /**
   * La date de l&#39;inscription au format AAAA-MM-JJ.Cette valeur peut être nulle si l&#39;inscription n&#39;est pas validée.
