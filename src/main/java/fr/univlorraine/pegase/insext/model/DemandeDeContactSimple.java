...
public class DemandeDeContactSimple {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("est1", "code", "codeStructure", "libelleAffichage", "canalCommunication", "temoinSaisie", "temoinSaisieProprietaire"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("est1", "code", "codeStructure", "libelleAffichage", "canalCommunication", "temoinSaisie", "temoinSaisieProprietaire"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DemandeDeContactSimple.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DemandeDeContactSimple is not found in the empty JSON string", DemandeDeContactSimple.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DemandeDeContactSimple.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DemandeDeContactSimple` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
