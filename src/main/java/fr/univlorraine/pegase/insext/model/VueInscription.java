...
public class VueInscription {
  ...
  public VueInscription dateInscription(@jakarta.annotation.Nullable String dateInscription) {
  ...
  public void setDateInscription(@jakarta.annotation.Nullable String dateInscription) {
    this.dateInscription = dateInscription;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("UAI", "codeApprenant", "derniereModification", "derniereModificationApprenant", "civilite", "nomUsage", "nomFamille", "prenom", "dateDeNaissance", "nationalite", "droitPhoto", "regime", "bourses", "mobilite", "statutPaiement", "formation", "periode", "chemin", "adresses", "mels", "telephones"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("dateInscription") != null && !jsonObj.get("dateInscription").isJsonNull()) && !jsonObj.get("dateInscription").isJsonPrimitive()) {
