...
public class VueInscription {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Le code UAI de l'établissement")
  ...
  public VueInscription idApprenant(String idApprenant) {
  ...
  **/
  ...
  @ApiModelProperty(value = "L'UUID de l'apprenant tel que déclaré dans IDT")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "La date de l'inscription au format ISO-8601 (AAAA-MM-JJThh:mm:ss) Les heures-minutes-secondes seront toujours 00:00:00")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le numéro INE maître de l'apprenant")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "L'année universitaire associée à la période")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le code diplôme SISE du PIA")
