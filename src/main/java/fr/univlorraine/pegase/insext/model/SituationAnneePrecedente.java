...
public class SituationAnneePrecedente extends Nomenclature {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CODE_BCN, required = false)
   ...
   */
  @JsonAnySetter
  public SituationAnneePrecedente putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public SituationAnneePrecedente typeNomenclature(@jakarta.annotation.Nonnull String typeNomenclature) {
    this.setTypeNomenclature(typeNomenclature);
    return this;
  }

  @Override
  public SituationAnneePrecedente code(@jakarta.annotation.Nullable String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public SituationAnneePrecedente libelle(@jakarta.annotation.Nullable String libelle) {
    this.setLibelle(libelle);
    return this;
  }

  @Override
  public SituationAnneePrecedente prioriteAffichage(@jakarta.annotation.Nullable Integer prioriteAffichage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeBcn, situationAnneePrecedente.codeBcn) &&
        Objects.equals(this.additionalProperties, situationAnneePrecedente.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeBcn, super.hashCode(), additionalProperties);
  }
