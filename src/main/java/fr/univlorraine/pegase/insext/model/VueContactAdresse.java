...
public class VueContactAdresse extends VueContact {
  ...
  public VueContactAdresse() {
    ...
    this.canalCommunication = CanalCommunicationEnum.VUE_CONTACT_ADRESSE;
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("canalCommunication", "code", "libelle", "proprietaire", "pays", "ligne1OuEtage", "ligne2OuBatiment", "ligne3OuVoie", "ligne4OuComplement", "ligne5Etranger", "codePostal", "commune"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pays", "canalCommunication", "code", "libelle"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VueContactAdresse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VueContactAdresse is not found in the empty JSON string", VueContactAdresse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VueContactAdresse.openapiFields.contains(entry.getKey())) {
          //throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VueContactAdresse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
          return;
        }
      }
