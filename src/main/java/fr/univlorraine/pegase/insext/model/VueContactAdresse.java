...
import fr.univlorraine.pegase.insext.model.VueContact;
 ...
 */
@JsonPropertyOrder({
  VueContactAdresse.JSON_PROPERTY_PAYS,
  VueContactAdresse.JSON_PROPERTY_LIGNE1_OU_ETAGE,
  VueContactAdresse.JSON_PROPERTY_LIGNE2_OU_BATIMENT,
  VueContactAdresse.JSON_PROPERTY_LIGNE3_OU_VOIE,
  VueContactAdresse.JSON_PROPERTY_LIGNE4_OU_COMPLEMENT,
  VueContactAdresse.JSON_PROPERTY_LIGNE5_ETRANGER,
  VueContactAdresse.JSON_PROPERTY_CODE_POSTAL,
  VueContactAdresse.JSON_PROPERTY_COMMUNE
})
...
public class VueContactAdresse extends VueContact {
  ...
  public VueContactAdresse pays(@jakarta.annotation.Nonnull String pays) {
  ...
  public VueContactAdresse ligne1OuEtage(@jakarta.annotation.Nullable String ligne1OuEtage) {
  ...
  public VueContactAdresse ligne2OuBatiment(@jakarta.annotation.Nullable String ligne2OuBatiment) {
  ...
  public VueContactAdresse ligne3OuVoie(@jakarta.annotation.Nullable String ligne3OuVoie) {
  ...
  public VueContactAdresse ligne4OuComplement(@jakarta.annotation.Nullable String ligne4OuComplement) {
  ...
  public VueContactAdresse ligne5Etranger(@jakarta.annotation.Nullable String ligne5Etranger) {
  ...
  public VueContactAdresse codePostal(@jakarta.annotation.Nullable String codePostal) {
  ...
  public VueContactAdresse commune(@jakarta.annotation.Nullable String commune) {
   ...
   */
  @JsonAnySetter
  public VueContactAdresse putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public VueContactAdresse canalCommunication(@jakarta.annotation.Nonnull CanalCommunicationEnum canalCommunication) {
    this.setCanalCommunication(canalCommunication);
    return this;
  }

  @Override
  public VueContactAdresse code(@jakarta.annotation.Nonnull String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public VueContactAdresse libelle(@jakarta.annotation.Nonnull String libelle) {
    this.setLibelle(libelle);
    return this;
  }

  @Override
  public VueContactAdresse proprietaire(@jakarta.annotation.Nullable String proprietaire) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pays, vueContactAdresse.pays) &&
        ...
        Objects.equals(this.additionalProperties, vueContactAdresse.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pays, ligne1OuEtage, ligne2OuBatiment, ligne3OuVoie, ligne4OuComplement, ligne5Etranger, codePostal, commune, super.hashCode(), additionalProperties);
  }
