...
public class VueContact {
  ...
  public enum CanalCommunicationEnum {
    VUE_CONTACT_ADRESSE(String.valueOf("VueContactAdresse")),
    
    VUE_CONTACT_MEL(String.valueOf("VueContactMel")),
    
    VUE_CONTACT_TELEPHONE(String.valueOf("VueContactTelephone"));
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROPRIETAIRE, required = false)
