...
public class VueContact {
  ...
  public VueContact canalCommunication(@jakarta.annotation.Nonnull CanalCommunicationEnum canalCommunication) {
  ...
  public VueContact code(@jakarta.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public VueContact libelle(@jakarta.annotation.Nonnull String libelle) {
  ...
  public VueContact proprietaire(@jakarta.annotation.Nullable String proprietaire) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("canalCommunication", "code", "libelle", "proprietaire"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("canalCommunication", "code", "libelle"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VueContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VueContact is not found in the empty JSON string", VueContact.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        ...
        case "VueContactTelephone":
          ...
          break;
        default:
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The value of the `canalCommunication` field `%s` does not match any key defined in the discriminator's mapping.", discriminatorValue));
      }
  }
