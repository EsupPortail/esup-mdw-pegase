...
public class ContactComplet {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("canalCommunication", "demandeDeContact", "proprietaire"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("canalCommunication", "demandeDeContact"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactComplet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContactComplet is not found in the empty JSON string", ContactComplet.openapiRequiredFields.toString()));
        }
      }
