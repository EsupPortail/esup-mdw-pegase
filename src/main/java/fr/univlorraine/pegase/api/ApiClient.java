...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3003/api/ins/ext/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.3.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3003/api/ins/ext/v1
