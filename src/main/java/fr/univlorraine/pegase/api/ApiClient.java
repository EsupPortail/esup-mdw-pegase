...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3003/api/v5/ins";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3003/api/v5/ins
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        if (isJsonMime(contentType)) {
            ...
            throw new ApiException(
                    "Content type \"" + contentType + "\" is not supported for type: " + returnType+ " body: "+respBody,
                    response.code(),
