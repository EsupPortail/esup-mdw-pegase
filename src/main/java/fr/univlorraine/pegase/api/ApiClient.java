...
import fr.univlorraine.pegase.api.auth.OAuth;
import fr.univlorraine.pegase.api.auth.RetryingOAuth;
import fr.univlorraine.pegase.api.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "http://localhost:3003/api/v1/ins";
    ...
    public ApiClient() {
        ...
        authentications.put("idTokenAuth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3003/api/v1/ins
