...
public class PeriodeApi {
    ...
    /**
     * Build call for lireListePeriodes
     ...
     */
    public okhttp3.Call lireListePeriodesCall(String codeStructure, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/structure/{codeStructure}/periodes"
    ...
    private okhttp3.Call lireListePeriodesValidateBeforeCall(String codeStructure, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling lireListePeriodes(Async)");
        }
        

        okhttp3.Call localVarCall = lireListePeriodesCall(codeStructure, _callback);
        return localVarCall;
     ...
     */
    public List<Periode> lireListePeriodes(String codeStructure) throws ApiException {
        ApiResponse<List<Periode>> localVarResp = lireListePeriodesWithHttpInfo(codeStructure);
     ...
     */
    public ApiResponse<List<Periode>> lireListePeriodesWithHttpInfo(String codeStructure) throws ApiException {
        okhttp3.Call localVarCall = lireListePeriodesValidateBeforeCall(codeStructure, null);
     ...
     */
    public okhttp3.Call lireListePeriodesAsync(String codeStructure, final ApiCallback<List<Periode>> _callback) throws ApiException {

        okhttp3.Call localVarCall = lireListePeriodesValidateBeforeCall(codeStructure, _callback);
        Type localVarReturnType = new TypeToken<List<Periode>>(){}.getType();
