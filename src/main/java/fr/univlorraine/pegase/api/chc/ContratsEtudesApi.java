...
import fr.univlorraine.pegase.model.chc.ContratEditable;
import java.io.File;
import fr.univlorraine.pegase.model.chc.ParametresEditionListeContratEtudesRecapitulatifAutre;
...
public class ContratsEtudesApi {
     ...
     */
    public okhttp3.Call genererListeContratEtudesRecapitulatifAutreCall(String codeStructure, String codePeriode, ParametresEditionListeContratEtudesRecapitulatifAutre parametresEditionListeContratEtudesRecapitulatifAutre, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/editions/{codeStructure}/{codePeriode}/listeDeCursusApprenants"
    ...
    private okhttp3.Call genererListeContratEtudesRecapitulatifAutreValidateBeforeCall(String codeStructure, String codePeriode, ParametresEditionListeContratEtudesRecapitulatifAutre parametresEditionListeContratEtudesRecapitulatifAutre, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling genererListeContratEtudesRecapitulatifAutre(Async)");
        }
        
        // verify the required parameter 'codePeriode' is set
        if (codePeriode == null) {
            throw new ApiException("Missing the required parameter 'codePeriode' when calling genererListeContratEtudesRecapitulatifAutre(Async)");
        }
        ...
        okhttp3.Call localVarCall = genererListeContratEtudesRecapitulatifAutreCall(codeStructure, codePeriode, parametresEditionListeContratEtudesRecapitulatifAutre, _callback);
        return localVarCall;
     ...
     */
    public File genererListeContratEtudesRecapitulatifAutre(String codeStructure, String codePeriode, ParametresEditionListeContratEtudesRecapitulatifAutre parametresEditionListeContratEtudesRecapitulatifAutre) throws ApiException {
        ApiResponse<File> localVarResp = genererListeContratEtudesRecapitulatifAutreWithHttpInfo(codeStructure, codePeriode, parametresEditionListeContratEtudesRecapitulatifAutre);
     ...
     */
    public ApiResponse<File> genererListeContratEtudesRecapitulatifAutreWithHttpInfo(String codeStructure, String codePeriode, ParametresEditionListeContratEtudesRecapitulatifAutre parametresEditionListeContratEtudesRecapitulatifAutre) throws ApiException {
        okhttp3.Call localVarCall = genererListeContratEtudesRecapitulatifAutreValidateBeforeCall(codeStructure, codePeriode, parametresEditionListeContratEtudesRecapitulatifAutre, null);
     ...
     */
    public okhttp3.Call genererListeContratEtudesRecapitulatifAutreAsync(String codeStructure, String codePeriode, ParametresEditionListeContratEtudesRecapitulatifAutre parametresEditionListeContratEtudesRecapitulatifAutre, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = genererListeContratEtudesRecapitulatifAutreValidateBeforeCall(codeStructure, codePeriode, parametresEditionListeContratEtudesRecapitulatifAutre, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
     ...
     */
    public okhttp3.Call lireContratsEditablesParCibleCall(String codeStructure, String codePeriode, String codeChemin, String statutInscription, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/contrats-etudes/{codeChemin}/{codePeriode}/{codeStructure}"
            .replaceAll("\\{" + "codeStructure" + "\\}", localVarApiClient.escapeString(codeStructure.toString()))
            .replaceAll("\\{" + "codePeriode" + "\\}", localVarApiClient.escapeString(codePeriode.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call lireContratsEditablesParCibleValidateBeforeCall(String codeStructure, String codePeriode, String codeChemin, String statutInscription, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling lireContratsEditablesParCible(Async)");
        }
        
        // verify the required parameter 'codePeriode' is set
        if (codePeriode == null) {
            throw new ApiException("Missing the required parameter 'codePeriode' when calling lireContratsEditablesParCible(Async)");
        }
        
        // verify the required parameter 'codeChemin' is set
        if (codeChemin == null) {
            throw new ApiException("Missing the required parameter 'codeChemin' when calling lireContratsEditablesParCible(Async)");
        }
        

        okhttp3.Call localVarCall = lireContratsEditablesParCibleCall(codeStructure, codePeriode, codeChemin, statutInscription, _callback);
        return localVarCall;
     ...
     */
    public List<ContratEditable> lireContratsEditablesParCible(String codeStructure, String codePeriode, String codeChemin, String statutInscription) throws ApiException {
        ApiResponse<List<ContratEditable>> localVarResp = lireContratsEditablesParCibleWithHttpInfo(codeStructure, codePeriode, codeChemin, statutInscription);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<ContratEditable>> lireContratsEditablesParCibleWithHttpInfo(String codeStructure, String codePeriode, String codeChemin, String statutInscription) throws ApiException {
        okhttp3.Call localVarCall = lireContratsEditablesParCibleValidateBeforeCall(codeStructure, codePeriode, codeChemin, statutInscription, null);
     ...
     */
    public okhttp3.Call lireContratsEditablesParCibleAsync(String codeStructure, String codePeriode, String codeChemin, String statutInscription, final ApiCallback<List<ContratEditable>> _callback) throws ApiException {

        okhttp3.Call localVarCall = lireContratsEditablesParCibleValidateBeforeCall(codeStructure, codePeriode, codeChemin, statutInscription, _callback);
        Type localVarReturnType = new TypeToken<List<ContratEditable>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
