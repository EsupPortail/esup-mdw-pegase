...
public class CursusDcaApi {
    ...
    public CursusDcaApi(ApiClient apiClient) {
    ...
    /**
     * Build call for lireCusrsuApprenant
     ...
     */
    public okhttp3.Call lireCusrsuApprenantCall(String codeApprenant, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/cursus-dca";
    ...
    private okhttp3.Call lireCusrsuApprenantValidateBeforeCall(String codeApprenant, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeApprenant' is set
        if (codeApprenant == null) {
            throw new ApiException("Missing the required parameter 'codeApprenant' when calling lireCusrsuApprenant(Async)");
        }
        

        okhttp3.Call localVarCall = lireCusrsuApprenantCall(codeApprenant, _callback);
        return localVarCall;
    ...
    public List<CursusDCA> lireCusrsuApprenant(String codeApprenant) throws ApiException {
        ApiResponse<List<CursusDCA>> localVarResp = lireCusrsuApprenantWithHttpInfo(codeApprenant);
     ...
     * 
     * @param codeApprenant Le code de l&#39;apprenant (required)
     * @return ApiResponse&lt;List&lt;CursusDCA&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<CursusDCA>> lireCusrsuApprenantWithHttpInfo(String codeApprenant) throws ApiException {
        okhttp3.Call localVarCall = lireCusrsuApprenantValidateBeforeCall(codeApprenant, null);
        Type localVarReturnType = new TypeToken<List<CursusDCA>>(){}.getType();
     ...
     */
    public okhttp3.Call lireCusrsuApprenantAsync(String codeApprenant, final ApiCallback<List<CursusDCA>> _callback) throws ApiException {

        okhttp3.Call localVarCall = lireCusrsuApprenantValidateBeforeCall(codeApprenant, _callback);
        Type localVarReturnType = new TypeToken<List<CursusDCA>>(){}.getType();
