...
public class ObjetmaquetteApi {
    ...
    /**
     * Liste des objets maquette de type groupement
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @return List&lt;ObjetMaquette&gt;
    ...
    /**
     * Liste des objets maquette de type groupement (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Liste des objets maquette pour une periode
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @return List&lt;ObjetMaquette&gt;
    ...
    /**
     * Liste des objets maquette pour une periode (asynchronously)
     * 
     * @param codeStructure Le code structure de l&#39;établissement (required)
     * @param codePeriode Le code periode (required)
     * @param _callback The callback to be executed when the API call finishes
