...
public class InscriptionsApi {
    ...
    /**
     * Récupération de l&#39;enquête Sise (déprécié) (asynchronously)
     * Récupération de l&#39;enquête Sise (déprécié)
     * @param codeStructure Le code de l&#39;établissement (required)
     * @param codePeriode Code de la Periode (required)
     * @param typeEnqueteSise Liste des types d&#39;enquêtes sise (required)
    ...
    public okhttp3.Call listerInscriptionsValideesCall(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        if (rechercheIne != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("rechercheIne", rechercheIne));
        }
        ...
        if (nomDeNaissance != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("nomDeNaissance", nomDeNaissance));
        }
    ...
    private okhttp3.Call listerInscriptionsValideesValidateBeforeCall(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listerInscriptionsValideesCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, _callback);
        return localVarCall;
    ...
    public Inscriptions listerInscriptionsValidees(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit) throws ApiException {
        ApiResponse<Inscriptions> localVarResp = listerInscriptionsValideesWithHttpInfo(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Inscriptions> listerInscriptionsValideesWithHttpInfo(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = listerInscriptionsValideesValidateBeforeCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, null);
    ...
    public okhttp3.Call listerInscriptionsValideesAsync(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit, final ApiCallback<Inscriptions> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listerInscriptionsValideesValidateBeforeCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, _callback);
        Type localVarReturnType = new TypeToken<Inscriptions>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listerInscriptionsValideesCSV
     * @param codeStructure Le code de l&#39;établissement (required)
     * @param statutsInscription liste des statusInscription à filtrer (optional)
     * @param statutsPieces liste des statusPiece à filtrer (optional)
     * @param statutsPaiement liste des statutPaiement à filtrer (optional)
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listerInscriptionsValideesCSVValidateBeforeCall(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling listerInscriptionsValideesCSV(Async)");
        }
        

        okhttp3.Call localVarCall = listerInscriptionsValideesCSVCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, _callback);
        return localVarCall;
    ...
    public File listerInscriptionsValideesCSV(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit) throws ApiException {
        ApiResponse<File> localVarResp = listerInscriptionsValideesCSVWithHttpInfo(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<File> listerInscriptionsValideesCSVWithHttpInfo(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = listerInscriptionsValideesCSVValidateBeforeCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Exporter la liste des inscriptions validées au format csv (asynchronously)
     * Liste des inscriptions validées au format csv
     * @param codeStructure Le code de l&#39;établissement (required)
     * @param statutsInscription liste des statusInscription à filtrer (optional)
     * @param statutsPieces liste des statusPiece à filtrer (optional)
     ...
     */
    public okhttp3.Call listerInscriptionsValideesCSVAsync(String codeStructure, List<StatutInscriptionVoeu> statutsInscription, List<StatutPiecesVoeu> statutsPieces, List<StatutPaiementVoeu> statutsPaiement, List<TriInscription> tri, String rechercheIne, String recherche, String periode, String objetMaquette, String nomOuPrenom, String nomDeNaissance, String prenom, String codeApprenant, String ine, Integer limit, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = listerInscriptionsValideesCSVValidateBeforeCall(codeStructure, statutsInscription, statutsPieces, statutsPaiement, tri, rechercheIne, recherche, periode, objetMaquette, nomOuPrenom, nomDeNaissance, prenom, codeApprenant, ine, limit, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for verifierReinscriptionPossible
     * @param codeStructure Le code de l&#39;établissement (required)
     * @param codeApprenant Le code de l&#39;apprenant (required)
     * @param codeVoeu Le code du voeu (\&quot;code_cible@code_periode\&quot;) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call verifierReinscriptionPossibleCall(String codeStructure, String codeApprenant, String codeVoeu, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifierReinscriptionPossibleValidateBeforeCall(String codeStructure, String codeApprenant, String codeVoeu, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'codeStructure' is set
        if (codeStructure == null) {
            throw new ApiException("Missing the required parameter 'codeStructure' when calling verifierReinscriptionPossible(Async)");
        }
        
        // verify the required parameter 'codeApprenant' is set
        if (codeApprenant == null) {
            throw new ApiException("Missing the required parameter 'codeApprenant' when calling verifierReinscriptionPossible(Async)");
        }
        
        // verify the required parameter 'codeVoeu' is set
        if (codeVoeu == null) {
            throw new ApiException("Missing the required parameter 'codeVoeu' when calling verifierReinscriptionPossible(Async)");
        }
        

        okhttp3.Call localVarCall = verifierReinscriptionPossibleCall(codeStructure, codeApprenant, codeVoeu, _callback);
        return localVarCall;
    ...
    public Boolean verifierReinscriptionPossible(String codeStructure, String codeApprenant, String codeVoeu) throws ApiException {
        ApiResponse<Boolean> localVarResp = verifierReinscriptionPossibleWithHttpInfo(codeStructure, codeApprenant, codeVoeu);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Boolean> verifierReinscriptionPossibleWithHttpInfo(String codeStructure, String codeApprenant, String codeVoeu) throws ApiException {
        okhttp3.Call localVarCall = verifierReinscriptionPossibleValidateBeforeCall(codeStructure, codeApprenant, codeVoeu, null);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * verifie la possibilité d&#39;une réinscription, true si OK, false si KO (asynchronously)
     * verifie si une reinscription est possible pour un apprenant sur un cursus donné
     * @param codeStructure Le code de l&#39;établissement (required)
     * @param codeApprenant Le code de l&#39;apprenant (required)
     * @param codeVoeu Le code du voeu (\&quot;code_cible@code_periode\&quot;) (required)
     ...
     */
    public okhttp3.Call verifierReinscriptionPossibleAsync(String codeStructure, String codeApprenant, String codeVoeu, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifierReinscriptionPossibleValidateBeforeCall(codeStructure, codeApprenant, codeVoeu, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
