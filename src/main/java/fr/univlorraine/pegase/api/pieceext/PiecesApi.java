...
package fr.univlorraine.pegase.api.pieceext;
...
import fr.univlorraine.pegase.model.pieceext.Cursus;
import fr.univlorraine.pegase.model.pieceext.DemandePieceElementResume;
import fr.univlorraine.pegase.model.pieceext.DepotsPieceElementsEpochResume;
import fr.univlorraine.pegase.model.pieceext.Pageable;
import fr.univlorraine.pegase.model.pieceext.StatutGlobalPieceParInscription;
import fr.univlorraine.pegase.model.pieceext.StatutGlobalPieceParInscriptionCommand;
...
public class PiecesApi {
     ...
     * @throws fr.univlorraine.pegase.api.ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> la liste des statut facture par inscription </td><td>  -  </td></tr>
     ...
     * @throws fr.univlorraine.pegase.api.ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> la liste des statut facture par inscription </td><td>  -  </td></tr>
