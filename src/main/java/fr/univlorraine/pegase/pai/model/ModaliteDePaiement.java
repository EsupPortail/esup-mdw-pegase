...
import fr.univlorraine.pegase.pai.model.ContextesInscription;
import fr.univlorraine.pegase.pai.model.ModeConfirmationPaiement;
import fr.univlorraine.pegase.pai.model.ModePaiement;
...
public class ModaliteDePaiement {
  ...
  **/
  ...
  public ModaliteDePaiement dateDebutValidite(Date dateDebutValidite) {
  ...
  **/
  ...
  public ModaliteDePaiement dateFinValidite(Date dateFinValidite) {
  ...
  **/
  ...
  public ModaliteDePaiement addComptesImputationItem(CompteImputation comptesImputationItem) {
    if (this.comptesImputation == null) {
      this.comptesImputation = new ArrayList<CompteImputation>();
    }
